...
route add -host 104.72.70.32 gw $1
route add -host 104.72.70.33 gw $1
route add -host 104.72.70.40 gw $1
route add -host 104.72.70.49 gw $1
route add -host 104.72.70.50 gw $1
route add -host 104.72.70.51 gw $1
route add -host 104.72.70.57 gw $1
route add -host 104.72.70.58 gw $1
route add -host 104.72.70.59 gw $1
route add -host 104.72.70.72 gw $1
route add -host 104.72.70.73 gw $1
route add -host 104.72.70.75 gw $1
route add -host 104.72.70.80 gw $1
route add -host 104.72.70.81 gw $1
route add -host 104.72.70.82 gw $1
...
route add -host 125.252.224.27 gw $1
route add -host 125.56.201.104 gw $1
route add -host 125.56.201.120 gw $1
route add -host 125.56.201.97 gw $1
...
route add -host 13.225.171.63 gw $1
...
route add -host 13.249.198.57 gw $1
...
route add -host 13.32.54.102 gw $1
route add -host 13.32.54.118 gw $1
route add -host 13.32.54.128 gw $1
route add -host 13.32.54.18 gw $1
route add -host 13.32.54.55 gw $1
...
route add -host 13.33.215.10 gw $1
route add -host 13.33.215.102 gw $1
route add -host 13.33.215.113 gw $1
route add -host 13.33.215.18 gw $1
route add -host 13.33.215.225 gw $1
route add -host 13.33.215.28 gw $1
route add -host 13.33.215.40 gw $1
route add -host 13.33.215.64 gw $1
route add -host 13.33.215.82 gw $1
route add -host 13.33.215.89 gw $1
...
route add -host 3.220.0.145 gw $1
route add -host 3.220.150.151 gw $1
route add -host 34.211.240.82 gw $1
route add -host 34.214.67.119 gw $1
route add -host 34.225.10.107 gw $1
...
route add -host 52.206.203.38 gw $1
route add -host 52.216.168.5 gw $1
route add -host 52.216.200.179 gw $1
route add -host 52.218.221.152 gw $1
route add -host 52.218.56.131 gw $1
route add -host 52.219.128.66 gw $1
route add -host 52.219.28.33 gw $1
route add -host 52.219.68.198 gw $1
route add -host 52.219.72.76 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.43.125.12 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.52.177.212 gw $1
route add -host 52.52.242.152 gw $1
route add -host 52.69.238.181 gw $1
...
route add -host 54.175.7.48 gw $1
...
route add -host 54.240.188.178 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-28T08:29:21+08:00
