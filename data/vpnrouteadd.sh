...
route add -host 172.217.173.3 gw $1
...
route add -host 18.176.79.169 gw $1
...
route add -host 3.212.27.130 gw $1
...
route add -host 52.217.42.36 gw $1
...
route add -host 52.2.3.211 gw $1
route add -host 52.34.54.102 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.69.219.96 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.9.26.145 gw $1
route add -host 52.95.129.15 gw $1
...
route add -host 99.84.233.146 gw $1
route add -host 99.84.233.147 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-20T05:49:16+08:00
