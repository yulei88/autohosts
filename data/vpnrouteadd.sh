...
route add -host 104.115.91.122 gw $1
route add -host 104.115.91.212 gw $1
...
route add -host 172.253.119.120 gw $1
...
route add -host 35.170.138.55 gw $1
...
route add -host 52.216.242.174 gw $1
route add -host 52.216.89.180 gw $1
route add -host 52.218.233.8 gw $1
route add -host 52.218.52.186 gw $1
...
route add -host 52.32.170.162 gw $1
...
route add -host 74.125.134.94 gw $1
...
route add -host 99.86.33.8 gw $1
route add -host 99.86.33.96 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-15T22:02:13+08:00
