...
route add -host 23.44.7.96 gw $1
...
route add -host 34.211.98.71 gw $1
route add -host 34.230.154.8 gw $1
route add -host 34.239.89.209 gw $1
...
route add -host 52.216.89.77 gw $1
route add -host 52.217.97.132 gw $1
route add -host 52.218.105.130 gw $1
route add -host 52.218.219.16 gw $1
route add -host 52.219.116.88 gw $1
route add -host 52.219.133.62 gw $1
route add -host 52.219.16.174 gw $1
route add -host 52.219.75.211 gw $1
