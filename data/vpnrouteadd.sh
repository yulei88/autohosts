...
route add -host 108.177.122.94 gw $1
...
route add -host 13.224.2.51 gw $1
...
route add -host 52.216.169.117 gw $1
route add -host 52.216.225.104 gw $1
route add -host 52.218.110.27 gw $1
route add -host 52.218.241.160 gw $1
route add -host 52.219.116.192 gw $1
route add -host 52.219.124.162 gw $1
...
route add -host 99.84.232.55 gw $1
route add -host 99.84.232.74 gw $1
...
route add -host 99.86.33.28 gw $1
route add -host 99.86.33.87 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-11T05:46:15+08:00
