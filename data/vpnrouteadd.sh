...
route add -host 13.225.159.83 gw $1
...
route add -host 13.226.251.70 gw $1
...
route add -host 184.169.215.85 gw $1
...
route add -host 23.195.239.69 gw $1
...
route add -host 23.222.146.140 gw $1
...
route add -host 3.230.14.82 gw $1
...
route add -host 52.216.99.147 gw $1
...
route add -host 67.217.80.113 gw $1
...
route add -host 99.84.191.116 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-04-02T22:02:44+08:00
