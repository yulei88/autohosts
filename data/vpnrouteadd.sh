...
route add -host 108.177.126.190 gw $1
...
route add -host 13.225.159.66 gw $1
...
route add -host 13.226.238.13 gw $1
...
route add -host 13.249.170.116 gw $1
route add -host 13.249.170.28 gw $1
route add -host 13.249.170.60 gw $1
...
route add -host 3.221.96.90 gw $1
route add -host 34.211.129.117 gw $1
...
route add -host 52.193.139.196 gw $1
route add -host 52.216.141.30 gw $1
route add -host 52.216.142.4 gw $1
route add -host 52.218.209.64 gw $1
...
route add -host 52.219.75.59 gw $1
...
route add -host 52.52.107.153 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-20T09:52:37+08:00
