...
route add -host 3.211.183.31 gw $1
route add -host 3.215.223.2 gw $1
route add -host 3.233.194.92 gw $1
route add -host 34.197.184.81 gw $1
route add -host 34.201.202.112 gw $1
...
route add -host 52.217.0.198 gw $1
route add -host 52.217.43.172 gw $1
route add -host 52.218.20.148 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-28T06:02:05+08:00
