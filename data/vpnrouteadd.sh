...
route add -host 13.35.67.122 gw $1
route add -host 13.35.67.123 gw $1
route add -host 13.35.67.127 gw $1
route add -host 13.35.67.43 gw $1
route add -host 13.35.67.46 gw $1
route add -host 13.35.68.18 gw $1
route add -host 13.35.69.18 gw $1
...
route add -host 172.217.167.99 gw $1
...
route add -host 23.50.224.9 gw $1
...
route add -host 3.224.109.36 gw $1
route add -host 3.226.2.213 gw $1
...
route add -host 52.216.228.72 gw $1
route add -host 52.218.100.107 gw $1
route add -host 52.218.222.8 gw $1
route add -host 52.219.116.144 gw $1
route add -host 52.219.124.6 gw $1
...
route add -host 52.5.223.247 gw $1
...
route add -host 54.88.41.235 gw $1
...
route add -host 64.233.184.94 gw $1
