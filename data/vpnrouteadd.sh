...
route add -host 216.58.196.226 gw $1
...
route add -host 52.216.179.3 gw $1
route add -host 52.216.227.35 gw $1
route add -host 52.218.21.66 gw $1
...
route add -host 74.125.200.105 gw $1
...
#Last updated:  2019-01-29T08:30:06+08:00
