...
route add -host 216.58.202.35 gw $1
...
route add -host 3.230.141.75 gw $1
route add -host 34.214.228.41 gw $1
...
route add -host 52.216.154.124 gw $1
route add -host 52.218.249.64 gw $1
route add -host 52.218.29.43 gw $1
...
route add -host 54.199.181.16 gw $1
...
route add -host 74.125.128.136 gw $1
