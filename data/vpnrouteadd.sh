...
route add -host 13.225.145.113 gw $1
...
route add -host 13.32.53.43 gw $1
route add -host 13.32.53.44 gw $1
route add -host 13.32.53.98 gw $1
...
route add -host 34.202.118.80 gw $1
...
route add -host 52.203.132.65 gw $1
route add -host 52.21.58.55 gw $1
route add -host 52.216.26.164 gw $1
route add -host 52.218.208.168 gw $1
route add -host 52.218.56.235 gw $1
route add -host 52.219.120.216 gw $1
route add -host 52.219.124.238 gw $1
...
route add -host 54.208.107.5 gw $1
...
route add -host 54.231.50.98 gw $1
