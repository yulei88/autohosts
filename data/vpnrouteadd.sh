...
route add -host 107.21.55.126 gw $1
...
route add -host 216.58.193.46 gw $1
...
route add -host 23.48.201.27 gw $1
...
route add -host 34.193.155.154 gw $1
...
route add -host 52.216.129.133 gw $1
route add -host 52.216.236.35 gw $1
route add -host 52.218.52.76 gw $1
route add -host 52.219.112.128 gw $1
route add -host 52.219.36.182 gw $1
route add -host 52.219.68.88 gw $1
...
route add -host 52.59.4.151 gw $1
...
route add -host 54.219.149.5 gw $1
...
route add -host 54.231.169.52 gw $1
...
#Last updated:  2019-06-30T08:27:39+08:00
