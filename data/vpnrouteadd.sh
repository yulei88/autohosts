...
route add -host 13.225.163.42 gw $1
...
route add -host 13.35.126.114 gw $1
...
route add -host 143.204.80.10 gw $1
...
route add -host 143.204.80.74 gw $1
route add -host 143.204.80.75 gw $1
...
route add -host 23.44.7.33 gw $1
...
route add -host 34.211.243.169 gw $1
...
route add -host 52.217.32.180 gw $1
...
route add -host 99.84.235.108 gw $1
route add -host 99.84.235.111 gw $1
route add -host 99.84.235.2 gw $1
route add -host 99.84.235.71 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-04-26T13:07:37+08:00
