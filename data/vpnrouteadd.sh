...
route add -host 34.223.154.246 gw $1
...
route add -host 52.216.145.11 gw $1
route add -host 52.217.47.142 gw $1
route add -host 52.218.182.40 gw $1
route add -host 52.218.29.235 gw $1
route add -host 52.219.128.94 gw $1
route add -host 52.219.136.26 gw $1
route add -host 52.219.168.23 gw $1
...
route add -host 54.164.208.63 gw $1
...
route add -host 99.84.207.10 gw $1
route add -host 99.84.207.41 gw $1
route add -host 99.84.207.5 gw $1
route add -host 99.84.207.60 gw $1
route add -host 99.84.207.84 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-03T06:01:45+08:00
