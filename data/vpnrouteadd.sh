...
route add -host 13.227.21.95 gw $1
...
route add -host 172.217.24.227 gw $1
...
route add -host 52.216.179.219 gw $1
route add -host 52.217.12.22 gw $1
route add -host 52.218.20.36 gw $1
route add -host 52.218.205.24 gw $1
...
route add -host 52.38.207.6 gw $1
...
route add -host 52.8.241.159 gw $1
route add -host 52.95.132.239 gw $1
route add -host 52.95.164.18 gw $1
route add -host 54.192.229.127 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-16T09:46:24+08:00
