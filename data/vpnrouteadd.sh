...
route add -host 34.225.110.3 gw $1
...
route add -host 52.216.16.91 gw $1
route add -host 52.216.237.211 gw $1
route add -host 52.218.232.216 gw $1
...
#Last updated:  2019-07-05T08:26:45+08:00
