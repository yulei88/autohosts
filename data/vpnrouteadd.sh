...
route add -host 157.240.22.20 gw $1
...
route add -host 213.144.233.252 gw $1
...
route add -host 23.42.156.32 gw $1
...
route add -host 40.100.52.18 gw $1
...
route add -host 52.216.132.69 gw $1
route add -host 52.216.166.35 gw $1
route add -host 52.218.248.160 gw $1
route add -host 52.218.65.44 gw $1
route add -host 52.219.0.84 gw $1
route add -host 52.219.20.73 gw $1
...
route add -host 52.40.155.165 gw $1
route add -host 52.42.184.183 gw $1
route add -host 52.45.135.189 gw $1
...
route add -host 54.156.220.168 gw $1
...
route add -host 89.146.4.146 gw $1
...
#Last updated:  2019-01-31T08:29:10+08:00
