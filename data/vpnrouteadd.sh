...
route add -host 13.225.143.74 gw $1
...
route add -host 52.216.141.140 gw $1
route add -host 52.217.66.70 gw $1
route add -host 52.218.108.211 gw $1
...
route add -host 52.219.74.147 gw $1
...
route add -host 52.5.183.1 gw $1
...
route add -host 74.125.137.120 gw $1
...
route add -host 99.84.206.31 gw $1
route add -host 99.84.206.33 gw $1
route add -host 99.84.206.80 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-11-03T13:18:11+08:00
