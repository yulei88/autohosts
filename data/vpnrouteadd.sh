...
route add -host 13.32.52.120 gw $1
...
route add -host 13.32.52.34 gw $1
...
route add -host 13.32.52.96 gw $1
...
route add -host 13.33.8.41 gw $1
...
route add -host 23.2.16.11 gw $1
...
route add -host 23.4.240.27 gw $1
route add -host 23.4.240.50 gw $1
...
route add -host 34.196.124.69 gw $1
...
route add -host 34.232.15.68 gw $1
route add -host 34.237.203.31 gw $1
route add -host 35.160.20.207 gw $1
...
route add -host 52.95.165.2 gw $1
...
route add -host 54.231.98.155 gw $1
...
route add -host 54.248.130.249 gw $1
...
#Last updated:  2018-11-07T20:05:59+08:00
