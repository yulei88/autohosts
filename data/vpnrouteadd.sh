...
route add -host 34.210.109.56 gw $1
...
route add -host 3.94.154.83 gw $1
...
route add -host 52.216.2.32 gw $1
route add -host 52.218.249.32 gw $1
...
#Last updated:  2019-03-15T08:29:08+08:00
