...
route add -host 13.227.66.39 gw $1
...
route add -host 172.217.7.238 gw $1
...
route add -host 2.23.47.193 gw $1
...
route add -host 23.195.89.163 gw $1
...
route add -host 52.1.41.233 gw $1
route add -host 52.196.193.27 gw $1
route add -host 52.205.68.57 gw $1
route add -host 52.216.141.124 gw $1
route add -host 52.217.46.30 gw $1
...
#Last updated:  2020-06-05T05:47:58+08:00
