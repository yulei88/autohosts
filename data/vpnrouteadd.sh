...
route add -host 172.217.14.174 gw $1
...
route add -host 44.237.58.140 gw $1
route add -host 44.239.14.223 gw $1
...
route add -host 52.201.104.12 gw $1
route add -host 52.216.186.67 gw $1
route add -host 52.216.92.61 gw $1
route add -host 52.218.112.163 gw $1
route add -host 52.218.252.48 gw $1
route add -host 52.219.120.0 gw $1
route add -host 52.219.124.18 gw $1
route add -host 52.219.136.22 gw $1
route add -host 52.219.168.88 gw $1
...
route add -host 52.88.201.70 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-12-09T05:54:33+08:00
