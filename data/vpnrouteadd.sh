...
route add -host 13.225.176.124 gw $1
...
route add -host 13.32.54.7 gw $1
route add -host 13.32.54.9 gw $1
...
route add -host 13.33.215.115 gw $1
route add -host 13.33.215.22 gw $1
route add -host 13.33.215.24 gw $1
...
route add -host 13.33.215.68 gw $1
...
route add -host 23.32.3.82 gw $1
...
route add -host 52.216.105.29 gw $1
route add -host 52.216.176.35 gw $1
route add -host 52.218.234.160 gw $1
route add -host 52.218.37.203 gw $1
...
route add -host 54.231.49.104 gw $1
...
#Last updated:  2019-09-24T08:29:12+08:00
