...
route add -host 108.177.121.120 gw $1
...
route add -host 13.125.55.220 gw $1
...
route add -host 209.85.201.26 gw $1
...
route add -host 3.211.167.12 gw $1
route add -host 3.216.110.7 gw $1
route add -host 34.196.86.192 gw $1
route add -host 34.225.32.233 gw $1
...
route add -host 52.216.101.101 gw $1
route add -host 52.216.106.107 gw $1
route add -host 52.216.226.32 gw $1
route add -host 52.218.208.96 gw $1
...
route add -host 52.25.127.67 gw $1
route add -host 52.28.27.180 gw $1
...
route add -host 54.192.111.79 gw $1
...
#Last updated:  2019-06-19T05:58:17+08:00
