...
route add -host 13.224.51.34 gw $1
route add -host 13.224.51.73 gw $1
route add -host 13.224.51.8 gw $1
...
route add -host 13.33.71.20 gw $1
route add -host 13.33.71.78 gw $1
route add -host 13.33.71.99 gw $1
...
route add -host 3.226.55.207 gw $1
...
route add -host 52.216.102.149 gw $1
route add -host 52.217.8.172 gw $1
route add -host 52.218.105.82 gw $1
route add -host 52.218.221.248 gw $1
...
route add -host 52.72.197.61 gw $1
...
#Last updated:  2019-12-23T22:02:18+08:00
