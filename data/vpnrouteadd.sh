...
route add -host 104.28.6.99 gw $1
...
route add -host 13.249.213.9 gw $1
...
route add -host 3.214.38.217 gw $1
...
route add -host 34.213.33.192 gw $1
...
route add -host 52.217.102.22 gw $1
route add -host 52.217.43.44 gw $1
route add -host 52.218.209.176 gw $1
route add -host 52.218.52.12 gw $1
route add -host 52.219.120.32 gw $1
route add -host 52.219.132.50 gw $1
route add -host 52.219.136.98 gw $1
...
route add -host 52.89.54.208 gw $1
...
route add -host 64.233.191.94 gw $1
...
#Last updated:  2020-10-06T05:53:21+08:00
