...
route add -host 34.200.113.97 gw $1
route add -host 34.206.18.92 gw $1
...
route add -host 52.216.144.85 gw $1
route add -host 52.216.178.227 gw $1
...
#Last updated:  2019-05-23T05:57:36+08:00
