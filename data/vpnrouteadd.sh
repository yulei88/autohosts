...
route add -host 104.24.103.79 gw $1
...
route add -host 13.35.46.126 gw $1
...
route add -host 34.237.121.124 gw $1
...
route add -host 3.93.83.183 gw $1
...
route add -host 52.216.178.85 gw $1
route add -host 52.216.97.211 gw $1
...
route add -host 52.219.75.127 gw $1
...
route add -host 54.162.12.171 gw $1
route add -host 54.193.253.2 gw $1
route add -host 54.203.128.50 gw $1
route add -host 54.209.58.221 gw $1
...
route add -host 74.125.68.109 gw $1
route add -host 74.125.68.192 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-21T05:48:03+08:00
