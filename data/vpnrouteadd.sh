...
route add -host 13.226.62.58 gw $1
...
route add -host 18.185.162.15 gw $1
...
route add -host 3.233.0.34 gw $1
...
route add -host 34.235.72.99 gw $1
route add -host 34.237.115.134 gw $1
route add -host 35.168.42.194 gw $1
...
route add -host 52.216.12.124 gw $1
route add -host 52.216.244.134 gw $1
route add -host 52.218.243.16 gw $1
...
route add -host 52.95.128.87 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-08-22T13:16:45+08:00
