...
route add -host 216.58.214.163 gw $1
...
route add -host 52.216.233.229 gw $1
route add -host 52.218.17.28 gw $1
route add -host 52.218.241.176 gw $1
...
#Last updated:  2019-03-05T05:59:46+08:00
