...
route add -host 23.195.90.81 gw $1
...
route add -host 52.216.146.187 gw $1
route add -host 52.217.81.110 gw $1
route add -host 52.218.105.242 gw $1
route add -host 52.218.245.216 gw $1
route add -host 52.219.125.38 gw $1
route add -host 52.219.24.169 gw $1
route add -host 52.219.72.12 gw $1
route add -host 52.219.8.46 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.23.85.248 gw $1
route add -host 52.26.2.85 gw $1
route add -host 52.28.76.116 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-03T05:51:29+08:00
