...
route add -host 104.102.144.211 gw $1
route add -host 104.102.147.36 gw $1
route add -host 104.102.159.140 gw $1
route add -host 104.102.163.189 gw $1
...
route add -host 13.249.122.124 gw $1
...
route add -host 151.101.72.158 gw $1
...
route add -host 157.240.25.31 gw $1
...
route add -host 172.217.161.212 gw $1
...
route add -host 172.217.24.99 gw $1
...
route add -host 172.217.26.67 gw $1
...
route add -host 184.25.205.10 gw $1
route add -host 184.25.205.11 gw $1
route add -host 184.25.205.16 gw $1
route add -host 184.25.205.17 gw $1
route add -host 184.25.205.26 gw $1
route add -host 184.25.205.9 gw $1
...
route add -host 23.15.14.24 gw $1
route add -host 23.15.14.49 gw $1
route add -host 23.185.0.2 gw $1
route add -host 23.20.146.132 gw $1
...
route add -host 23.32.248.67 gw $1
route add -host 23.35.216.152 gw $1
route add -host 23.35.216.154 gw $1
route add -host 23.35.216.168 gw $1
route add -host 23.35.216.171 gw $1
route add -host 23.35.216.176 gw $1
route add -host 23.42.103.113 gw $1
route add -host 23.74.153.216 gw $1
...
route add -host 34.194.53.151 gw $1
route add -host 34.196.17.71 gw $1
route add -host 34.197.53.24 gw $1
route add -host 34.198.88.244 gw $1
route add -host 34.202.128.74 gw $1
route add -host 34.218.151.212 gw $1
route add -host 34.227.43.180 gw $1
route add -host 34.228.128.195 gw $1
route add -host 35.166.2.149 gw $1
...
route add -host 52.216.101.115 gw $1
route add -host 52.216.17.227 gw $1
route add -host 52.216.227.16 gw $1
route add -host 52.218.212.96 gw $1
route add -host 52.219.20.5 gw $1
route add -host 52.219.36.121 gw $1
route add -host 52.219.4.28 gw $1
...
route add -host 52.4.126.164 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.55.207.131 gw $1
route add -host 52.58.199.178 gw $1
...
route add -host 52.85.12.114 gw $1
...
route add -host 52.85.12.214 gw $1
...
route add -host 54.215.154.246 gw $1
route add -host 54.230.235.123 gw $1
route add -host 54.231.131.51 gw $1
...
route add -host 54.82.217.46 gw $1
route add -host 54.88.237.156 gw $1
route add -host 59.124.99.130 gw $1
route add -host 63.217.21.9 gw $1
...
route add -host 69.192.4.19 gw $1
route add -host 69.192.4.40 gw $1
...
route add -host 74.125.28.108 gw $1
