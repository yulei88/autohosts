...
route add -host 13.35.99.8 gw $1
...
route add -host 172.217.165.14 gw $1
...
route add -host 216.58.206.3 gw $1
...
route add -host 34.212.212.167 gw $1
...
route add -host 52.216.139.219 gw $1
route add -host 52.216.141.46 gw $1
route add -host 52.218.20.156 gw $1
route add -host 52.218.246.64 gw $1
route add -host 52.219.120.48 gw $1
...
route add -host 52.57.123.134 gw $1
...
route add -host 54.152.173.145 gw $1
...
route add -host 69.192.4.104 gw $1
route add -host 69.192.4.106 gw $1
route add -host 69.192.4.107 gw $1
route add -host 69.192.4.113 gw $1
route add -host 69.192.4.114 gw $1
route add -host 69.192.4.115 gw $1
route add -host 69.192.4.120 gw $1
route add -host 69.192.4.121 gw $1
route add -host 69.192.4.122 gw $1
route add -host 69.192.4.128 gw $1
route add -host 69.192.4.129 gw $1
route add -host 69.192.4.130 gw $1
route add -host 69.192.4.131 gw $1
route add -host 69.192.4.136 gw $1
route add -host 69.192.4.137 gw $1
route add -host 69.192.4.138 gw $1
route add -host 69.192.4.139 gw $1
route add -host 69.192.4.144 gw $1
route add -host 69.192.4.145 gw $1
route add -host 69.192.4.146 gw $1
route add -host 69.192.4.147 gw $1
route add -host 69.192.4.152 gw $1
route add -host 69.192.4.153 gw $1
route add -host 69.192.4.154 gw $1
route add -host 69.192.4.155 gw $1
route add -host 69.192.4.161 gw $1
route add -host 69.192.4.163 gw $1
route add -host 69.192.4.169 gw $1
route add -host 69.192.4.170 gw $1
route add -host 69.192.4.171 gw $1
route add -host 69.192.4.176 gw $1
route add -host 69.192.4.177 gw $1
route add -host 69.192.4.98 gw $1
route add -host 69.192.4.99 gw $1
...
#Last updated:  2020-02-15T09:45:23+08:00
