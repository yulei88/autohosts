...
route add -host 13.56.53.3 gw $1
...
route add -host 172.217.16.163 gw $1
...
route add -host 18.233.116.52 gw $1
...
route add -host 23.32.241.99 gw $1
...
route add -host 34.212.107.111 gw $1
route add -host 34.231.37.160 gw $1
...
route add -host 52.216.108.149 gw $1
route add -host 52.216.230.131 gw $1
route add -host 52.216.96.251 gw $1
route add -host 52.218.20.12 gw $1
...
route add -host 52.219.73.72 gw $1
...
route add -host 52.85.152.76 gw $1
...
route add -host 64.71.134.28 gw $1
...
#Last updated:  2019-06-27T18:56:18+08:00
