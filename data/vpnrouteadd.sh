...
route add -host 104.111.210.63 gw $1
...
route add -host 104.28.11.120 gw $1
route add -host 104.28.23.12 gw $1
route add -host 104.75.245.99 gw $1
route add -host 104.75.246.108 gw $1
...
route add -host 13.32.54.87 gw $1
...
route add -host 13.35.101.90 gw $1
...
route add -host 172.217.15.14 gw $1
...
route add -host 173.205.29.57 gw $1
...
route add -host 18.196.193.15 gw $1
route add -host 184.169.175.82 gw $1
route add -host 184.25.232.118 gw $1
...
route add -host 23.198.103.229 gw $1
route add -host 23.198.125.212 gw $1
route add -host 23.198.127.211 gw $1
route add -host 23.198.134.194 gw $1
route add -host 23.198.135.66 gw $1
route add -host 23.2.16.119 gw $1
route add -host 23.2.16.48 gw $1
route add -host 23.2.16.51 gw $1
route add -host 23.2.16.74 gw $1
route add -host 23.2.16.80 gw $1
route add -host 23.218.17.29 gw $1
route add -host 23.218.32.221 gw $1
route add -host 23.218.33.173 gw $1
route add -host 23.218.35.179 gw $1
route add -host 23.219.172.57 gw $1
route add -host 23.227.38.32 gw $1
route add -host 23.227.38.64 gw $1
route add -host 23.39.70.72 gw $1
route add -host 23.44.172.56 gw $1
route add -host 23.44.172.72 gw $1
route add -host 23.47.84.13 gw $1
route add -host 23.47.87.238 gw $1
route add -host 23.48.201.16 gw $1
route add -host 23.48.201.18 gw $1
route add -host 23.55.46.153 gw $1
...
route add -host 3.216.154.158 gw $1
...
route add -host 52.216.108.27 gw $1
route add -host 52.216.144.77 gw $1
route add -host 52.218.160.56 gw $1
route add -host 52.218.88.115 gw $1
...
route add -host 52.45.184.14 gw $1
...
route add -host 54.165.105.2 gw $1
route add -host 54.191.252.42 gw $1
route add -host 54.193.253.7 gw $1
route add -host 54.213.189.36 gw $1
...
route add -host 54.243.22.197 gw $1
...
route add -host 99.84.199.117 gw $1
route add -host 99.84.199.121 gw $1
route add -host 99.84.199.25 gw $1
route add -host 99.84.199.28 gw $1
route add -host 99.84.199.3 gw $1
route add -host 99.84.199.87 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-07-29T05:50:35+08:00
