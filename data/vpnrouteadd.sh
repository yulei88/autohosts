...
route add -host 13.225.160.125 gw $1
...
route add -host 13.225.177.96 gw $1
...
route add -host 142.250.8.190 gw $1
...
route add -host 18.178.252.160 gw $1
...
route add -host 3.208.119.220 gw $1
...
route add -host 35.161.99.10 gw $1
...
route add -host 52.198.184.6 gw $1
route add -host 52.216.207.59 gw $1
route add -host 52.217.192.8 gw $1
...
route add -host 99.84.238.123 gw $1
route add -host 99.84.238.157 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-31T09:53:29+08:00
