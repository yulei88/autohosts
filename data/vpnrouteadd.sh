...
route add -host 13.35.126.80 gw $1
...
route add -host 172.67.150.178 gw $1
...
route add -host 18.213.78.90 gw $1
route add -host 18.235.71.198 gw $1
...
route add -host 23.195.89.144 gw $1
...
route add -host 23.23.36.87 gw $1
...
route add -host 34.232.252.150 gw $1
route add -host 34.235.21.52 gw $1
route add -host 35.155.246.5 gw $1
...
route add -host 52.216.141.156 gw $1
route add -host 52.217.64.206 gw $1
route add -host 52.218.109.155 gw $1
route add -host 52.218.250.48 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-31T13:11:32+08:00
