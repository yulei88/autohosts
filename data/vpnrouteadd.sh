...
route add -host 216.58.199.131 gw $1
...
route add -host 3.210.121.151 gw $1
...
route add -host 52.217.69.140 gw $1
route add -host 52.218.152.120 gw $1
route add -host 52.218.60.211 gw $1
route add -host 52.219.120.160 gw $1
route add -host 52.219.132.94 gw $1
route add -host 52.219.47.63 gw $1
...
route add -host 54.146.154.93 gw $1
...
route add -host 99.86.32.111 gw $1
route add -host 99.86.32.126 gw $1
route add -host 99.86.32.25 gw $1
route add -host 99.86.32.73 gw $1
route add -host 99.86.32.91 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-09-22T05:52:08+08:00
