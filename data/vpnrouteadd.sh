...
route add -host 18.235.221.208 gw $1
...
route add -host 216.58.196.228 gw $1
...
route add -host 216.58.199.243 gw $1
...
route add -host 34.226.0.41 gw $1
...
route add -host 52.216.108.195 gw $1
route add -host 52.216.19.27 gw $1
route add -host 52.218.201.192 gw $1
route add -host 52.218.48.204 gw $1
route add -host 52.219.24.97 gw $1
route add -host 52.219.40.117 gw $1
route add -host 52.219.4.116 gw $1
route add -host 52.219.74.64 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.28.82.87 gw $1
route add -host 52.35.140.58 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.39.74.21 gw $1
route add -host 52.45.31.148 gw $1
...
route add -host 52.85.12.84 gw $1
...
route add -host 52.95.163.54 gw $1
...
route add -host 54.215.201.94 gw $1
...
route add -host 99.84.74.74 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-02-03T05:58:12+08:00
