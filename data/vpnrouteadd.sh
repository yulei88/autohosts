...
route add -host 104.18.44.215 gw $1
...
route add -host 13.225.163.46 gw $1
...
route add -host 13.33.42.127 gw $1
...
route add -host 143.204.80.127 gw $1
route add -host 143.204.80.28 gw $1
route add -host 143.204.80.29 gw $1
...
route add -host 52.1.109.248 gw $1
...
route add -host 52.216.143.38 gw $1
route add -host 52.216.89.19 gw $1
route add -host 52.218.20.36 gw $1
route add -host 52.218.243.64 gw $1
...
route add -host 99.84.206.55 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-04-23T13:11:11+08:00
