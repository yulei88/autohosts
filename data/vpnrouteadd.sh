...
route add -host 13.249.153.43 gw $1
...
route add -host 13.32.230.171 gw $1
route add -host 13.32.230.54 gw $1
...
route add -host 3.225.42.152 gw $1
...
route add -host 52.20.204.248 gw $1
route add -host 52.216.130.45 gw $1
route add -host 52.216.176.139 gw $1
route add -host 52.218.108.187 gw $1
route add -host 52.218.144.0 gw $1
route add -host 52.219.116.120 gw $1
route add -host 52.219.124.42 gw $1
...
route add -host 52.53.139.53 gw $1
...
route add -host 52.84.165.236 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-17T05:56:02+08:00
