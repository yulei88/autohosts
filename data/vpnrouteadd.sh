...
route add -host 13.226.219.11 gw $1
...
route add -host 13.35.67.103 gw $1
...
route add -host 52.216.8.5 gw $1
route add -host 52.216.94.227 gw $1
...
route add -host 99.84.55.93 gw $1
route add -host 99.84.59.110 gw $1
route add -host 99.84.60.9 gw $1
route add -host 99.84.63.88 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-30T06:00:05+08:00
