...
route add -host 104.84.206.14 gw $1
...
route add -host 13.225.163.94 gw $1
...
route add -host 143.204.80.125 gw $1
route add -host 143.204.80.39 gw $1
route add -host 143.204.80.56 gw $1
route add -host 143.204.80.76 gw $1
route add -host 143.204.80.92 gw $1
route add -host 143.204.80.94 gw $1
...
route add -host 18.205.231.22 gw $1
...
route add -host 23.45.51.185 gw $1
...
route add -host 23.63.138.128 gw $1
...
route add -host 3.212.49.115 gw $1
...
route add -host 34.192.88.161 gw $1
...
route add -host 52.216.24.86 gw $1
route add -host 52.216.76.252 gw $1
route add -host 52.218.224.8 gw $1
...
#Last updated:  2020-04-24T05:43:07+08:00
