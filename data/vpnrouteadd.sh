...
route add -host 13.32.197.246 gw $1
route add -host 13.32.197.78 gw $1
route add -host 13.32.230.168 gw $1
...
route add -host 52.216.130.59 gw $1
route add -host 52.216.163.149 gw $1
route add -host 52.218.144.0 gw $1
route add -host 52.218.64.4 gw $1
route add -host 52.219.0.186 gw $1
route add -host 52.219.112.56 gw $1
route add -host 52.219.40.206 gw $1
route add -host 52.219.73.191 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.22.47.222 gw $1
...
route add -host 52.9.75.153 gw $1
route add -host 54.175.87.213 gw $1
...
route add -host 99.84.224.56 gw $1
...
#Last updated:  2019-09-19T18:57:57+08:00
