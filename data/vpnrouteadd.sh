...
route add -host 104.44.88.24 gw $1
...
route add -host 142.250.185.195 gw $1
...
route add -host 2.17.71.182 gw $1
...
route add -host 52.216.242.38 gw $1
route add -host 52.216.94.123 gw $1
route add -host 52.218.1.59 gw $1
...
route add -host 52.95.163.96 gw $1
...
route add -host 54.210.152.179 gw $1
