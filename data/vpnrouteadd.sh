...
route add -host 104.16.135.192 gw $1
...
route add -host 172.217.24.100 gw $1
...
route add -host 203.208.43.119 gw $1
...
route add -host 23.20.23.97 gw $1
...
route add -host 34.192.81.36 gw $1
...
route add -host 52.20.90.39 gw $1
route add -host 52.2.14.221 gw $1
route add -host 52.216.130.85 gw $1
route add -host 52.217.1.188 gw $1
route add -host 52.218.248.40 gw $1
route add -host 52.218.96.146 gw $1
route add -host 52.219.20.21 gw $1
route add -host 52.219.40.133 gw $1
route add -host 52.219.68.40 gw $1
route add -host 52.219.74.16 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.24.8.26 gw $1
...
route add -host 52.5.37.95 gw $1
route add -host 52.53.89.64 gw $1
route add -host 52.54.96.50 gw $1
...
route add -host 52.85.12.220 gw $1
...
route add -host 52.95.133.45 gw $1
...
route add -host 54.201.43.136 gw $1
...
route add -host 54.81.215.211 gw $1
route add -host 59.124.99.130 gw $1
route add -host 61.213.183.136 gw $1
route add -host 61.213.189.226 gw $1
route add -host 61.213.189.253 gw $1
...
route add -host 74.125.23.91 gw $1
route add -host 74.125.68.147 gw $1
...
route add -host 99.84.74.38 gw $1
route add -host 99.84.74.55 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-02-03T18:57:17+08:00
