...
route add -host 104.118.6.109 gw $1
route add -host 104.118.6.116 gw $1
...
route add -host 104.118.6.98 gw $1
...
route add -host 104.244.46.199 gw $1
...
route add -host 108.177.12.109 gw $1
...
route add -host 13.209.115.84 gw $1
...
route add -host 162.125.49.1 gw $1
...
route add -host 172.217.194.103 gw $1
...
route add -host 18.235.35.137 gw $1
...
route add -host 216.58.197.4 gw $1
route add -host 216.58.199.227 gw $1
route add -host 216.58.199.238 gw $1
...
route add -host 23.2.16.116 gw $1
route add -host 23.2.16.121 gw $1
route add -host 23.2.16.184 gw $1
...
route add -host 23.33.178.26 gw $1
...
route add -host 52.0.184.145 gw $1
route add -host 52.1.172.141 gw $1
route add -host 52.119.168.190 gw $1
route add -host 52.21.155.87 gw $1
route add -host 52.216.105.115 gw $1
route add -host 52.216.108.189 gw $1
route add -host 52.216.110.83 gw $1
route add -host 52.218.104.82 gw $1
route add -host 52.218.224.88 gw $1
route add -host 52.219.0.60 gw $1
route add -host 52.219.20.97 gw $1
route add -host 52.219.32.129 gw $1
route add -host 52.219.73.56 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.23.136.93 gw $1
route add -host 52.32.255.139 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.39.74.21 gw $1
route add -host 52.40.144.152 gw $1
route add -host 52.45.219.205 gw $1
route add -host 52.45.51.26 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.85.12.113 gw $1
route add -host 52.85.12.131 gw $1
route add -host 52.85.12.134 gw $1
route add -host 52.85.12.163 gw $1
route add -host 52.85.12.167 gw $1
route add -host 52.85.12.174 gw $1
route add -host 52.85.12.184 gw $1
route add -host 52.85.12.187 gw $1
route add -host 52.85.12.200 gw $1
route add -host 52.85.12.206 gw $1
route add -host 52.85.12.213 gw $1
route add -host 52.85.12.219 gw $1
route add -host 52.85.12.225 gw $1
route add -host 52.85.12.226 gw $1
route add -host 52.85.12.229 gw $1
route add -host 52.85.12.234 gw $1
route add -host 52.85.12.242 gw $1
route add -host 52.85.12.247 gw $1
route add -host 52.85.12.34 gw $1
route add -host 52.85.12.49 gw $1
route add -host 52.85.12.6 gw $1
route add -host 52.85.12.72 gw $1
route add -host 52.85.12.76 gw $1
route add -host 52.85.12.8 gw $1
route add -host 52.85.12.99 gw $1
route add -host 52.85.13.44 gw $1
route add -host 52.85.13.64 gw $1
route add -host 52.85.152.19 gw $1
route add -host 52.95.132.21 gw $1
route add -host 52.95.164.34 gw $1
route add -host 54.152.96.152 gw $1
route add -host 54.153.81.237 gw $1
route add -host 54.183.228.231 gw $1
route add -host 54.191.39.115 gw $1
route add -host 54.192.235.105 gw $1
route add -host 54.193.253.0 gw $1
route add -host 54.193.49.77 gw $1
route add -host 54.197.51.228 gw $1
route add -host 54.210.2.70 gw $1
route add -host 54.230.232.21 gw $1
route add -host 54.230.235.120 gw $1
route add -host 54.235.253.182 gw $1
route add -host 54.236.136.135 gw $1
route add -host 54.236.67.202 gw $1
route add -host 54.239.194.148 gw $1
...
route add -host 54.84.155.223 gw $1
route add -host 54.93.134.34 gw $1
...
route add -host 74.125.23.139 gw $1
route add -host 74.125.23.189 gw $1
route add -host 74.125.24.100 gw $1
...
route add -host 89.146.4.154 gw $1
...
route add -host 96.17.151.42 gw $1
route add -host 96.17.151.43 gw $1
...
route add -host 99.84.239.22 gw $1
route add -host 99.84.239.88 gw $1
route add -host 99.84.239.9 gw $1
route add -host 99.84.239.95 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-01-04T08:28:16+08:00
