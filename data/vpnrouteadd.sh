...
route add -host 209.85.146.120 gw $1
...
route add -host 23.11.29.11 gw $1
route add -host 23.192.44.100 gw $1
route add -host 23.194.96.45 gw $1
route add -host 23.20.165.22 gw $1
route add -host 23.202.136.17 gw $1
route add -host 23.210.128.232 gw $1
...
route add -host 23.52.75.62 gw $1
...
route add -host 52.216.142.54 gw $1
route add -host 52.217.41.148 gw $1
route add -host 52.218.160.16 gw $1
...
route add -host 52.8.160.78 gw $1
...
route add -host 54.230.173.72 gw $1
...
route add -host 74.125.143.136 gw $1
...
route add -host 99.84.142.68 gw $1
...
#Last updated:  2020-02-25T22:02:25+08:00
