...
route add -host 52.216.113.53 gw $1
route add -host 52.217.66.228 gw $1
route add -host 52.218.232.96 gw $1
route add -host 52.218.40.203 gw $1
route add -host 52.219.112.56 gw $1
route add -host 52.219.140.139 gw $1
route add -host 52.219.164.70 gw $1
...
route add -host 99.84.238.100 gw $1
route add -host 99.84.238.141 gw $1
route add -host 99.84.238.95 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-19T05:46:52+08:00
