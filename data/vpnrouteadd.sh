...
route add -host 108.177.11.94 gw $1
...
route add -host 13.35.50.103 gw $1
route add -host 13.35.50.104 gw $1
route add -host 13.35.50.29 gw $1
route add -host 13.35.51.10 gw $1
route add -host 13.35.55.9 gw $1
route add -host 13.35.67.10 gw $1
route add -host 13.35.67.12 gw $1
route add -host 13.35.67.25 gw $1
route add -host 13.35.67.39 gw $1
route add -host 13.35.67.5 gw $1
route add -host 13.35.67.61 gw $1
route add -host 13.35.67.81 gw $1
route add -host 13.35.67.84 gw $1
...
route add -host 172.217.12.131 gw $1
...
route add -host 18.211.127.122 gw $1
...
route add -host 216.58.193.195 gw $1
...
route add -host 23.200.54.218 gw $1
route add -host 23.202.136.17 gw $1
route add -host 23.213.108.104 gw $1
route add -host 23.213.122.193 gw $1
route add -host 23.213.123.159 gw $1
route add -host 23.227.38.32 gw $1
route add -host 23.227.38.64 gw $1
route add -host 23.32.241.153 gw $1
...
route add -host 23.32.3.42 gw $1
...
route add -host 23.32.3.98 gw $1
route add -host 23.41.56.122 gw $1
route add -host 23.41.57.98 gw $1
route add -host 23.42.218.139 gw $1
route add -host 23.42.218.148 gw $1
route add -host 23.42.35.213 gw $1
route add -host 23.42.37.17 gw $1
route add -host 23.43.249.34 gw $1
route add -host 23.47.84.13 gw $1
route add -host 23.47.87.238 gw $1
route add -host 23.50.224.24 gw $1
...
route add -host 23.56.170.224 gw $1
route add -host 23.56.170.226 gw $1
route add -host 23.56.170.242 gw $1
route add -host 23.56.170.243 gw $1
route add -host 23.56.170.27 gw $1
route add -host 23.56.170.33 gw $1
route add -host 23.56.170.35 gw $1
route add -host 23.56.170.40 gw $1
route add -host 23.56.170.41 gw $1
route add -host 23.56.170.42 gw $1
route add -host 23.56.170.43 gw $1
route add -host 23.56.170.48 gw $1
route add -host 23.56.170.49 gw $1
route add -host 23.56.170.50 gw $1
route add -host 23.56.170.57 gw $1
...
route add -host 23.56.170.73 gw $1
route add -host 23.60.174.46 gw $1
route add -host 23.62.226.160 gw $1
route add -host 23.62.226.168 gw $1
...
route add -host 3.92.168.117 gw $1
...
route add -host 52.216.108.155 gw $1
route add -host 52.216.137.62 gw $1
route add -host 52.218.196.192 gw $1
route add -host 52.218.96.58 gw $1
route add -host 52.219.0.92 gw $1
route add -host 52.219.112.192 gw $1
route add -host 52.219.32.1 gw $1
route add -host 52.219.74.20 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.24.221.236 gw $1
route add -host 52.27.59.15 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.45.162.54 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.8.52.14 gw $1
route add -host 52.95.132.155 gw $1
route add -host 52.95.164.66 gw $1
route add -host 54.152.165.187 gw $1
route add -host 54.172.115.1 gw $1
route add -host 54.183.177.144 gw $1
route add -host 54.193.253.3 gw $1
route add -host 54.193.36.8 gw $1
...
route add -host 64.233.189.93 gw $1
...
route add -host 99.84.53.157 gw $1
route add -host 99.84.55.107 gw $1
route add -host 99.84.55.111 gw $1
route add -host 99.84.55.112 gw $1
route add -host 99.84.55.22 gw $1
route add -host 99.84.55.28 gw $1
route add -host 99.84.55.31 gw $1
route add -host 99.84.55.32 gw $1
route add -host 99.84.55.64 gw $1
route add -host 99.84.55.69 gw $1
route add -host 99.84.55.92 gw $1
route add -host 99.84.59.110 gw $1
route add -host 99.84.59.227 gw $1
route add -host 99.84.60.9 gw $1
route add -host 99.84.62.164 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-30T22:00:34+08:00
