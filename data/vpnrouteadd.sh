...
route add -host 104.31.86.217 gw $1
...
route add -host 108.177.10.127 gw $1
...
route add -host 2.21.121.239 gw $1
...
route add -host 23.45.50.18 gw $1
route add -host 23.45.50.35 gw $1
route add -host 23.45.50.56 gw $1
route add -host 23.45.50.99 gw $1
...
route add -host 3.210.81.177 gw $1
...
route add -host 34.215.107.145 gw $1
...
route add -host 52.217.9.190 gw $1
...
route add -host 52.4.24.153 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-04-06T05:45:55+08:00
