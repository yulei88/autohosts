...
route add -host 3.93.233.206 gw $1
...
route add -host 52.216.164.45 gw $1
route add -host 52.216.83.24 gw $1
route add -host 52.218.241.232 gw $1
...
#Last updated:  2019-06-27T08:27:29+08:00
