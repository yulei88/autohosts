...
route add -host 13.225.176.90 gw $1
...
route add -host 13.32.54.120 gw $1
route add -host 13.32.54.2 gw $1
route add -host 13.32.54.21 gw $1
...
route add -host 13.33.215.108 gw $1
route add -host 13.33.215.113 gw $1
route add -host 13.33.215.119 gw $1
route add -host 13.33.215.25 gw $1
route add -host 13.33.215.4 gw $1
route add -host 13.33.215.44 gw $1
route add -host 13.33.215.51 gw $1
route add -host 13.33.215.58 gw $1
route add -host 13.33.215.59 gw $1
route add -host 13.33.215.79 gw $1
route add -host 13.33.215.97 gw $1
route add -host 13.35.125.25 gw $1
...
route add -host 18.185.176.202 gw $1
route add -host 18.215.96.138 gw $1
route add -host 18.232.21.201 gw $1
...
route add -host 216.58.206.163 gw $1
...
route add -host 52.216.146.115 gw $1
route add -host 52.216.239.13 gw $1
route add -host 52.218.212.96 gw $1
route add -host 52.218.53.234 gw $1
...
route add -host 52.84.235.30 gw $1
route add -host 52.8.42.89 gw $1
route add -host 52.89.42.167 gw $1
...
route add -host 99.84.224.72 gw $1
route add -host 99.84.224.76 gw $1
route add -host 99.84.224.95 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-23T18:56:04+08:00
