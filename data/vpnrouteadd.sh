...
route add -host 104.118.6.18 gw $1
...
route add -host 108.177.126.120 gw $1
...
route add -host 13.224.12.29 gw $1
...
route add -host 2.20.199.129 gw $1
...
route add -host 3.224.37.102 gw $1
...
route add -host 52.216.166.91 gw $1
route add -host 52.216.244.182 gw $1
...
route add -host 52.86.225.78 gw $1
route add -host 52.88.41.93 gw $1
...
route add -host 99.84.230.29 gw $1
route add -host 99.84.230.7 gw $1
route add -host 99.84.230.84 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-03-04T22:04:07+08:00
