...
route add -host 13.225.159.44 gw $1
...
route add -host 13.57.112.28 gw $1
route add -host 13.57.123.222 gw $1
...
route add -host 35.163.50.242 gw $1
...
route add -host 52.216.144.61 gw $1
route add -host 52.218.242.48 gw $1
route add -host 52.218.53.202 gw $1
route add -host 52.219.0.52 gw $1
route add -host 52.219.112.160 gw $1
route add -host 52.219.124.218 gw $1
...
route add -host 54.215.196.147 gw $1
...
route add -host 64.233.178.94 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-03-25T05:45:22+08:00
