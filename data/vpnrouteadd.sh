...
route add -host 104.100.85.159 gw $1
...
route add -host 172.217.167.3 gw $1
...
route add -host 18.209.242.102 gw $1
...
route add -host 2.17.196.247 gw $1
route add -host 2.17.197.84 gw $1
route add -host 2.17.198.85 gw $1
route add -host 2.18.154.77 gw $1
...
route add -host 23.43.179.222 gw $1
route add -host 23.46.220.75 gw $1
route add -host 23.47.84.13 gw $1
route add -host 23.47.87.238 gw $1
route add -host 23.57.66.26 gw $1
route add -host 23.57.66.32 gw $1
route add -host 23.57.66.34 gw $1
route add -host 23.57.66.35 gw $1
...
route add -host 52.20.26.181 gw $1
route add -host 52.205.232.222 gw $1
route add -host 52.216.106.61 gw $1
route add -host 52.216.115.3 gw $1
route add -host 52.218.20.132 gw $1
route add -host 52.218.204.216 gw $1
...
route add -host 52.222.211.49 gw $1
route add -host 52.2.25.175 gw $1
...
route add -host 54.148.183.39 gw $1
route add -host 54.149.33.159 gw $1
...
#Last updated:  2019-07-10T18:53:30+08:00
