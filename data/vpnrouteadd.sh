...
route add -host 104.27.179.247 gw $1
...
route add -host 13.226.238.66 gw $1
route add -host 13.226.251.115 gw $1
route add -host 13.226.251.24 gw $1
...
route add -host 23.43.191.144 gw $1
...
route add -host 23.45.50.82 gw $1
...
route add -host 23.52.169.118 gw $1
route add -host 23.52.75.62 gw $1
route add -host 23.77.56.122 gw $1
...
route add -host 3.208.96.39 gw $1
...
route add -host 52.216.147.29 gw $1
route add -host 52.216.94.195 gw $1
route add -host 52.217.0.220 gw $1
route add -host 52.218.236.144 gw $1
...
route add -host 52.52.209.84 gw $1
...
route add -host 52.89.94.62 gw $1
...
#Last updated:  2020-04-07T22:02:46+08:00
