...
route add -host 13.33.148.101 gw $1
route add -host 13.33.148.163 gw $1
route add -host 13.33.148.250 gw $1
route add -host 13.33.148.88 gw $1
...
route add -host 52.216.66.0 gw $1
route add -host 52.216.84.24 gw $1
route add -host 52.218.197.24 gw $1
route add -host 52.218.84.34 gw $1
route add -host 52.219.20.29 gw $1
route add -host 52.219.32.137 gw $1
route add -host 52.219.4.40 gw $1
...
route add -host 52.89.249.189 gw $1
...
route add -host 54.231.249.17 gw $1
...
#Last updated:  2018-11-09T08:25:07+08:00
