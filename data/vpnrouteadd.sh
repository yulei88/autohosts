...
route add -host 13.32.230.202 gw $1
...
route add -host 172.217.170.67 gw $1
...
route add -host 52.216.104.99 gw $1
route add -host 52.216.161.19 gw $1
route add -host 52.218.100.227 gw $1
route add -host 52.218.204.240 gw $1
...
route add -host 54.231.82.164 gw $1
...
route add -host 54.89.31.191 gw $1
