...
route add -host 13.226.214.23 gw $1
...
route add -host 13.226.217.40 gw $1
route add -host 13.226.217.91 gw $1
...
route add -host 13.32.54.83 gw $1
...
route add -host 34.203.143.236 gw $1
...
route add -host 52.0.125.121 gw $1
route add -host 52.119.210.255 gw $1
route add -host 52.204.68.55 gw $1
route add -host 52.217.64.156 gw $1
route add -host 52.217.81.118 gw $1
route add -host 52.218.192.32 gw $1
route add -host 52.218.30.171 gw $1
route add -host 52.219.112.208 gw $1
route add -host 52.219.128.230 gw $1
...
route add -host 54.186.79.100 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-09-01T09:48:28+08:00
