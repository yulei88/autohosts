...
route add -host 143.204.77.41 gw $1
...
route add -host 34.194.164.160 gw $1
...
route add -host 52.216.145.59 gw $1
route add -host 52.216.178.37 gw $1
route add -host 52.218.101.3 gw $1
route add -host 52.218.200.112 gw $1
route add -host 52.219.116.200 gw $1
...
route add -host 99.86.144.21 gw $1
route add -host 99.86.144.48 gw $1
route add -host 99.86.144.61 gw $1
route add -host 99.86.144.68 gw $1
route add -host 99.86.144.80 gw $1
route add -host 99.86.144.92 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-03-16T22:02:43+08:00
