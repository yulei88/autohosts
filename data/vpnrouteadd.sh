...
route add -host 13.107.18.13 gw $1
...
route add -host 172.217.161.3 gw $1
...
route add -host 173.194.198.26 gw $1
...
route add -host 18.182.160.88 gw $1
...
route add -host 3.120.68.26 gw $1
...
route add -host 34.195.19.18 gw $1
...
route add -host 52.216.10.125 gw $1
route add -host 52.216.133.155 gw $1
route add -host 52.216.8.251 gw $1
route add -host 52.218.200.16 gw $1
route add -host 52.218.84.178 gw $1
route add -host 52.219.0.162 gw $1
route add -host 52.219.116.24 gw $1
route add -host 52.219.32.37 gw $1
...
route add -host 52.54.158.48 gw $1
route add -host 52.71.55.56 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.8.108.227 gw $1
route add -host 52.85.231.43 gw $1
route add -host 52.85.6.104 gw $1
route add -host 52.85.6.116 gw $1
route add -host 52.85.6.13 gw $1
route add -host 52.85.6.132 gw $1
route add -host 52.85.6.154 gw $1
route add -host 52.85.6.182 gw $1
route add -host 52.85.6.188 gw $1
route add -host 52.85.6.19 gw $1
route add -host 52.85.6.203 gw $1
route add -host 52.85.6.213 gw $1
route add -host 52.85.6.217 gw $1
route add -host 52.85.6.220 gw $1
route add -host 52.85.6.229 gw $1
route add -host 52.85.6.24 gw $1
route add -host 52.85.6.58 gw $1
route add -host 52.85.6.66 gw $1
route add -host 52.85.6.78 gw $1
route add -host 52.85.6.80 gw $1
route add -host 52.85.6.91 gw $1
route add -host 52.85.6.96 gw $1
route add -host 52.85.6.98 gw $1
route add -host 52.85.8.29 gw $1
route add -host 52.85.8.32 gw $1
route add -host 52.86.65.143 gw $1
route add -host 52.9.109.157 gw $1
route add -host 52.95.133.87 gw $1
route add -host 52.95.163.54 gw $1
route add -host 54.174.209.190 gw $1
route add -host 54.192.124.206 gw $1
route add -host 54.192.126.180 gw $1
route add -host 54.192.126.40 gw $1
route add -host 54.193.253.2 gw $1
route add -host 54.213.108.65 gw $1
route add -host 54.230.126.154 gw $1
route add -host 54.230.126.212 gw $1
...
route add -host 74.125.138.120 gw $1
...
route add -host 74.125.198.27 gw $1
...
#Last updated:  2019-03-08T08:31:34+08:00
