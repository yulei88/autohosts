...
route add -host 108.177.112.26 gw $1
...
route add -host 216.58.204.131 gw $1
...
route add -host 52.216.170.165 gw $1
route add -host 52.218.225.104 gw $1
route add -host 52.218.98.67 gw $1
route add -host 52.219.0.178 gw $1
route add -host 52.219.40.77 gw $1
route add -host 52.219.73.111 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.22.29.220 gw $1
route add -host 52.35.179.247 gw $1
route add -host 52.35.229.130 gw $1
...
route add -host 52.55.45.1 gw $1
...
#Last updated:  2019-08-07T05:54:48+08:00
