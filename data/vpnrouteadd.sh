...
route add -host 104.86.182.33 gw $1
...
route add -host 172.253.58.120 gw $1
...
route add -host 23.192.44.106 gw $1
...
route add -host 23.36.52.44 gw $1
...
route add -host 23.76.231.241 gw $1
...
route add -host 35.162.93.192 gw $1
...
route add -host 52.201.22.32 gw $1
route add -host 52.216.26.252 gw $1
route add -host 52.216.76.222 gw $1
...
route add -host 52.219.132.86 gw $1
...
route add -host 52.53.49.148 gw $1
...
route add -host 54.153.29.242 gw $1
...
route add -host 99.84.230.114 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-03-10T22:00:21+08:00
