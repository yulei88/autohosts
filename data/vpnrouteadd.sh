...
route add -host 107.23.22.79 gw $1
route add -host 108.174.10.14 gw $1
route add -host 108.174.10.19 gw $1
route add -host 108.177.103.94 gw $1
...
route add -host 13.32.230.197 gw $1
...
route add -host 3.93.161.183 gw $1
...
route add -host 52.216.100.3 gw $1
route add -host 52.216.128.13 gw $1
route add -host 52.217.37.36 gw $1
route add -host 52.218.24.179 gw $1
route add -host 52.218.252.8 gw $1
route add -host 52.219.40.238 gw $1
...
route add -host 52.71.49.20 gw $1
...
#Last updated:  2019-09-20T08:28:55+08:00
