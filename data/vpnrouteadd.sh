...
route add -host 142.250.76.110 gw $1
...
route add -host 172.253.118.102 gw $1
...
route add -host 3.216.71.121 gw $1
route add -host 3.219.177.99 gw $1
route add -host 3.223.216.208 gw $1
...
route add -host 52.216.205.163 gw $1
route add -host 52.216.8.165 gw $1
route add -host 52.218.112.187 gw $1
route add -host 52.218.182.72 gw $1
route add -host 52.219.120.32 gw $1
route add -host 52.219.36.94 gw $1
...
route add -host 52.43.66.123 gw $1
...
route add -host 74.125.130.102 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-09T09:53:20+08:00
