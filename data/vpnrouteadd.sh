...
route add -host 3.213.47.242 gw $1
...
route add -host 52.216.131.163 gw $1
route add -host 52.216.249.22 gw $1
route add -host 52.218.225.16 gw $1
...
#Last updated:  2020-11-22T09:52:17+08:00
