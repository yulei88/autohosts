...
route add -host 106.10.236.153 gw $1
...
route add -host 143.204.131.78 gw $1
...
route add -host 172.217.163.110 gw $1
...
route add -host 210.57.59.18 gw $1
...
route add -host 3.217.106.253 gw $1
route add -host 3.219.177.99 gw $1
route add -host 3.227.187.123 gw $1
route add -host 34.209.218.24 gw $1
...
route add -host 52.217.82.118 gw $1
route add -host 52.217.83.140 gw $1
route add -host 52.218.181.128 gw $1
route add -host 52.218.97.170 gw $1
route add -host 52.219.0.250 gw $1
...
route add -host 52.98.89.66 gw $1
...
#Last updated:  2020-12-16T05:54:35+08:00
