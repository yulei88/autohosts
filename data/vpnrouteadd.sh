...
route add -host 13.226.214.16 gw $1
route add -host 13.226.254.19 gw $1
...
route add -host 13.56.72.90 gw $1
...
route add -host 18.198.9.162 gw $1
...
route add -host 216.58.200.110 gw $1
...
route add -host 23.195.90.90 gw $1
...
route add -host 34.228.126.183 gw $1
...
route add -host 44.238.222.33 gw $1
...
route add -host 52.216.245.60 gw $1
route add -host 52.216.81.11 gw $1
route add -host 52.218.250.0 gw $1
route add -host 52.218.97.130 gw $1
route add -host 52.219.117.32 gw $1
...
#Last updated:  2020-10-29T13:15:14+08:00
