...
route add -host 35.163.38.114 gw $1
...
route add -host 52.216.30.68 gw $1
route add -host 52.217.48.62 gw $1
route add -host 52.218.252.80 gw $1
...
route add -host 52.52.190.9 gw $1
...
#Last updated:  2020-09-06T05:52:27+08:00
