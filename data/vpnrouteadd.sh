...
route add -host 104.106.60.195 gw $1
route add -host 104.106.61.153 gw $1
route add -host 104.106.63.152 gw $1
...
route add -host 172.217.172.3 gw $1
...
route add -host 216.58.208.227 gw $1
...
route add -host 3.220.8.224 gw $1
...
route add -host 52.216.110.35 gw $1
route add -host 52.217.38.22 gw $1
route add -host 52.218.100.27 gw $1
route add -host 52.218.221.128 gw $1
route add -host 52.219.116.96 gw $1
route add -host 52.219.1.30 gw $1
route add -host 52.219.48.62 gw $1
...
route add -host 54.67.72.144 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-21T09:45:42+08:00
