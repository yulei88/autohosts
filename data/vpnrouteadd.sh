...
route add -host 104.27.131.141 gw $1
...
route add -host 13.224.0.28 gw $1
...
route add -host 13.33.9.84 gw $1
...
route add -host 18.197.13.195 gw $1
...
route add -host 216.58.222.195 gw $1
...
route add -host 23.195.90.74 gw $1
...
route add -host 3.215.37.208 gw $1
route add -host 3.219.177.99 gw $1
route add -host 3.222.39.232 gw $1
route add -host 34.200.181.43 gw $1
...
route add -host 44.238.43.54 gw $1
...
route add -host 52.199.41.34 gw $1
route add -host 52.216.145.251 gw $1
route add -host 52.216.99.77 gw $1
route add -host 52.218.224.80 gw $1
route add -host 52.218.40.147 gw $1
route add -host 52.219.0.44 gw $1
route add -host 52.219.113.0 gw $1
...
route add -host 52.54.142.16 gw $1
route add -host 52.55.198.78 gw $1
route add -host 52.70.83.103 gw $1
...
route add -host 54.158.210.187 gw $1
route add -host 54.191.235.13 gw $1
route add -host 54.193.253.0 gw $1
route add -host 54.193.84.215 gw $1
...
route add -host 99.84.130.51 gw $1
route add -host 99.84.130.75 gw $1
route add -host 99.84.130.85 gw $1
route add -host 99.84.130.88 gw $1
...
route add -host 99.86.38.45 gw $1
route add -host 99.86.38.69 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-01T13:16:30+08:00
