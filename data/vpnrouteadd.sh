...
#
route add -host 100.26.94.110 gw $1
...
route add -host 23.33.178.25 gw $1
...
route add -host 34.230.185.201 gw $1
route add -host 34.237.29.185 gw $1
route add -host 35.160.92.183 gw $1
...
route add -host 52.216.111.11 gw $1
route add -host 52.216.130.221 gw $1
route add -host 52.216.17.248 gw $1
route add -host 52.218.224.120 gw $1
route add -host 52.218.54.2 gw $1
...
route add -host 52.85.12.157 gw $1
route add -host 52.85.12.160 gw $1
...
route add -host 54.180.0.93 gw $1
...
route add -host 64.233.168.125 gw $1
route add -host 64.233.168.27 gw $1
...
route add -host 64.233.191.26 gw $1
...
route add -host 74.125.128.108 gw $1
...
route add -host 74.125.24.105 gw $1
...
#Last updated:  2019-01-08T08:28:26+08:00
