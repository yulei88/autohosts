...
route add -host 34.236.226.66 gw $1
...
route add -host 52.216.115.11 gw $1
route add -host 52.216.228.128 gw $1
route add -host 52.218.244.8 gw $1
route add -host 52.218.84.146 gw $1
route add -host 52.219.0.100 gw $1
route add -host 52.219.116.1 gw $1
route add -host 52.219.40.73 gw $1
route add -host 52.219.72.147 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.29.167.241 gw $1
...
route add -host 99.84.74.65 gw $1
route add -host 99.84.74.8 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-07-09T05:55:43+08:00
