...
route add -host 13.209.119.246 gw $1
...
route add -host 13.33.41.30 gw $1
...
route add -host 172.217.19.3 gw $1
...
route add -host 3.224.19.206 gw $1
...
route add -host 52.216.241.188 gw $1
route add -host 52.217.11.30 gw $1
route add -host 52.218.237.48 gw $1
route add -host 52.218.85.10 gw $1
route add -host 52.219.0.112 gw $1
route add -host 52.219.120.56 gw $1
...
route add -host 54.241.77.51 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-11T13:11:47+08:00
