...
route add -host 18.233.29.235 gw $1
...
route add -host 23.22.217.92 gw $1
...
route add -host 52.216.134.101 gw $1
route add -host 52.216.232.179 gw $1
route add -host 52.218.249.8 gw $1
route add -host 52.218.96.186 gw $1
route add -host 52.219.28.45 gw $1
route add -host 52.219.36.85 gw $1
...
route add -host 52.52.240.97 gw $1
...
route add -host 52.85.12.47 gw $1
...
route add -host 52.85.12.95 gw $1
...
route add -host 54.174.78.10 gw $1
...
route add -host 54.239.194.73 gw $1
...
#Last updated:  2019-01-21T08:28:58+08:00
