...
route add -host 13.225.160.17 gw $1
...
route add -host 13.225.160.58 gw $1
...
route add -host 142.250.136.27 gw $1
route add -host 142.250.138.26 gw $1
route add -host 143.204.131.18 gw $1
route add -host 143.204.131.44 gw $1
...
route add -host 34.231.72.50 gw $1
...
route add -host 3.85.199.98 gw $1
route add -host 40.114.86.114 gw $1
route add -host 40.90.133.97 gw $1
...
route add -host 52.216.204.5 gw $1
route add -host 52.217.37.36 gw $1
route add -host 52.218.154.104 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2021-02-28T09:48:43+08:00
