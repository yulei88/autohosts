...
route add -host 13.224.8.38 gw $1
...
route add -host 13.227.75.23 gw $1
route add -host 13.227.75.34 gw $1
route add -host 13.227.75.56 gw $1
...
route add -host 173.194.205.94 gw $1
...
route add -host 216.58.223.78 gw $1
...
route add -host 34.209.68.141 gw $1
...
route add -host 52.1.121.187 gw $1
...
route add -host 52.216.115.45 gw $1
route add -host 52.216.161.227 gw $1
route add -host 52.218.193.232 gw $1
route add -host 52.218.41.227 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-08-22T05:51:12+08:00
