...
route add -host 13.33.9.97 gw $1
...
route add -host 172.217.8.131 gw $1
...
route add -host 18.185.224.112 gw $1
...
route add -host 3.213.62.93 gw $1
...
route add -host 52.216.160.45 gw $1
route add -host 52.217.102.44 gw $1
...
route add -host 52.219.132.226 gw $1
route add -host 52.219.75.79 gw $1
...
route add -host 54.230.175.77 gw $1
...
route add -host 99.84.130.26 gw $1
route add -host 99.84.130.90 gw $1
route add -host 99.84.131.46 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-11-05T13:13:09+08:00
