...
route add -host 13.225.160.10 gw $1
...
route add -host 142.250.183.67 gw $1
...
route add -host 18.158.148.25 gw $1
...
route add -host 3.208.167.253 gw $1
...
route add -host 52.1.174.226 gw $1
...
route add -host 52.216.230.157 gw $1
route add -host 52.217.98.44 gw $1
route add -host 52.218.108.83 gw $1
route add -host 52.218.228.144 gw $1
...
route add -host 52.43.9.156 gw $1
...
route add -host 52.9.57.45 gw $1
