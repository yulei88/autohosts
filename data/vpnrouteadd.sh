...
route add -host 13.225.171.70 gw $1
...
route add -host 13.225.176.35 gw $1
...
route add -host 3.221.106.224 gw $1
route add -host 3.223.64.141 gw $1
route add -host 34.225.178.187 gw $1
route add -host 34.230.226.126 gw $1
route add -host 35.161.113.230 gw $1
...
route add -host 3.93.134.68 gw $1
...
route add -host 52.201.161.93 gw $1
route add -host 52.207.11.35 gw $1
route add -host 52.216.82.32 gw $1
route add -host 52.217.46.246 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-12-14T12:02:25+08:00
