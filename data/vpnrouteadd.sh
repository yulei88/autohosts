...
route add -host 13.224.0.36 gw $1
...
route add -host 23.14.241.220 gw $1
...
route add -host 23.44.7.114 gw $1
...
route add -host 3.214.16.192 gw $1
route add -host 3.231.0.46 gw $1
route add -host 34.202.179.39 gw $1
...
route add -host 52.89.40.124 gw $1
...
route add -host 99.84.50.11 gw $1
route add -host 99.84.50.129 gw $1
route add -host 99.84.50.50 gw $1
route add -host 99.84.50.6 gw $1
route add -host 99.84.50.88 gw $1
route add -host 99.84.50.98 gw $1
...
route add -host 99.86.32.115 gw $1
route add -host 99.86.32.48 gw $1
route add -host 99.86.32.94 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-01T21:59:49+08:00
