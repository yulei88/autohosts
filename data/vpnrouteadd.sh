...
route add -host 13.32.52.91 gw $1
...
route add -host 13.33.231.32 gw $1
...
route add -host 172.217.27.171 gw $1
...
route add -host 18.195.181.115 gw $1
...
route add -host 216.58.221.162 gw $1
...
route add -host 34.205.205.184 gw $1
...
route add -host 52.21.167.187 gw $1
route add -host 52.216.107.70 gw $1
route add -host 52.216.17.32 gw $1
route add -host 52.218.244.144 gw $1
route add -host 52.218.64.52 gw $1
route add -host 52.219.0.0 gw $1
...
route add -host 52.54.82.79 gw $1
...
#Last updated:  2018-11-11T08:26:59+08:00
