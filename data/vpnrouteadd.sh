...
route add -host 104.78.4.143 gw $1
...
route add -host 124.108.115.88 gw $1
...
route add -host 13.107.42.14 gw $1
route add -host 13.228.53.16 gw $1
route add -host 13.35.99.107 gw $1
route add -host 13.35.99.14 gw $1
route add -host 13.35.99.66 gw $1
route add -host 13.35.99.70 gw $1
route add -host 13.35.99.80 gw $1
route add -host 13.35.99.81 gw $1
route add -host 134.170.179.79 gw $1
route add -host 13.56.64.175 gw $1
...
route add -host 145.131.132.86 gw $1
...
route add -host 172.217.161.241 gw $1
...
route add -host 180.222.102.158 gw $1
route add -host 184.73.84.110 gw $1
...
route add -host 203.208.43.127 gw $1
...
route add -host 23.2.129.202 gw $1
route add -host 23.2.138.149 gw $1
route add -host 23.227.38.32 gw $1
route add -host 23.227.38.64 gw $1
route add -host 23.2.36.161 gw $1
route add -host 23.32.241.10 gw $1
route add -host 23.32.241.11 gw $1
route add -host 23.32.241.16 gw $1
route add -host 23.32.241.18 gw $1
route add -host 23.32.241.19 gw $1
route add -host 23.32.241.24 gw $1
route add -host 23.32.241.25 gw $1
route add -host 23.32.241.26 gw $1
route add -host 23.32.241.3 gw $1
route add -host 23.32.241.8 gw $1
route add -host 23.32.241.9 gw $1
route add -host 23.33.52.41 gw $1
route add -host 23.41.50.105 gw $1
route add -host 23.41.84.242 gw $1
route add -host 23.41.93.64 gw $1
route add -host 23.48.32.56 gw $1
...
route add -host 34.235.194.27 gw $1
...
route add -host 52.201.133.6 gw $1
route add -host 52.203.236.187 gw $1
route add -host 52.216.109.221 gw $1
route add -host 52.216.110.107 gw $1
route add -host 52.2.176.132 gw $1
route add -host 52.218.244.136 gw $1
route add -host 52.218.96.82 gw $1
route add -host 52.219.24.113 gw $1
route add -host 52.219.32.77 gw $1
route add -host 52.219.4.154 gw $1
route add -host 52.219.74.76 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.28.204.65 gw $1
route add -host 52.35.140.58 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.38.128.79 gw $1
...
route add -host 52.8.33.170 gw $1
route add -host 52.85.12.105 gw $1
route add -host 52.85.12.106 gw $1
route add -host 52.85.12.123 gw $1
route add -host 52.85.12.145 gw $1
route add -host 52.85.12.16 gw $1
route add -host 52.85.12.179 gw $1
route add -host 52.85.12.18 gw $1
route add -host 52.85.12.180 gw $1
route add -host 52.85.12.191 gw $1
route add -host 52.85.12.193 gw $1
route add -host 52.85.12.194 gw $1
route add -host 52.85.12.196 gw $1
route add -host 52.85.12.204 gw $1
route add -host 52.85.12.212 gw $1
route add -host 52.85.12.213 gw $1
route add -host 52.85.12.223 gw $1
route add -host 52.85.12.254 gw $1
route add -host 52.85.12.35 gw $1
route add -host 52.85.12.59 gw $1
route add -host 52.85.12.82 gw $1
route add -host 52.85.12.9 gw $1
route add -host 52.85.12.98 gw $1
route add -host 52.85.13.4 gw $1
route add -host 52.85.13.7 gw $1
route add -host 52.85.15.93 gw $1
route add -host 52.95.132.13 gw $1
route add -host 52.95.165.43 gw $1
route add -host 54.169.27.21 gw $1
route add -host 54.192.235.52 gw $1
route add -host 54.193.253.2 gw $1
route add -host 54.209.129.43 gw $1
route add -host 54.210.144.50 gw $1
route add -host 54.215.199.132 gw $1
route add -host 54.230.235.26 gw $1
route add -host 54.235.253.182 gw $1
route add -host 54.236.109.127 gw $1
route add -host 54.236.70.234 gw $1
route add -host 54.239.194.202 gw $1
...
route add -host 54.70.209.189 gw $1
...
route add -host 74.125.126.109 gw $1
...
#Last updated:  2019-02-14T18:56:46+08:00
