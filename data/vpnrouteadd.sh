...
route add -host 108.177.96.93 gw $1
...
route add -host 13.35.126.58 gw $1
...
route add -host 173.194.66.94 gw $1
...
route add -host 3.93.94.64 gw $1
...
route add -host 52.217.8.182 gw $1
route add -host 52.218.250.120 gw $1
route add -host 52.218.88.51 gw $1
...
route add -host 52.27.170.221 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-12T22:03:02+08:00
