...
route add -host 104.118.6.149 gw $1
...
route add -host 104.77.35.126 gw $1
...
route add -host 172.217.24.67 gw $1
...
route add -host 180.222.102.155 gw $1
route add -host 18.195.68.21 gw $1
...
route add -host 216.58.196.244 gw $1
...
route add -host 23.210.215.74 gw $1
route add -host 23.210.215.97 gw $1
...
route add -host 23.34.61.10 gw $1
route add -host 23.34.61.11 gw $1
route add -host 23.34.61.137 gw $1
route add -host 23.34.61.138 gw $1
route add -host 23.34.61.139 gw $1
route add -host 23.34.61.144 gw $1
route add -host 23.34.61.145 gw $1
route add -host 23.34.61.146 gw $1
route add -host 23.34.61.147 gw $1
route add -host 23.34.61.152 gw $1
route add -host 23.34.61.153 gw $1
route add -host 23.34.61.154 gw $1
route add -host 23.34.61.155 gw $1
route add -host 23.34.61.16 gw $1
route add -host 23.34.61.160 gw $1
route add -host 23.34.61.161 gw $1
route add -host 23.34.61.162 gw $1
route add -host 23.34.61.163 gw $1
route add -host 23.34.61.168 gw $1
route add -host 23.34.61.169 gw $1
route add -host 23.34.61.17 gw $1
route add -host 23.34.61.170 gw $1
route add -host 23.34.61.171 gw $1
route add -host 23.34.61.176 gw $1
route add -host 23.34.61.177 gw $1
route add -host 23.34.61.18 gw $1
route add -host 23.34.61.19 gw $1
route add -host 23.34.61.24 gw $1
route add -host 23.34.61.25 gw $1
route add -host 23.34.61.26 gw $1
route add -host 23.34.61.27 gw $1
route add -host 23.34.61.32 gw $1
route add -host 23.34.61.33 gw $1
route add -host 23.34.61.34 gw $1
route add -host 23.34.61.35 gw $1
route add -host 23.34.61.40 gw $1
route add -host 23.34.61.41 gw $1
route add -host 23.34.61.42 gw $1
route add -host 23.34.61.8 gw $1
route add -host 23.42.103.113 gw $1
route add -host 23.57.66.40 gw $1
route add -host 23.67.180.20 gw $1
...
route add -host 34.195.224.249 gw $1
route add -host 34.205.207.145 gw $1
route add -host 34.218.107.93 gw $1
route add -host 34.228.128.195 gw $1
route add -host 34.232.127.22 gw $1
...
route add -host 40.100.52.114 gw $1
...
route add -host 52.216.162.43 gw $1
route add -host 52.218.209.40 gw $1
route add -host 52.218.36.194 gw $1
route add -host 52.219.20.17 gw $1
route add -host 52.219.40.182 gw $1
route add -host 52.219.68.92 gw $1
...
route add -host 52.85.12.133 gw $1
route add -host 52.85.12.147 gw $1
route add -host 52.85.12.155 gw $1
...
route add -host 52.85.12.241 gw $1
...
route add -host 99.84.74.127 gw $1
...
#Last updated:  2019-01-30T18:56:49+08:00
