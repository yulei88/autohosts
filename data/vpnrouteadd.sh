...
route add -host 3.93.202.32 gw $1
...
route add -host 52.216.184.45 gw $1
route add -host 52.216.248.52 gw $1
route add -host 52.218.242.192 gw $1
route add -host 52.218.61.27 gw $1
...
route add -host 52.3.8.132 gw $1
...
route add -host 54.184.223.136 gw $1
...
route add -host 99.84.170.50 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-07-31T22:08:47+08:00
