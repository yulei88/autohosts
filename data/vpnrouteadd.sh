...
route add -host 125.56.201.139 gw $1
...
route add -host 13.224.143.105 gw $1
route add -host 13.224.143.106 gw $1
route add -host 13.224.143.129 gw $1
route add -host 13.224.143.14 gw $1
route add -host 13.224.143.38 gw $1
route add -host 13.224.143.55 gw $1
route add -host 13.224.143.62 gw $1
route add -host 13.224.143.73 gw $1
route add -host 13.224.144.67 gw $1
route add -host 13.224.148.180 gw $1
route add -host 13.224.148.9 gw $1
route add -host 13.224.150.110 gw $1
route add -host 13.249.144.10 gw $1
route add -host 13.249.146.114 gw $1
route add -host 13.249.146.117 gw $1
route add -host 13.249.146.122 gw $1
route add -host 13.249.146.36 gw $1
route add -host 13.249.146.40 gw $1
route add -host 13.249.146.44 gw $1
route add -host 13.249.146.78 gw $1
route add -host 13.249.147.46 gw $1
route add -host 13.249.147.52 gw $1
route add -host 13.249.147.64 gw $1
route add -host 13.249.150.190 gw $1
route add -host 13.249.157.96 gw $1
route add -host 13.249.158.243 gw $1
route add -host 13.251.73.118 gw $1
route add -host 133.152.43.29 gw $1
route add -host 13.32.197.14 gw $1
route add -host 13.32.230.243 gw $1
...
route add -host 18.197.14.159 gw $1
...
route add -host 209.85.232.27 gw $1
...
route add -host 23.194.210.236 gw $1
route add -host 23.194.224.71 gw $1
route add -host 23.194.224.79 gw $1
route add -host 23.194.240.134 gw $1
route add -host 23.194.241.233 gw $1
route add -host 23.194.247.140 gw $1
route add -host 23.202.138.24 gw $1
route add -host 23.227.38.32 gw $1
route add -host 23.227.38.64 gw $1
route add -host 23.32.248.43 gw $1
route add -host 23.34.61.120 gw $1
...
route add -host 23.46.220.75 gw $1
...
route add -host 34.192.19.119 gw $1
route add -host 34.202.246.86 gw $1
route add -host 34.209.112.55 gw $1
...
route add -host 52.197.147.134 gw $1
route add -host 52.199.134.57 gw $1
route add -host 52.199.27.22 gw $1
route add -host 52.216.147.93 gw $1
route add -host 52.216.186.203 gw $1
route add -host 52.218.108.155 gw $1
route add -host 52.218.234.128 gw $1
route add -host 52.219.0.146 gw $1
route add -host 52.219.24.1 gw $1
route add -host 52.219.40.202 gw $1
route add -host 52.219.72.143 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.37.124.246 gw $1
route add -host 52.39.74.21 gw $1
route add -host 52.44.48.38 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.5.190.166 gw $1
route add -host 52.54.232.76 gw $1
route add -host 52.55.135.251 gw $1
route add -host 52.72.218.17 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.84.167.94 gw $1
route add -host 52.8.42.89 gw $1
route add -host 52.9.153.141 gw $1
route add -host 52.95.132.17 gw $1
route add -host 52.95.163.26 gw $1
route add -host 54.146.140.99 gw $1
route add -host 54.158.4.217 gw $1
route add -host 54.172.115.1 gw $1
route add -host 54.183.152.138 gw $1
route add -host 54.193.253.3 gw $1
route add -host 54.215.202.46 gw $1
...
route add -host 54.85.203.93 gw $1
...
route add -host 69.192.4.10 gw $1
route add -host 69.192.4.11 gw $1
route add -host 69.192.4.16 gw $1
route add -host 69.192.4.17 gw $1
route add -host 69.192.4.19 gw $1
route add -host 69.192.4.24 gw $1
route add -host 69.192.4.25 gw $1
route add -host 69.192.4.26 gw $1
route add -host 69.192.4.27 gw $1
route add -host 69.192.4.32 gw $1
route add -host 69.192.4.33 gw $1
route add -host 69.192.4.34 gw $1
route add -host 69.192.4.35 gw $1
route add -host 69.192.4.41 gw $1
route add -host 69.192.4.42 gw $1
route add -host 69.192.4.43 gw $1
route add -host 69.192.4.48 gw $1
route add -host 69.192.4.49 gw $1
route add -host 69.192.4.51 gw $1
route add -host 69.192.4.56 gw $1
route add -host 69.192.4.57 gw $1
route add -host 69.192.4.64 gw $1
route add -host 69.192.4.65 gw $1
route add -host 69.192.4.66 gw $1
route add -host 69.192.4.67 gw $1
route add -host 69.192.4.8 gw $1
route add -host 69.192.4.82 gw $1
route add -host 69.192.4.83 gw $1
route add -host 69.192.4.88 gw $1
route add -host 69.192.4.89 gw $1
route add -host 69.192.4.9 gw $1
route add -host 69.192.4.91 gw $1
route add -host 69.192.4.96 gw $1
...
route add -host 99.86.129.11 gw $1
route add -host 99.86.129.111 gw $1
route add -host 99.86.129.37 gw $1
route add -host 99.86.129.42 gw $1
route add -host 99.86.129.63 gw $1
...
route add -host 99.86.199.110 gw $1
route add -host 99.86.199.112 gw $1
route add -host 99.86.199.113 gw $1
route add -host 99.86.199.126 gw $1
route add -host 99.86.199.29 gw $1
route add -host 99.86.199.6 gw $1
route add -host 99.86.199.69 gw $1
route add -host 99.86.199.8 gw $1
route add -host 99.86.199.88 gw $1
route add -host 99.86.199.97 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-08-30T18:56:21+08:00
