...
route add -host 13.227.73.63 gw $1
...
route add -host 173.194.203.91 gw $1
...
route add -host 52.20.136.82 gw $1
route add -host 52.203.121.28 gw $1
route add -host 52.216.169.131 gw $1
route add -host 52.217.36.86 gw $1
...
route add -host 52.84.121.15 gw $1
route add -host 52.85.108.35 gw $1
route add -host 52.95.128.43 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-03T13:12:48+08:00
