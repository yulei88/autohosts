...
route add -host 13.32.77.99 gw $1
...
route add -host 143.204.129.62 gw $1
...
route add -host 34.224.228.45 gw $1
...
route add -host 52.216.132.53 gw $1
route add -host 52.217.46.180 gw $1
route add -host 52.218.184.192 gw $1
...
route add -host 54.184.80.60 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-10T09:46:49+08:00
