...
route add -host 34.200.8.183 gw $1
...
route add -host 52.216.146.155 gw $1
route add -host 52.216.226.195 gw $1
route add -host 52.218.245.16 gw $1
route add -host 52.218.24.75 gw $1
...
route add -host 52.85.0.201 gw $1
route add -host 52.85.0.205 gw $1
route add -host 52.85.3.249 gw $1
route add -host 52.85.3.42 gw $1
...
route add -host 52.9.6.210 gw $1
...
route add -host 54.192.111.108 gw $1
...
route add -host 54.230.111.192 gw $1
route add -host 54.230.111.3 gw $1
route add -host 54.231.50.83 gw $1
...
route add -host 74.125.195.120 gw $1
...
#Last updated:  2019-06-20T18:56:30+08:00
