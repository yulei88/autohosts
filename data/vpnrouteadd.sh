...
route add -host 104.27.172.221 gw $1
...
route add -host 13.225.145.121 gw $1
route add -host 13.225.145.79 gw $1
...
route add -host 13.32.53.118 gw $1
route add -host 13.32.53.127 gw $1
route add -host 13.32.53.13 gw $1
route add -host 13.32.53.50 gw $1
route add -host 13.32.53.60 gw $1
...
route add -host 23.42.18.198 gw $1
...
route add -host 3.220.215.245 gw $1
route add -host 34.206.166.95 gw $1
route add -host 34.206.85.51 gw $1
...
route add -host 52.216.200.219 gw $1
route add -host 52.216.200.77 gw $1
route add -host 52.218.246.160 gw $1
...
route add -host 52.29.54.215 gw $1
...
route add -host 54.200.126.140 gw $1
...
#Last updated:  2020-04-17T21:59:03+08:00
