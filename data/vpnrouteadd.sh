...
route add -host 13.225.103.22 gw $1
...
route add -host 143.204.131.22 gw $1
...
route add -host 3.211.123.255 gw $1
...
route add -host 40.90.136.1 gw $1
...
route add -host 52.216.184.101 gw $1
route add -host 52.218.248.24 gw $1
...
route add -host 52.219.140.95 gw $1
...
route add -host 54.85.179.35 gw $1
