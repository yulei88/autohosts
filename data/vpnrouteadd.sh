...
route add -host 13.225.176.36 gw $1
...
route add -host 13.32.54.71 gw $1
route add -host 13.32.54.77 gw $1
route add -host 13.32.55.8 gw $1
route add -host 13.33.174.100 gw $1
...
route add -host 13.33.174.83 gw $1
route add -host 13.33.174.86 gw $1
...
route add -host 172.217.195.120 gw $1
...
route add -host 52.216.112.171 gw $1
route add -host 52.216.97.195 gw $1
route add -host 52.217.37.62 gw $1
route add -host 52.218.21.154 gw $1
...
route add -host 54.201.189.175 gw $1
...
#Last updated:  2019-10-05T14:00:38+08:00
