...
route add -host 13.227.73.22 gw $1
...
route add -host 172.253.122.94 gw $1
...
route add -host 3.215.5.203 gw $1
...
route add -host 52.207.120.15 gw $1
route add -host 52.216.137.100 gw $1
route add -host 52.217.45.54 gw $1
route add -host 52.218.246.224 gw $1
...
route add -host 52.71.223.34 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-30T09:45:13+08:00
