...
route add -host 13.32.254.190 gw $1
route add -host 13.32.254.199 gw $1
route add -host 13.32.254.208 gw $1
route add -host 13.32.254.48 gw $1
...
route add -host 52.216.21.61 gw $1
route add -host 52.216.98.51 gw $1
route add -host 52.216.98.91 gw $1
route add -host 52.218.194.8 gw $1
route add -host 52.218.84.210 gw $1
route add -host 52.219.24.113 gw $1
route add -host 52.219.40.97 gw $1
...
route add -host 54.193.31.241 gw $1
...
route add -host 74.125.204.103 gw $1
...
#Last updated:  2018-11-05T05:57:44+08:00
