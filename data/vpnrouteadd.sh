...
route add -host 107.152.27.207 gw $1
...
route add -host 13.124.109.158 gw $1
...
route add -host 172.217.17.227 gw $1
route add -host 172.217.18.131 gw $1
route add -host 172.217.23.3 gw $1
...
route add -host 18.233.25.127 gw $1
...
route add -host 34.214.242.67 gw $1
route add -host 34.236.177.61 gw $1
...
route add -host 3.90.211.181 gw $1
...
route add -host 52.216.177.35 gw $1
route add -host 52.218.36.98 gw $1
route add -host 52.219.0.178 gw $1
route add -host 52.219.116.9 gw $1
route add -host 52.219.36.85 gw $1
route add -host 52.219.73.135 gw $1
...
route add -host 54.85.203.203 gw $1
...
route add -host 69.147.86.12 gw $1
...
#Last updated:  2019-03-27T19:01:18+08:00
