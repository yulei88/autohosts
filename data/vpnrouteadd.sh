...
route add -host 13.226.238.22 gw $1
...
route add -host 18.197.83.36 gw $1
...
route add -host 23.194.96.245 gw $1
...
route add -host 34.208.226.217 gw $1
route add -host 34.213.71.239 gw $1
...
route add -host 52.216.178.173 gw $1
route add -host 52.216.90.60 gw $1
route add -host 52.218.128.8 gw $1
route add -host 52.218.40.3 gw $1
route add -host 52.219.120.128 gw $1
route add -host 52.219.124.222 gw $1
route add -host 52.219.1.34 gw $1
route add -host 52.219.75.103 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.52.210.163 gw $1
route add -host 52.54.193.72 gw $1
route add -host 52.73.64.69 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.89.251.30 gw $1
route add -host 52.95.128.63 gw $1
...
route add -host 64.95.129.66 gw $1
...
route add -host 99.84.50.101 gw $1
route add -host 99.84.50.118 gw $1
route add -host 99.84.50.16 gw $1
route add -host 99.84.50.19 gw $1
route add -host 99.84.50.29 gw $1
route add -host 99.84.50.31 gw $1
route add -host 99.84.50.67 gw $1
...
#Last updated:  2020-05-04T22:01:31+08:00
