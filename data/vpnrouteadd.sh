...
route add -host 104.78.87.7 gw $1
route add -host 104.78.88.84 gw $1
...
route add -host 13.225.167.102 gw $1
route add -host 13.225.167.31 gw $1
route add -host 13.225.167.63 gw $1
route add -host 13.225.167.78 gw $1
route add -host 13.225.167.80 gw $1
route add -host 13.225.167.94 gw $1
route add -host 13.225.167.97 gw $1
route add -host 13.226.210.73 gw $1
route add -host 13.226.214.47 gw $1
route add -host 13.226.214.97 gw $1
route add -host 13.226.254.22 gw $1
route add -host 13.226.254.33 gw $1
route add -host 13.226.254.51 gw $1
route add -host 13.249.165.101 gw $1
route add -host 13.249.165.103 gw $1
route add -host 13.249.165.13 gw $1
route add -host 13.249.165.80 gw $1
route add -host 13.249.165.84 gw $1
route add -host 13.249.165.99 gw $1
route add -host 13.249.168.90 gw $1
...
route add -host 142.250.107.136 gw $1
route add -host 143.204.73.10 gw $1
route add -host 143.204.73.107 gw $1
route add -host 143.204.73.114 gw $1
route add -host 143.204.73.115 gw $1
route add -host 143.204.73.119 gw $1
route add -host 143.204.73.12 gw $1
route add -host 143.204.73.128 gw $1
route add -host 143.204.73.16 gw $1
route add -host 143.204.73.24 gw $1
route add -host 143.204.73.35 gw $1
route add -host 143.204.73.41 gw $1
route add -host 143.204.73.53 gw $1
route add -host 143.204.73.64 gw $1
route add -host 143.204.73.71 gw $1
route add -host 143.204.73.77 gw $1
route add -host 143.204.73.9 gw $1
route add -host 143.204.73.97 gw $1
...
route add -host 162.125.82.13 gw $1
route add -host 162.125.82.14 gw $1
route add -host 162.125.82.15 gw $1
route add -host 162.125.82.16 gw $1
route add -host 162.125.82.17 gw $1
route add -host 162.125.82.19 gw $1
...
route add -host 172.217.16.206 gw $1
...
route add -host 172.67.201.56 gw $1
...
route add -host 192.30.255.112 gw $1
...
route add -host 216.219.114.224 gw $1
...
route add -host 23.45.51.139 gw $1
...
route add -host 3.210.52.228 gw $1
route add -host 3.219.177.99 gw $1
route add -host 34.195.78.105 gw $1
route add -host 34.223.197.210 gw $1
route add -host 35.155.228.151 gw $1
...
route add -host 52.1.73.80 gw $1
route add -host 52.200.54.57 gw $1
route add -host 52.202.140.148 gw $1
route add -host 52.21.219.104 gw $1
route add -host 52.216.110.117 gw $1
route add -host 52.216.84.171 gw $1
route add -host 52.218.112.163 gw $1
route add -host 52.218.144.72 gw $1
route add -host 52.219.120.88 gw $1
route add -host 52.219.124.150 gw $1
route add -host 52.219.4.32 gw $1
route add -host 52.219.75.87 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.41.142.207 gw $1
route add -host 52.42.227.25 gw $1
route add -host 52.44.138.243 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.52.181.180 gw $1
route add -host 52.55.198.78 gw $1
route add -host 52.68.51.170 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.86.117.182 gw $1
route add -host 52.88.195.29 gw $1
route add -host 52.95.129.19 gw $1
route add -host 52.95.165.35 gw $1
route add -host 54.153.94.21 gw $1
route add -host 54.164.224.80 gw $1
route add -host 54.165.0.68 gw $1
...
route add -host 54.250.252.49 gw $1
...
route add -host 65.9.42.107 gw $1
route add -host 65.9.42.12 gw $1
route add -host 65.9.42.20 gw $1
route add -host 65.9.42.63 gw $1
route add -host 65.9.42.72 gw $1
route add -host 65.9.42.87 gw $1
...
route add -host 99.84.47.113 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-28T05:52:05+08:00
