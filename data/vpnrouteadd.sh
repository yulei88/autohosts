...
route add -host 172.217.203.120 gw $1
...
route add -host 3.224.92.118 gw $1
...
route add -host 52.216.137.238 gw $1
route add -host 52.217.16.140 gw $1
route add -host 52.218.100.155 gw $1
route add -host 52.218.204.192 gw $1
route add -host 52.219.116.224 gw $1
route add -host 52.219.132.98 gw $1
route add -host 52.219.16.2 gw $1
...
route add -host 99.86.33.126 gw $1
route add -host 99.86.33.21 gw $1
route add -host 99.86.33.70 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-08T22:03:55+08:00
