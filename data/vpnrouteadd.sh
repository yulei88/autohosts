...
#
route add -host 100.26.118.212 gw $1
...
route add -host 172.217.12.4 gw $1
...
route add -host 18.182.93.45 gw $1
...
route add -host 23.195.91.200 gw $1
...
route add -host 40.90.136.20 gw $1
...
route add -host 54.237.27.14 gw $1
...
route add -host 64.233.169.94 gw $1
...
route add -host 99.84.137.22 gw $1
route add -host 99.84.137.37 gw $1
route add -host 99.84.137.46 gw $1
route add -host 99.84.137.62 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-02-28T13:16:56+08:00
