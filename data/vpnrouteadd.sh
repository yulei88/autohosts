...
route add -host 104.118.6.181 gw $1
route add -host 104.118.6.195 gw $1
route add -host 104.16.103.5 gw $1
...
route add -host 104.244.46.200 gw $1
...
route add -host 108.177.104.27 gw $1
route add -host 108.177.12.108 gw $1
...
route add -host 172.217.161.228 gw $1
...
route add -host 172.217.26.68 gw $1
...
route add -host 18.196.114.223 gw $1
...
route add -host 203.208.43.111 gw $1
...
route add -host 216.58.197.205 gw $1
...
route add -host 216.58.199.228 gw $1
...
route add -host 23.48.32.35 gw $1
route add -host 23.65.182.155 gw $1
...
route add -host 50.18.217.98 gw $1
route add -host 50.18.252.43 gw $1
route add -host 52.1.172.141 gw $1
route add -host 52.119.161.208 gw $1
route add -host 52.203.236.187 gw $1
route add -host 52.216.129.187 gw $1
route add -host 52.216.130.171 gw $1
route add -host 52.216.163.157 gw $1
route add -host 52.218.240.248 gw $1
route add -host 52.218.36.26 gw $1
route add -host 52.219.0.76 gw $1
route add -host 52.219.20.45 gw $1
route add -host 52.219.32.133 gw $1
route add -host 52.219.72.115 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.22.243.135 gw $1
route add -host 52.35.140.58 gw $1
route add -host 52.35.190.21 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.53.89.64 gw $1
route add -host 52.7.11.163 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.85.12.102 gw $1
route add -host 52.85.12.106 gw $1
route add -host 52.85.12.109 gw $1
route add -host 52.85.12.110 gw $1
route add -host 52.85.12.118 gw $1
route add -host 52.85.12.123 gw $1
route add -host 52.85.12.137 gw $1
route add -host 52.85.12.147 gw $1
route add -host 52.85.12.203 gw $1
route add -host 52.85.12.204 gw $1
route add -host 52.85.12.21 gw $1
route add -host 52.85.12.211 gw $1
route add -host 52.85.12.218 gw $1
route add -host 52.85.12.242 gw $1
route add -host 52.85.12.250 gw $1
route add -host 52.85.12.26 gw $1
route add -host 52.85.12.3 gw $1
route add -host 52.85.12.32 gw $1
route add -host 52.85.12.35 gw $1
route add -host 52.85.12.46 gw $1
route add -host 52.85.12.65 gw $1
route add -host 52.85.12.68 gw $1
route add -host 52.85.12.7 gw $1
route add -host 52.85.12.79 gw $1
route add -host 52.85.12.8 gw $1
route add -host 52.85.12.9 gw $1
route add -host 52.85.13.44 gw $1
route add -host 52.85.13.70 gw $1
route add -host 52.85.15.82 gw $1
route add -host 52.87.70.195 gw $1
route add -host 52.9.109.157 gw $1
route add -host 52.95.131.58 gw $1
route add -host 52.95.163.50 gw $1
route add -host 54.156.212.69 gw $1
route add -host 54.169.27.21 gw $1
route add -host 54.186.65.1 gw $1
...
route add -host 54.230.235.14 gw $1
...
route add -host 69.192.3.10 gw $1
route add -host 69.192.3.19 gw $1
route add -host 69.192.3.27 gw $1
route add -host 69.192.3.32 gw $1
route add -host 69.192.3.34 gw $1
route add -host 72.246.188.17 gw $1
route add -host 72.246.189.10 gw $1
route add -host 72.246.189.11 gw $1
route add -host 72.246.189.17 gw $1
route add -host 72.246.189.18 gw $1
route add -host 72.246.189.24 gw $1
route add -host 72.246.189.8 gw $1
route add -host 72.246.190.16 gw $1
...
route add -host 74.125.200.147 gw $1
...
route add -host 74.125.24.147 gw $1
route add -host 74.125.68.94 gw $1
...
route add -host 99.84.74.111 gw $1
route add -host 99.84.74.128 gw $1
route add -host 99.84.74.15 gw $1
route add -host 99.84.74.2 gw $1
route add -host 99.84.74.50 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-02-04T18:57:08+08:00
