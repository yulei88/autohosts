...
route add -host 104.80.89.56 gw $1
...
route add -host 172.217.9.131 gw $1
...
route add -host 23.56.170.107 gw $1
...
route add -host 52.0.47.86 gw $1
route add -host 52.119.210.50 gw $1
route add -host 52.199.254.91 gw $1
route add -host 52.201.150.235 gw $1
route add -host 52.216.146.21 gw $1
route add -host 52.217.45.108 gw $1
route add -host 52.218.106.187 gw $1
route add -host 52.218.200.104 gw $1
...
route add -host 54.152.61.144 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-23T22:03:00+08:00
