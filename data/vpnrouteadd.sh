...
route add -host 13.224.41.124 gw $1
route add -host 13.224.41.31 gw $1
route add -host 13.224.41.34 gw $1
route add -host 13.224.41.80 gw $1
...
route add -host 13.33.68.12 gw $1
...
route add -host 52.216.95.45 gw $1
route add -host 52.217.93.156 gw $1
route add -host 52.218.137.0 gw $1
...
route add -host 54.183.95.234 gw $1
...
route add -host 74.125.130.101 gw $1
...
route add -host 74.125.142.137 gw $1
...
route add -host 74.125.70.94 gw $1
...
route add -host 99.84.198.67 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-10T13:17:14+08:00
