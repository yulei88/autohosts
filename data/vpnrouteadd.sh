...
route add -host 172.217.19.78 gw $1
...
route add -host 18.195.118.240 gw $1
...
route add -host 23.195.90.59 gw $1
...
route add -host 34.225.94.169 gw $1
...
route add -host 52.11.106.114 gw $1
route add -host 52.1.116.50 gw $1
route add -host 52.119.211.114 gw $1
route add -host 52.199.172.187 gw $1
route add -host 52.216.107.20 gw $1
route add -host 52.217.32.62 gw $1
route add -host 52.218.196.248 gw $1
route add -host 52.218.85.43 gw $1
route add -host 52.219.1.18 gw $1
route add -host 52.219.121.24 gw $1
...
route add -host 52.54.244.249 gw $1
route add -host 52.71.74.107 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.95.128.47 gw $1
route add -host 52.95.164.46 gw $1
route add -host 54.153.45.96 gw $1
...
#Last updated:  2020-10-12T13:18:14+08:00
