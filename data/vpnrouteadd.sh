...
route add -host 13.249.198.55 gw $1
route add -host 13.249.198.6 gw $1
...
route add -host 13.32.54.66 gw $1
...
route add -host 3.226.104.210 gw $1
route add -host 34.195.65.236 gw $1
...
route add -host 52.216.101.139 gw $1
route add -host 52.216.169.211 gw $1
route add -host 52.216.88.245 gw $1
route add -host 52.218.229.136 gw $1
route add -host 52.218.65.140 gw $1
route add -host 52.219.0.64 gw $1
route add -host 52.219.116.120 gw $1
route add -host 52.219.48.46 gw $1
...
route add -host 52.88.59.58 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-30T05:55:28+08:00
