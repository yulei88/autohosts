...
route add -host 13.56.86.216 gw $1
...
route add -host 52.216.85.133 gw $1
route add -host 52.21.76.84 gw $1
route add -host 52.217.88.148 gw $1
route add -host 52.218.180.32 gw $1
route add -host 52.218.24.131 gw $1
route add -host 52.219.112.176 gw $1
route add -host 52.219.140.31 gw $1
route add -host 52.219.1.78 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-05T09:50:08+08:00
