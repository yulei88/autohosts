...
route add -host 142.250.180.99 gw $1
...
route add -host 3.208.202.236 gw $1
...
route add -host 52.216.77.94 gw $1
route add -host 52.217.76.100 gw $1
route add -host 52.218.212.184 gw $1
route add -host 52.218.56.51 gw $1
route add -host 52.219.112.120 gw $1
route add -host 52.219.132.74 gw $1
route add -host 52.219.16.182 gw $1
...
route add -host 54.148.230.63 gw $1
route add -host 54.156.54.124 gw $1
...
route add -host 74.125.20.91 gw $1
...
route add -host 99.84.130.5 gw $1
...
route add -host 99.86.35.5 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-19T09:51:20+08:00
