...
route add -host 104.118.91.159 gw $1
...
route add -host 13.225.166.127 gw $1
route add -host 13.225.166.57 gw $1
route add -host 13.225.166.61 gw $1
route add -host 13.225.166.75 gw $1
...
route add -host 13.226.77.124 gw $1
route add -host 13.226.77.84 gw $1
route add -host 13.226.77.94 gw $1
route add -host 13.227.48.57 gw $1
route add -host 13.227.51.145 gw $1
route add -host 13.227.57.15 gw $1
route add -host 13.249.171.114 gw $1
...
route add -host 13.35.125.122 gw $1
route add -host 13.35.125.83 gw $1
route add -host 13.35.65.123 gw $1
route add -host 13.35.66.99 gw $1
route add -host 13.35.67.128 gw $1
route add -host 13.35.67.25 gw $1
route add -host 13.35.67.32 gw $1
route add -host 13.35.67.39 gw $1
route add -host 13.35.67.78 gw $1
route add -host 13.35.67.91 gw $1
route add -host 13.35.67.97 gw $1
...
route add -host 143.204.83.73 gw $1
route add -host 143.204.83.87 gw $1
...
route add -host 172.217.175.72 gw $1
...
route add -host 172.217.25.3 gw $1
...
route add -host 216.58.198.67 gw $1
...
route add -host 23.192.47.219 gw $1
route add -host 23.192.47.224 gw $1
route add -host 23.192.47.225 gw $1
route add -host 23.192.47.226 gw $1
route add -host 23.192.47.227 gw $1
route add -host 23.192.47.232 gw $1
route add -host 23.192.47.233 gw $1
route add -host 23.192.47.234 gw $1
route add -host 23.192.47.235 gw $1
route add -host 23.192.47.240 gw $1
...
route add -host 23.196.224.196 gw $1
...
route add -host 23.50.224.56 gw $1
route add -host 23.51.175.246 gw $1
route add -host 23.51.177.170 gw $1
route add -host 23.53.178.111 gw $1
route add -host 23.53.182.84 gw $1
route add -host 23.54.18.232 gw $1
...
route add -host 34.196.168.246 gw $1
route add -host 34.196.229.158 gw $1
route add -host 34.202.128.229 gw $1
route add -host 34.205.94.147 gw $1
route add -host 34.211.122.133 gw $1
route add -host 35.164.128.78 gw $1
...
route add -host 52.203.75.109 gw $1
route add -host 52.205.231.22 gw $1
route add -host 52.207.129.163 gw $1
route add -host 52.216.144.211 gw $1
route add -host 52.217.1.22 gw $1
route add -host 52.218.110.99 gw $1
route add -host 52.218.251.48 gw $1
route add -host 52.219.120.96 gw $1
route add -host 52.219.136.86 gw $1
route add -host 52.219.36.203 gw $1
route add -host 52.219.73.119 gw $1
...
route add -host 96.17.4.40 gw $1
...
route add -host 99.84.224.103 gw $1
route add -host 99.84.224.113 gw $1
route add -host 99.84.224.114 gw $1
route add -host 99.84.224.76 gw $1
...
route add -host 99.84.63.13 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-29T22:02:03+08:00
