...
route add -host 13.209.130.79 gw $1
...
route add -host 18.185.189.45 gw $1
...
route add -host 3.208.46.5 gw $1
route add -host 34.192.215.205 gw $1
route add -host 34.196.17.71 gw $1
route add -host 34.210.99.100 gw $1
route add -host 34.214.2.31 gw $1
route add -host 34.214.75.22 gw $1
route add -host 34.228.128.195 gw $1
route add -host 34.232.15.5 gw $1
...
route add -host 52.216.112.59 gw $1
route add -host 52.216.65.91 gw $1
route add -host 52.216.82.16 gw $1
route add -host 52.217.0.51 gw $1
route add -host 52.218.160.32 gw $1
route add -host 52.218.20.124 gw $1
...
#Last updated:  2019-04-05T18:57:14+08:00
