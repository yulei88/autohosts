...
route add -host 172.217.166.195 gw $1
...
route add -host 23.23.48.121 gw $1
...
route add -host 34.196.103.119 gw $1
...
route add -host 52.216.165.171 gw $1
route add -host 52.216.166.37 gw $1
route add -host 52.218.104.250 gw $1
...
route add -host 52.85.85.207 gw $1
route add -host 52.85.85.215 gw $1
route add -host 52.85.85.40 gw $1
route add -host 52.85.85.84 gw $1
route add -host 52.85.85.88 gw $1
...
route add -host 54.156.246.248 gw $1
route add -host 54.180.38.31 gw $1
...
#Last updated:  2019-03-24T18:58:32+08:00
