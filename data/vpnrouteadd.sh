...
route add -host 13.224.51.115 gw $1
route add -host 13.224.51.20 gw $1
route add -host 13.224.51.75 gw $1
...
route add -host 13.32.52.111 gw $1
...
route add -host 13.33.71.26 gw $1
route add -host 13.33.71.75 gw $1
...
route add -host 172.217.193.94 gw $1
...
route add -host 52.216.170.157 gw $1
...
route add -host 52.35.25.154 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.44.77.2 gw $1
...
route add -host 52.98.89.50 gw $1
...
#Last updated:  2019-12-22T22:01:15+08:00
