...
route add -host 216.58.201.163 gw $1
...
route add -host 23.46.210.176 gw $1
...
route add -host 52.204.203.28 gw $1
route add -host 52.216.132.147 gw $1
route add -host 52.216.137.30 gw $1
route add -host 52.218.16.4 gw $1
route add -host 52.218.240.48 gw $1
route add -host 52.219.20.13 gw $1
route add -host 52.219.40.5 gw $1
...
route add -host 52.85.12.152 gw $1
...
route add -host 52.85.12.217 gw $1
...
route add -host 54.164.180.146 gw $1
...
route add -host 54.210.84.87 gw $1
...
#Last updated:  2019-03-07T18:57:43+08:00
