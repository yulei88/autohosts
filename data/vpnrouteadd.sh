...
route add -host 104.78.94.208 gw $1
...
route add -host 13.224.11.51 gw $1
...
route add -host 13.225.167.62 gw $1
...
route add -host 142.250.113.26 gw $1
route add -host 142.250.68.99 gw $1
route add -host 142.250.73.195 gw $1
...
route add -host 143.204.73.52 gw $1
route add -host 143.204.73.53 gw $1
route add -host 143.204.73.60 gw $1
route add -host 143.204.73.80 gw $1
...
route add -host 172.217.175.232 gw $1
...
route add -host 23.44.7.59 gw $1
...
route add -host 34.232.37.224 gw $1
route add -host 35.173.80.2 gw $1
...
route add -host 52.204.230.201 gw $1
route add -host 52.217.71.134 gw $1
route add -host 52.217.82.36 gw $1
route add -host 52.218.209.48 gw $1
route add -host 52.218.61.251 gw $1
route add -host 52.219.117.40 gw $1
route add -host 52.219.36.203 gw $1
route add -host 52.219.4.104 gw $1
route add -host 52.219.75.147 gw $1
...
route add -host 52.52.117.56 gw $1
...
route add -host 52.95.128.123 gw $1
...
route add -host 65.9.42.24 gw $1
route add -host 65.9.42.31 gw $1
route add -host 65.9.42.40 gw $1
route add -host 65.9.42.41 gw $1
route add -host 65.9.42.43 gw $1
...
route add -host 99.86.34.106 gw $1
route add -host 99.86.34.112 gw $1
route add -host 99.86.34.8 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-28T22:09:00+08:00
