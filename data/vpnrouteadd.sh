...
route add -host 108.177.112.94 gw $1
...
route add -host 142.250.66.163 gw $1
...
route add -host 173.194.214.120 gw $1
...
route add -host 216.58.204.3 gw $1
...
route add -host 44.238.72.101 gw $1
...
route add -host 52.45.71.100 gw $1
...
route add -host 52.95.132.223 gw $1
...
route add -host 99.86.34.122 gw $1
route add -host 99.86.34.28 gw $1
route add -host 99.86.34.66 gw $1
route add -host 99.86.34.8 gw $1
route add -host 99.86.34.89 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-30T05:52:34+08:00
