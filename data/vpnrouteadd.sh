...
route add -host 117.104.138.183 gw $1
route add -host 117.104.138.25 gw $1
...
route add -host 13.33.212.171 gw $1
route add -host 13.33.213.108 gw $1
route add -host 13.33.213.115 gw $1
route add -host 13.33.213.118 gw $1
route add -host 13.33.213.120 gw $1
route add -host 13.33.213.18 gw $1
route add -host 13.33.213.19 gw $1
route add -host 13.33.213.24 gw $1
route add -host 13.33.213.34 gw $1
route add -host 13.33.213.40 gw $1
route add -host 13.33.213.59 gw $1
route add -host 13.33.213.69 gw $1
route add -host 13.33.213.8 gw $1
route add -host 13.33.213.80 gw $1
route add -host 13.33.213.85 gw $1
route add -host 13.33.213.89 gw $1
route add -host 13.33.213.96 gw $1
route add -host 13.33.231.128 gw $1
route add -host 13.33.231.57 gw $1
...
route add -host 143.204.81.70 gw $1
route add -host 143.204.83.12 gw $1
route add -host 143.204.83.44 gw $1
route add -host 143.204.83.48 gw $1
route add -host 143.204.83.67 gw $1
route add -host 143.204.83.68 gw $1
route add -host 143.204.83.76 gw $1
...
route add -host 173.194.205.27 gw $1
route add -host 173.194.207.127 gw $1
route add -host 173.194.219.26 gw $1
...
route add -host 18.185.46.39 gw $1
route add -host 18.215.75.52 gw $1
...
route add -host 185.26.182.111 gw $1
...
route add -host 199.59.148.137 gw $1
...
route add -host 216.58.197.1 gw $1
...
route add -host 23.194.248.247 gw $1
route add -host 23.20.12.2 gw $1
route add -host 23.217.125.3 gw $1
route add -host 23.227.38.32 gw $1
route add -host 23.227.38.64 gw $1
route add -host 23.35.192.250 gw $1
route add -host 23.41.81.91 gw $1
...
route add -host 34.196.18.235 gw $1
...
route add -host 34.236.10.192 gw $1
route add -host 35.172.7.61 gw $1
route add -host 35.211.48.243 gw $1
route add -host 37.0.86.6 gw $1
...
route add -host 52.200.190.123 gw $1
route add -host 52.20.43.115 gw $1
route add -host 52.216.17.192 gw $1
route add -host 52.218.248.16 gw $1
route add -host 52.218.64.172 gw $1
route add -host 52.219.28.29 gw $1
route add -host 52.219.36.150 gw $1
route add -host 52.219.4.4 gw $1
route add -host 52.219.73.52 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.40.170.113 gw $1
route add -host 52.46.157.11 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.72.118.74 gw $1
...
route add -host 52.85.12.141 gw $1
route add -host 52.85.12.176 gw $1
route add -host 52.85.12.184 gw $1
route add -host 52.85.12.187 gw $1
route add -host 52.85.13.3 gw $1
route add -host 52.86.175.242 gw $1
route add -host 52.95.131.66 gw $1
route add -host 52.95.165.10 gw $1
route add -host 54.149.49.103 gw $1
route add -host 54.164.96.228 gw $1
...
route add -host 54.230.172.60 gw $1
route add -host 54.231.33.138 gw $1
...
route add -host 54.67.5.92 gw $1
...
route add -host 64.233.179.26 gw $1
...
route add -host 64.71.134.72 gw $1
...
route add -host 74.125.23.125 gw $1
route add -host 74.125.23.128 gw $1
route add -host 74.125.23.138 gw $1
route add -host 74.125.23.147 gw $1
route add -host 74.125.23.188 gw $1
route add -host 74.125.23.190 gw $1
...
route add -host 96.7.54.10 gw $1
route add -host 96.7.54.105 gw $1
route add -host 96.7.54.106 gw $1
route add -host 96.7.54.107 gw $1
route add -host 96.7.54.11 gw $1
route add -host 96.7.54.112 gw $1
route add -host 96.7.54.113 gw $1
route add -host 96.7.54.114 gw $1
route add -host 96.7.54.115 gw $1
route add -host 96.7.54.122 gw $1
route add -host 96.7.54.123 gw $1
route add -host 96.7.54.128 gw $1
route add -host 96.7.54.129 gw $1
route add -host 96.7.54.130 gw $1
route add -host 96.7.54.131 gw $1
route add -host 96.7.54.16 gw $1
route add -host 96.7.54.17 gw $1
route add -host 96.7.54.18 gw $1
route add -host 96.7.54.19 gw $1
route add -host 96.7.54.24 gw $1
route add -host 96.7.54.25 gw $1
route add -host 96.7.54.26 gw $1
route add -host 96.7.54.27 gw $1
route add -host 96.7.54.32 gw $1
route add -host 96.7.54.33 gw $1
route add -host 96.7.54.34 gw $1
route add -host 96.7.54.35 gw $1
route add -host 96.7.54.40 gw $1
route add -host 96.7.54.41 gw $1
route add -host 96.7.54.43 gw $1
route add -host 96.7.54.48 gw $1
route add -host 96.7.54.49 gw $1
route add -host 96.7.54.50 gw $1
route add -host 96.7.54.51 gw $1
route add -host 96.7.54.56 gw $1
route add -host 96.7.54.58 gw $1
route add -host 96.7.54.59 gw $1
route add -host 96.7.54.65 gw $1
route add -host 96.7.54.66 gw $1
route add -host 96.7.54.72 gw $1
route add -host 96.7.54.73 gw $1
route add -host 96.7.54.74 gw $1
route add -host 96.7.54.75 gw $1
route add -host 96.7.54.8 gw $1
route add -host 96.7.54.80 gw $1
route add -host 96.7.54.81 gw $1
route add -host 96.7.54.82 gw $1
route add -host 96.7.54.83 gw $1
route add -host 96.7.54.88 gw $1
route add -host 96.7.54.89 gw $1
route add -host 96.7.54.9 gw $1
route add -host 96.7.54.90 gw $1
route add -host 96.7.54.96 gw $1
route add -host 96.7.54.97 gw $1
route add -host 96.7.54.99 gw $1
...
#Last updated:  2018-11-04T20:03:26+08:00
