...
route add -host 13.35.126.105 gw $1
route add -host 13.35.126.17 gw $1
route add -host 13.35.126.24 gw $1
...
route add -host 143.204.77.118 gw $1
...
route add -host 143.204.77.62 gw $1
route add -host 143.204.77.69 gw $1
...
route add -host 184.72.190.68 gw $1
...
route add -host 34.215.212.74 gw $1
route add -host 34.226.19.223 gw $1
route add -host 34.232.176.182 gw $1
route add -host 35.157.43.153 gw $1
...
route add -host 52.216.170.99 gw $1
route add -host 52.217.14.110 gw $1
route add -host 52.218.100.235 gw $1
route add -host 52.218.252.32 gw $1
...
route add -host 52.5.164.1 gw $1
...
route add -host 54.200.222.69 gw $1
...
#Last updated:  2020-03-13T13:10:34+08:00
