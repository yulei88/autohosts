...
route add -host 13.35.121.68 gw $1
...
route add -host 18.210.60.5 gw $1
...
route add -host 216.58.204.227 gw $1
...
route add -host 52.216.93.83 gw $1
route add -host 52.217.14.30 gw $1
route add -host 52.218.193.80 gw $1
route add -host 52.218.96.90 gw $1
route add -host 52.219.0.48 gw $1
route add -host 52.219.124.178 gw $1
...
route add -host 52.7.86.152 gw $1
route add -host 52.95.132.123 gw $1
...
route add -host 54.67.79.17 gw $1
...
route add -host 99.84.232.65 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-12T05:46:47+08:00
