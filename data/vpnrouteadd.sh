...
route add -host 13.231.94.80 gw $1
...
route add -host 13.57.76.185 gw $1
...
route add -host 184.26.253.176 gw $1
route add -host 184.26.253.181 gw $1
...
route add -host 23.44.74.158 gw $1
route add -host 23.44.7.51 gw $1
route add -host 23.44.7.66 gw $1
route add -host 23.45.50.10 gw $1
route add -host 23.45.50.106 gw $1
...
route add -host 52.216.115.37 gw $1
...
route add -host 52.219.48.50 gw $1
...
route add -host 54.176.175.170 gw $1
...
#Last updated:  2020-03-31T21:58:57+08:00
