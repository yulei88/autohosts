...
route add -host 172.67.196.18 gw $1
...
route add -host 216.58.201.78 gw $1
...
route add -host 52.216.114.117 gw $1
route add -host 52.217.66.28 gw $1
route add -host 52.218.101.35 gw $1
route add -host 52.218.245.136 gw $1
route add -host 52.219.116.72 gw $1
route add -host 52.219.129.62 gw $1
route add -host 52.219.136.46 gw $1
route add -host 52.219.75.187 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.29.51.150 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-12T22:08:29+08:00
