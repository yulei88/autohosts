...
route add -host 2.17.162.158 gw $1
...
route add -host 52.216.243.76 gw $1
route add -host 52.216.24.70 gw $1
route add -host 52.218.169.144 gw $1
route add -host 52.218.56.75 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-12-02T22:11:01+08:00
