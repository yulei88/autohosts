...
route add -host 13.56.88.89 gw $1
...
route add -host 2.20.218.77 gw $1
...
route add -host 52.216.64.163 gw $1
route add -host 52.217.43.52 gw $1
route add -host 52.218.217.232 gw $1
...
#Last updated:  2020-05-16T22:03:14+08:00
