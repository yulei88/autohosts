...
route add -host 104.31.88.183 gw $1
...
route add -host 13.224.13.118 gw $1
route add -host 13.224.13.50 gw $1
...
route add -host 13.227.60.100 gw $1
route add -host 13.227.60.113 gw $1
route add -host 13.227.60.119 gw $1
route add -host 13.227.60.30 gw $1
route add -host 13.227.60.33 gw $1
route add -host 13.227.60.54 gw $1
route add -host 13.227.60.61 gw $1
route add -host 13.227.60.84 gw $1
...
route add -host 18.185.210.72 gw $1
...
route add -host 23.195.89.155 gw $1
...
route add -host 23.38.73.25 gw $1
...
route add -host 3.211.120.82 gw $1
...
route add -host 52.216.140.14 gw $1
route add -host 52.216.239.179 gw $1
route add -host 52.218.235.40 gw $1
route add -host 52.218.40.19 gw $1
route add -host 52.219.116.88 gw $1
route add -host 52.219.129.14 gw $1
route add -host 52.219.16.110 gw $1
route add -host 52.219.73.147 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.3.3.17 gw $1
route add -host 52.35.3.25 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.4.135.80 gw $1
...
route add -host 52.9.91.148 gw $1
route add -host 54.193.253.0 gw $1
route add -host 54.208.72.165 gw $1
...
route add -host 74.125.203.127 gw $1
...
route add -host 99.86.38.109 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-02T05:44:49+08:00
