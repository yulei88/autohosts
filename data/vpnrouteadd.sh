...
route add -host 104.102.144.166 gw $1
route add -host 104.116.243.155 gw $1
...
route add -host 104.244.46.135 gw $1
route add -host 104.244.46.136 gw $1
route add -host 104.25.114.6 gw $1
...
route add -host 119.161.5.26 gw $1
...
route add -host 120.29.144.113 gw $1
...
route add -host 120.29.144.123 gw $1
route add -host 120.29.144.128 gw $1
...
route add -host 145.131.132.74 gw $1
...
route add -host 172.217.160.4 gw $1
...
route add -host 172.217.25.235 gw $1
...
route add -host 173.194.207.27 gw $1
...
route add -host 18.194.154.53 gw $1
route add -host 18.211.216.175 gw $1
route add -host 18.235.213.168 gw $1
...
route add -host 216.58.192.35 gw $1
...
route add -host 216.58.197.17 gw $1
...
route add -host 216.58.203.67 gw $1
...
route add -host 23.23.26.29 gw $1
route add -host 23.65.182.147 gw $1
route add -host 23.65.182.171 gw $1
...
route add -host 34.195.161.0 gw $1
route add -host 34.196.17.71 gw $1
route add -host 34.202.100.20 gw $1
route add -host 34.205.207.145 gw $1
route add -host 34.211.124.105 gw $1
route add -host 34.228.128.195 gw $1
route add -host 34.239.24.102 gw $1
route add -host 35.161.116.170 gw $1
route add -host 35.169.45.146 gw $1
...
route add -host 40.101.144.98 gw $1
...
route add -host 52.203.70.197 gw $1
route add -host 52.216.139.93 gw $1
route add -host 52.216.168.251 gw $1
route add -host 52.216.99.35 gw $1
route add -host 52.218.216.80 gw $1
route add -host 52.218.64.180 gw $1
route add -host 52.219.116.24 gw $1
route add -host 52.219.40.85 gw $1
route add -host 52.219.4.150 gw $1
route add -host 52.219.72.80 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.34.28.246 gw $1
...
route add -host 52.7.11.163 gw $1
...
route add -host 52.85.12.115 gw $1
route add -host 52.85.12.120 gw $1
route add -host 52.85.12.126 gw $1
route add -host 52.85.12.128 gw $1
route add -host 52.85.12.137 gw $1
route add -host 52.85.12.147 gw $1
route add -host 52.85.12.168 gw $1
...
route add -host 52.85.12.254 gw $1
route add -host 52.85.12.28 gw $1
route add -host 52.85.12.38 gw $1
route add -host 52.85.12.48 gw $1
route add -host 52.85.12.52 gw $1
route add -host 52.85.12.60 gw $1
route add -host 52.85.12.62 gw $1
route add -host 52.85.12.67 gw $1
route add -host 52.85.12.7 gw $1
route add -host 52.85.12.9 gw $1
route add -host 52.85.13.4 gw $1
route add -host 52.85.13.50 gw $1
route add -host 52.85.13.7 gw $1
route add -host 52.85.15.82 gw $1
route add -host 52.95.132.37 gw $1
route add -host 52.95.165.50 gw $1
route add -host 54.153.81.237 gw $1
route add -host 54.169.27.21 gw $1
route add -host 54.183.44.206 gw $1
route add -host 54.192.235.95 gw $1
route add -host 54.193.253.6 gw $1
route add -host 54.213.108.65 gw $1
route add -host 54.230.235.87 gw $1
route add -host 54.235.253.182 gw $1
route add -host 54.236.109.127 gw $1
...
route add -host 64.233.187.132 gw $1
...
route add -host 72.246.188.10 gw $1
route add -host 72.246.188.11 gw $1
route add -host 72.246.189.216 gw $1
route add -host 72.246.189.233 gw $1
route add -host 72.246.189.241 gw $1
route add -host 72.246.190.11 gw $1
route add -host 72.246.190.27 gw $1
route add -host 72.246.190.32 gw $1
route add -host 72.246.190.42 gw $1
route add -host 72.246.190.43 gw $1
route add -host 72.246.190.9 gw $1
...
route add -host 99.84.74.43 gw $1
route add -host 99.84.74.73 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-01-31T18:55:43+08:00
