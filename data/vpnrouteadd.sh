...
route add -host 172.217.169.67 gw $1
...
route add -host 3.214.102.132 gw $1
...
route add -host 34.206.33.202 gw $1
...
route add -host 44.238.184.89 gw $1
...
route add -host 52.217.48.124 gw $1
route add -host 52.217.66.238 gw $1
route add -host 52.218.216.64 gw $1
route add -host 52.218.57.235 gw $1
route add -host 52.219.116.208 gw $1
route add -host 52.219.136.70 gw $1
route add -host 52.219.41.10 gw $1
route add -host 52.219.47.99 gw $1
...
route add -host 52.95.132.187 gw $1
...
#Last updated:  2020-10-30T09:51:57+08:00
