...
route add -host 13.249.25.93 gw $1
route add -host 13.249.62.39 gw $1
route add -host 13.251.73.118 gw $1
route add -host 133.152.43.29 gw $1
route add -host 13.32.108.103 gw $1
...
route add -host 52.217.16.156 gw $1
route add -host 52.218.137.72 gw $1
route add -host 52.218.60.219 gw $1
route add -host 52.219.120.152 gw $1
route add -host 52.219.133.6 gw $1
route add -host 52.219.4.12 gw $1
route add -host 52.219.75.223 gw $1
...
route add -host 52.95.128.99 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-11-16T09:53:36+08:00
