...
route add -host 13.57.122.149 gw $1
...
route add -host 172.217.174.67 gw $1
...
route add -host 34.202.42.246 gw $1
...
route add -host 44.240.45.32 gw $1
...
route add -host 52.217.111.70 gw $1
route add -host 52.217.85.196 gw $1
route add -host 52.218.180.88 gw $1
route add -host 52.218.31.43 gw $1
