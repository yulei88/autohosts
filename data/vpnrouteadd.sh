...
route add -host 172.217.160.110 gw $1
...
route add -host 23.46.211.184 gw $1
...
route add -host 52.216.226.184 gw $1
...
route add -host 52.85.85.104 gw $1
route add -host 52.85.85.130 gw $1
route add -host 52.85.85.165 gw $1
route add -host 52.85.85.72 gw $1
route add -host 52.85.85.84 gw $1
route add -host 52.95.134.35 gw $1
route add -host 52.95.165.35 gw $1
route add -host 54.186.212.163 gw $1
route add -host 54.193.253.7 gw $1
route add -host 54.213.108.65 gw $1
route add -host 54.231.40.235 gw $1
...
#Last updated:  2019-03-21T18:59:24+08:00
