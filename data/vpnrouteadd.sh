...
route add -host 104.18.48.242 gw $1
...
route add -host 104.86.182.18 gw $1
...
route add -host 13.225.146.19 gw $1
...
route add -host 13.33.42.104 gw $1
route add -host 13.33.42.23 gw $1
route add -host 13.33.42.67 gw $1
route add -host 13.33.42.8 gw $1
route add -host 13.35.27.118 gw $1
route add -host 13.35.50.101 gw $1
...
route add -host 13.35.67.43 gw $1
route add -host 13.35.67.47 gw $1
route add -host 13.35.67.48 gw $1
route add -host 13.35.67.5 gw $1
route add -host 13.35.67.71 gw $1
...
route add -host 172.217.175.12 gw $1
...
route add -host 173.194.197.120 gw $1
...
route add -host 18.195.142.1 gw $1
...
route add -host 23.192.44.35 gw $1
route add -host 23.192.46.106 gw $1
route add -host 23.192.46.107 gw $1
route add -host 23.192.46.112 gw $1
route add -host 23.192.46.113 gw $1
route add -host 23.192.46.114 gw $1
route add -host 23.192.46.115 gw $1
route add -host 23.192.46.121 gw $1
route add -host 23.192.46.123 gw $1
route add -host 23.192.46.128 gw $1
route add -host 23.192.46.129 gw $1
route add -host 23.192.46.130 gw $1
route add -host 23.192.46.138 gw $1
route add -host 23.192.46.139 gw $1
route add -host 23.192.46.144 gw $1
route add -host 23.192.46.145 gw $1
route add -host 23.192.46.146 gw $1
route add -host 23.192.46.147 gw $1
route add -host 23.192.46.154 gw $1
route add -host 23.192.46.155 gw $1
route add -host 23.192.46.160 gw $1
route add -host 23.192.46.161 gw $1
route add -host 23.192.46.162 gw $1
route add -host 23.192.46.169 gw $1
route add -host 23.192.46.170 gw $1
route add -host 23.192.46.171 gw $1
route add -host 23.192.46.176 gw $1
route add -host 23.192.46.177 gw $1
route add -host 23.192.46.178 gw $1
route add -host 23.192.46.179 gw $1
route add -host 23.192.46.184 gw $1
route add -host 23.192.46.186 gw $1
route add -host 23.192.46.192 gw $1
route add -host 23.192.46.193 gw $1
route add -host 23.192.46.194 gw $1
route add -host 23.192.46.195 gw $1
route add -host 23.192.46.201 gw $1
route add -host 23.192.46.202 gw $1
route add -host 23.192.46.203 gw $1
...
route add -host 23.211.96.224 gw $1
route add -host 23.218.94.25 gw $1
route add -host 23.218.94.8 gw $1
...
route add -host 3.226.49.82 gw $1
...
route add -host 3.83.208.179 gw $1
route add -host 40.114.86.114 gw $1
route add -host 46.51.216.187 gw $1
route add -host 50.17.2.67 gw $1
route add -host 52.0.204.99 gw $1
route add -host 52.119.210.255 gw $1
route add -host 52.198.174.169 gw $1
route add -host 52.199.254.91 gw $1
route add -host 52.200.5.51 gw $1
route add -host 52.216.82.59 gw $1
route add -host 52.217.33.4 gw $1
route add -host 52.218.101.91 gw $1
route add -host 52.218.233.144 gw $1
route add -host 52.219.112.208 gw $1
route add -host 52.219.136.2 gw $1
route add -host 52.219.32.242 gw $1
route add -host 52.219.73.123 gw $1
...
route add -host 52.87.74.106 gw $1
route add -host 52.95.133.163 gw $1
route add -host 52.95.163.58 gw $1
route add -host 54.175.94.100 gw $1
route add -host 54.193.253.0 gw $1
route add -host 54.193.36.8 gw $1
route add -host 54.210.133.45 gw $1
...
route add -host 54.70.204.49 gw $1
...
route add -host 72.246.189.243 gw $1
...
route add -host 88.221.76.229 gw $1
...
route add -host 99.84.194.8 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-13T22:04:07+08:00
