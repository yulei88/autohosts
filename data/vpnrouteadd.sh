...
route add -host 23.2.16.56 gw $1
route add -host 23.2.16.74 gw $1
...
route add -host 50.19.198.75 gw $1
route add -host 52.1.172.141 gw $1
route add -host 52.119.210.255 gw $1
route add -host 52.119.222.139 gw $1
route add -host 52.202.168.208 gw $1
route add -host 52.21.140.69 gw $1
route add -host 52.216.131.181 gw $1
route add -host 52.216.161.51 gw $1
route add -host 52.216.16.248 gw $1
route add -host 52.218.212.72 gw $1
route add -host 52.218.97.170 gw $1
...
route add -host 52.44.136.111 gw $1
...
route add -host 54.208.39.12 gw $1
...
#Last updated:  2019-06-04T18:58:17+08:00
