...
#
route add -host 100.25.32.177 gw $1
...
route add -host 104.116.243.178 gw $1
...
route add -host 172.217.6.195 gw $1
...
route add -host 18.197.166.194 gw $1
...
route add -host 23.57.66.64 gw $1
route add -host 23.62.136.119 gw $1
...
route add -host 34.239.218.98 gw $1
...
route add -host 52.0.33.31 gw $1
...
route add -host 52.216.114.227 gw $1
route add -host 52.216.179.187 gw $1
route add -host 52.218.241.0 gw $1
route add -host 52.218.84.138 gw $1
route add -host 52.219.24.153 gw $1
route add -host 52.219.32.230 gw $1
route add -host 52.219.68.146 gw $1
route add -host 52.219.74.20 gw $1
route add -host 52.2.213.60 gw $1
...
route add -host 52.84.254.47 gw $1
route add -host 52.85.0.161 gw $1
route add -host 52.85.0.228 gw $1
route add -host 52.85.0.88 gw $1
route add -host 52.85.3.201 gw $1
route add -host 52.85.3.3 gw $1
route add -host 52.9.210.53 gw $1
...
route add -host 54.192.108.74 gw $1
route add -host 54.192.111.101 gw $1
route add -host 54.192.111.107 gw $1
route add -host 54.192.111.116 gw $1
route add -host 54.192.111.125 gw $1
route add -host 54.192.111.129 gw $1
route add -host 54.192.111.133 gw $1
route add -host 54.192.111.136 gw $1
route add -host 54.192.111.15 gw $1
route add -host 54.192.111.19 gw $1
route add -host 54.192.111.190 gw $1
route add -host 54.192.111.193 gw $1
route add -host 54.192.111.199 gw $1
route add -host 54.192.111.21 gw $1
route add -host 54.192.111.217 gw $1
route add -host 54.192.111.223 gw $1
route add -host 54.192.111.225 gw $1
route add -host 54.192.111.248 gw $1
route add -host 54.192.111.49 gw $1
route add -host 54.192.111.52 gw $1
route add -host 54.192.111.66 gw $1
route add -host 54.192.111.69 gw $1
route add -host 54.192.111.7 gw $1
route add -host 54.192.111.91 gw $1
route add -host 54.192.111.92 gw $1
route add -host 54.201.153.16 gw $1
route add -host 54.209.113.24 gw $1
route add -host 54.230.109.226 gw $1
route add -host 54.230.111.125 gw $1
route add -host 54.230.111.138 gw $1
route add -host 54.230.111.3 gw $1
route add -host 54.231.82.148 gw $1
...
route add -host 54.67.4.155 gw $1
route add -host 54.84.229.86 gw $1
...
route add -host 64.233.177.136 gw $1
...
#Last updated:  2019-06-17T18:57:41+08:00
