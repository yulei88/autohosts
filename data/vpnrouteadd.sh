...
route add -host 172.217.15.110 gw $1
...
route add -host 3.210.30.85 gw $1
...
route add -host 52.216.112.219 gw $1
route add -host 52.216.176.141 gw $1
...
#Last updated:  2019-06-25T08:29:35+08:00
