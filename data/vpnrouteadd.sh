...
route add -host 13.224.8.113 gw $1
...
route add -host 13.33.9.64 gw $1
...
route add -host 18.158.83.14 gw $1
...
route add -host 216.58.198.35 gw $1
...
route add -host 34.192.66.106 gw $1
...
route add -host 52.217.15.150 gw $1
route add -host 52.217.34.4 gw $1
route add -host 52.21.76.84 gw $1
route add -host 52.218.112.59 gw $1
route add -host 52.218.177.72 gw $1
route add -host 52.219.120.8 gw $1
route add -host 52.219.16.198 gw $1
route add -host 52.219.36.33 gw $1
route add -host 52.219.47.51 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.24.114.138 gw $1
...
route add -host 52.54.107.178 gw $1
route add -host 52.55.157.149 gw $1
...
route add -host 75.2.37.224 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-09-26T13:17:21+08:00
