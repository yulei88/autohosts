...
route add -host 13.227.21.102 gw $1
route add -host 13.227.21.124 gw $1
route add -host 13.227.21.126 gw $1
route add -host 13.227.21.60 gw $1
route add -host 13.227.21.62 gw $1
route add -host 13.227.21.75 gw $1
...
route add -host 13.35.46.45 gw $1
...
route add -host 13.35.54.118 gw $1
route add -host 13.35.54.6 gw $1
...
route add -host 172.67.143.78 gw $1
...
route add -host 18.185.145.127 gw $1
...
route add -host 23.44.7.89 gw $1
...
route add -host 52.216.107.22 gw $1
route add -host 52.216.147.124 gw $1
...
route add -host 52.219.47.95 gw $1
...
route add -host 52.54.222.221 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.95.134.175 gw $1
route add -host 52.95.163.62 gw $1
route add -host 52.9.87.251 gw $1
route add -host 54.153.102.224 gw $1
...
route add -host 99.84.55.103 gw $1
route add -host 99.84.55.104 gw $1
route add -host 99.84.55.105 gw $1
...
route add -host 99.84.55.75 gw $1
route add -host 99.84.55.96 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-23T13:12:18+08:00
