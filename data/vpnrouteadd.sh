...
route add -host 173.194.218.120 gw $1
...
route add -host 18.195.65.197 gw $1
...
route add -host 23.2.16.33 gw $1
...
route add -host 34.201.79.186 gw $1
route add -host 34.214.36.220 gw $1
...
route add -host 3.93.108.47 gw $1
route add -host 3.94.11.69 gw $1
...
route add -host 52.216.162.211 gw $1
route add -host 52.216.237.189 gw $1
route add -host 52.218.105.98 gw $1
route add -host 52.218.204.96 gw $1
route add -host 52.219.20.29 gw $1
route add -host 52.219.32.37 gw $1
route add -host 52.219.68.190 gw $1
...
route add -host 52.79.195.104 gw $1
...
route add -host 54.192.111.10 gw $1
...
#Last updated:  2019-06-16T05:58:52+08:00
