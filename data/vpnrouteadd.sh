...
route add -host 104.118.6.140 gw $1
route add -host 104.118.6.170 gw $1
route add -host 104.118.6.178 gw $1
route add -host 104.118.6.179 gw $1
...
route add -host 104.244.46.8 gw $1
...
route add -host 104.78.0.177 gw $1
...
route add -host 120.29.144.104 gw $1
route add -host 120.29.144.105 gw $1
route add -host 120.29.144.106 gw $1
route add -host 120.29.144.107 gw $1
route add -host 120.29.144.112 gw $1
route add -host 120.29.144.114 gw $1
route add -host 120.29.144.115 gw $1
route add -host 120.29.144.120 gw $1
route add -host 120.29.144.121 gw $1
route add -host 120.29.144.122 gw $1
route add -host 120.29.144.129 gw $1
route add -host 120.29.144.130 gw $1
route add -host 120.29.144.131 gw $1
route add -host 120.29.144.168 gw $1
route add -host 120.29.144.169 gw $1
route add -host 120.29.144.170 gw $1
route add -host 120.29.144.171 gw $1
route add -host 120.29.144.176 gw $1
route add -host 120.29.144.177 gw $1
route add -host 120.29.144.178 gw $1
route add -host 120.29.144.179 gw $1
route add -host 120.29.144.184 gw $1
route add -host 120.29.144.185 gw $1
route add -host 120.29.144.186 gw $1
route add -host 120.29.144.187 gw $1
route add -host 120.29.144.203 gw $1
route add -host 120.29.144.208 gw $1
route add -host 120.29.144.209 gw $1
route add -host 120.29.144.210 gw $1
route add -host 120.29.144.211 gw $1
route add -host 120.29.145.10 gw $1
route add -host 120.29.145.11 gw $1
route add -host 120.29.145.16 gw $1
route add -host 120.29.145.17 gw $1
route add -host 120.29.145.18 gw $1
route add -host 120.29.145.8 gw $1
route add -host 120.29.145.9 gw $1
...
route add -host 13.228.53.16 gw $1
route add -host 13.35.99.17 gw $1
route add -host 13.35.99.3 gw $1
route add -host 13.35.99.53 gw $1
route add -host 13.35.99.57 gw $1
route add -host 13.35.99.80 gw $1
...
route add -host 162.125.18.1 gw $1
...
route add -host 172.217.26.100 gw $1
...
route add -host 173.194.207.26 gw $1
...
route add -host 199.16.156.17 gw $1
...
route add -host 208.100.17.190 gw $1
...
route add -host 216.58.202.163 gw $1
...
route add -host 23.42.136.105 gw $1
route add -host 23.65.182.147 gw $1
route add -host 23.65.182.160 gw $1
...
route add -host 34.197.53.24 gw $1
route add -host 34.202.128.74 gw $1
route add -host 34.206.203.200 gw $1
route add -host 35.161.151.161 gw $1
route add -host 35.162.167.202 gw $1
...
route add -host 3.82.80.6 gw $1
route add -host 3.93.114.140 gw $1
route add -host 3.93.233.94 gw $1
route add -host 40.114.86.114 gw $1
route add -host 40.90.136.182 gw $1
route add -host 46.51.219.131 gw $1
route add -host 50.16.182.52 gw $1
route add -host 50.18.252.43 gw $1
route add -host 52.1.172.141 gw $1
route add -host 52.119.164.244 gw $1
route add -host 52.216.100.197 gw $1
route add -host 52.216.233.51 gw $1
route add -host 52.218.96.98 gw $1
route add -host 52.219.0.116 gw $1
route add -host 52.219.20.5 gw $1
route add -host 52.219.36.89 gw $1
route add -host 52.219.73.84 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.28.42.101 gw $1
route add -host 52.35.140.58 gw $1
route add -host 52.35.190.21 gw $1
route add -host 52.39.74.21 gw $1
route add -host 52.45.219.205 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.52.159.97 gw $1
route add -host 52.74.174.169 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.8.208.136 gw $1
route add -host 52.85.12.105 gw $1
route add -host 52.85.12.110 gw $1
route add -host 52.85.12.128 gw $1
route add -host 52.85.12.137 gw $1
route add -host 52.85.12.14 gw $1
route add -host 52.85.12.146 gw $1
route add -host 52.85.12.165 gw $1
route add -host 52.85.12.178 gw $1
route add -host 52.85.12.179 gw $1
route add -host 52.85.12.180 gw $1
route add -host 52.85.12.182 gw $1
route add -host 52.85.12.19 gw $1
route add -host 52.85.12.194 gw $1
route add -host 52.85.12.204 gw $1
route add -host 52.85.12.205 gw $1
route add -host 52.85.12.213 gw $1
route add -host 52.85.12.218 gw $1
route add -host 52.85.12.234 gw $1
route add -host 52.85.12.250 gw $1
route add -host 52.85.12.28 gw $1
route add -host 52.85.12.3 gw $1
route add -host 52.85.12.35 gw $1
route add -host 52.85.12.38 gw $1
route add -host 52.85.12.48 gw $1
route add -host 52.85.12.56 gw $1
route add -host 52.85.12.68 gw $1
route add -host 52.85.12.7 gw $1
route add -host 52.85.13.28 gw $1
route add -host 52.85.13.44 gw $1
route add -host 52.85.15.82 gw $1
route add -host 52.87.70.195 gw $1
route add -host 52.95.131.17 gw $1
route add -host 52.95.163.50 gw $1
route add -host 54.153.81.237 gw $1
route add -host 54.169.27.21 gw $1
route add -host 54.172.193.190 gw $1
route add -host 54.172.244.116 gw $1
route add -host 54.192.235.95 gw $1
route add -host 54.193.253.7 gw $1
route add -host 54.230.235.123 gw $1
route add -host 54.231.169.56 gw $1
route add -host 54.234.26.176 gw $1
route add -host 54.235.253.182 gw $1
route add -host 54.236.67.202 gw $1
route add -host 54.239.194.44 gw $1
...
route add -host 54.85.125.41 gw $1
...
route add -host 72.246.190.104 gw $1
route add -host 72.246.190.105 gw $1
route add -host 72.246.190.43 gw $1
route add -host 72.246.190.49 gw $1
route add -host 72.246.190.50 gw $1
route add -host 72.246.190.51 gw $1
route add -host 72.246.190.56 gw $1
route add -host 72.246.190.57 gw $1
route add -host 72.246.190.58 gw $1
route add -host 72.246.190.59 gw $1
route add -host 72.246.190.65 gw $1
route add -host 72.246.190.66 gw $1
route add -host 72.246.190.67 gw $1
route add -host 72.246.190.73 gw $1
route add -host 72.246.190.74 gw $1
route add -host 72.246.190.75 gw $1
route add -host 72.246.190.80 gw $1
route add -host 72.246.190.81 gw $1
route add -host 72.246.190.82 gw $1
route add -host 72.246.190.83 gw $1
route add -host 72.246.190.88 gw $1
route add -host 72.246.190.89 gw $1
route add -host 72.246.190.90 gw $1
route add -host 72.246.190.96 gw $1
route add -host 72.246.190.97 gw $1
route add -host 72.246.190.98 gw $1
route add -host 72.246.190.99 gw $1
...
route add -host 74.125.126.108 gw $1
route add -host 74.125.126.27 gw $1
...
route add -host 74.125.23.136 gw $1
route add -host 74.125.23.137 gw $1
route add -host 74.125.23.14 gw $1
route add -host 74.125.23.189 gw $1
route add -host 74.125.24.94 gw $1
...
#Last updated:  2019-02-05T18:58:22+08:00
