...
route add -host 13.35.90.31 gw $1
...
route add -host 172.253.117.91 gw $1
...
route add -host 18.159.142.53 gw $1
...
route add -host 52.216.163.69 gw $1
route add -host 52.216.185.195 gw $1
route add -host 52.218.234.56 gw $1
route add -host 52.218.88.187 gw $1
route add -host 52.219.112.41 gw $1
route add -host 52.219.16.62 gw $1
route add -host 52.219.40.90 gw $1
...
route add -host 99.84.201.12 gw $1
route add -host 99.84.201.122 gw $1
route add -host 99.84.201.62 gw $1
route add -host 99.84.201.88 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-12-18T05:54:15+08:00
