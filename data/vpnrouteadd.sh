...
route add -host 104.28.7.99 gw $1
...
route add -host 13.56.92.111 gw $1
...
route add -host 142.250.28.125 gw $1
...
route add -host 18.185.167.233 gw $1
...
route add -host 3.217.69.239 gw $1
...
route add -host 34.209.239.238 gw $1
...
route add -host 52.216.240.30 gw $1
route add -host 52.217.82.132 gw $1
route add -host 52.218.253.40 gw $1
route add -host 52.218.89.67 gw $1
route add -host 52.219.1.114 gw $1
route add -host 52.219.112.88 gw $1
route add -host 52.219.124.226 gw $1
...
route add -host 99.84.130.16 gw $1
