...
#
route add -host 100.24.211.128 gw $1
...
route add -host 13.56.84.65 gw $1
...
route add -host 216.58.222.142 gw $1
...
route add -host 3.210.13.24 gw $1
route add -host 3.213.24.159 gw $1
route add -host 3.216.110.7 gw $1
route add -host 34.209.167.86 gw $1
route add -host 34.215.83.133 gw $1
...
route add -host 52.216.106.101 gw $1
route add -host 52.216.19.40 gw $1
route add -host 52.218.108.195 gw $1
route add -host 52.218.192.0 gw $1
route add -host 52.219.120.32 gw $1
route add -host 52.219.32.154 gw $1
route add -host 52.219.4.198 gw $1
...
#Last updated:  2019-07-24T08:27:50+08:00
