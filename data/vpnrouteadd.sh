...
route add -host 13.224.0.115 gw $1
route add -host 13.224.0.120 gw $1
route add -host 13.224.0.128 gw $1
route add -host 13.224.0.63 gw $1
route add -host 13.224.0.73 gw $1
route add -host 13.224.0.95 gw $1
...
route add -host 13.35.50.2 gw $1
...
route add -host 172.217.19.163 gw $1
route add -host 172.217.22.163 gw $1
...
route add -host 52.216.95.93 gw $1
route add -host 52.218.230.48 gw $1
route add -host 52.218.85.10 gw $1
route add -host 52.219.120.120 gw $1
...
route add -host 52.22.169.228 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-02T09:45:52+08:00
