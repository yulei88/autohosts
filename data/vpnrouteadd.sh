...
route add -host 13.35.121.114 gw $1
route add -host 13.35.121.122 gw $1
route add -host 13.35.121.28 gw $1
route add -host 13.35.121.50 gw $1
...
route add -host 13.35.50.24 gw $1
...
route add -host 23.15.14.25 gw $1
route add -host 23.15.14.34 gw $1
route add -host 23.192.44.234 gw $1
route add -host 23.192.44.235 gw $1
route add -host 23.192.44.249 gw $1
...
route add -host 23.214.81.81 gw $1
...
route add -host 23.54.19.35 gw $1
route add -host 23.57.31.220 gw $1
route add -host 23.60.72.14 gw $1
...
route add -host 3.216.121.128 gw $1
...
route add -host 34.233.179.3 gw $1
route add -host 34.235.18.92 gw $1
...
route add -host 52.206.47.108 gw $1
route add -host 52.216.237.179 gw $1
route add -host 52.217.16.134 gw $1
route add -host 52.218.193.32 gw $1
route add -host 52.218.97.10 gw $1
route add -host 52.219.116.112 gw $1
route add -host 52.219.132.62 gw $1
route add -host 52.219.16.90 gw $1
route add -host 52.219.73.151 gw $1
...
route add -host 61.213.168.9 gw $1
...
route add -host 99.84.232.19 gw $1
route add -host 99.84.232.43 gw $1
route add -host 99.84.232.79 gw $1
...
#Last updated:  2020-02-11T22:03:16+08:00
