...
route add -host 23.32.3.99 gw $1
...
route add -host 3.209.161.176 gw $1
route add -host 3.211.44.127 gw $1
route add -host 34.199.165.71 gw $1
route add -host 35.161.110.36 gw $1
route add -host 35.173.93.204 gw $1
...
route add -host 52.206.52.6 gw $1
route add -host 52.21.142.16 gw $1
route add -host 52.216.105.117 gw $1
route add -host 52.216.83.64 gw $1
route add -host 52.218.105.194 gw $1
route add -host 52.218.248.88 gw $1
...
route add -host 74.125.141.94 gw $1
...
#Last updated:  2019-05-26T18:57:33+08:00
