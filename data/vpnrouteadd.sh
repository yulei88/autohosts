...
route add -host 172.253.112.91 gw $1
...
route add -host 23.42.95.131 gw $1
route add -host 23.44.133.52 gw $1
...
route add -host 23.45.50.129 gw $1
route add -host 23.45.50.18 gw $1
route add -host 23.45.50.34 gw $1
...
route add -host 23.57.207.131 gw $1
...
route add -host 52.216.207.61 gw $1
...
#Last updated:  2020-03-29T22:02:43+08:00
