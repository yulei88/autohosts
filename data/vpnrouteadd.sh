...
route add -host 13.224.13.76 gw $1
...
route add -host 13.56.8.146 gw $1
...
route add -host 52.201.123.183 gw $1
route add -host 52.205.103.199 gw $1
route add -host 52.216.184.117 gw $1
route add -host 52.216.65.224 gw $1
route add -host 52.218.100.83 gw $1
route add -host 52.218.205.168 gw $1
...
route add -host 54.192.73.6 gw $1
...
route add -host 99.84.64.107 gw $1
route add -host 99.84.64.72 gw $1
route add -host 99.86.38.45 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-07T09:45:15+08:00
