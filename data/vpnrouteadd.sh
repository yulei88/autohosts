...
route add -host 34.230.186.253 gw $1
...
route add -host 52.216.94.67 gw $1
route add -host 52.218.106.171 gw $1
route add -host 52.218.243.8 gw $1
...
route add -host 52.52.182.107 gw $1
...
route add -host 54.201.215.4 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-17T22:00:31+08:00
