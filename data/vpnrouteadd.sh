...
route add -host 13.249.144.188 gw $1
route add -host 13.249.146.104 gw $1
route add -host 13.249.146.112 gw $1
route add -host 13.249.146.119 gw $1
route add -host 13.249.146.120 gw $1
route add -host 13.249.146.18 gw $1
route add -host 13.249.146.25 gw $1
route add -host 13.249.146.3 gw $1
...
route add -host 13.32.197.18 gw $1
route add -host 13.32.197.5 gw $1
route add -host 13.32.230.35 gw $1
route add -host 13.32.230.43 gw $1
route add -host 13.32.230.49 gw $1
route add -host 13.32.230.84 gw $1
...
route add -host 199.16.156.214 gw $1
...
route add -host 34.194.135.27 gw $1
route add -host 34.194.43.236 gw $1
route add -host 34.210.10.88 gw $1
route add -host 34.236.129.214 gw $1
route add -host 35.174.58.175 gw $1
...
route add -host 52.200.117.50 gw $1
route add -host 52.216.161.253 gw $1
route add -host 52.216.233.179 gw $1
route add -host 52.218.106.35 gw $1
route add -host 52.218.220.248 gw $1
route add -host 52.219.116.41 gw $1
route add -host 52.219.16.42 gw $1
route add -host 52.219.36.37 gw $1
route add -host 52.219.73.163 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.39.115.195 gw $1
...
route add -host 52.58.36.59 gw $1
...
route add -host 54.210.14.113 gw $1
route add -host 54.213.43.209 gw $1
route add -host 54.231.81.160 gw $1
...
route add -host 54.86.32.157 gw $1
...
route add -host 99.84.224.101 gw $1
route add -host 99.84.224.111 gw $1
route add -host 99.84.224.121 gw $1
route add -host 99.84.224.125 gw $1
route add -host 99.84.224.129 gw $1
route add -host 99.84.224.8 gw $1
route add -host 99.86.193.55 gw $1
route add -host 99.86.195.9 gw $1
route add -host 99.86.196.110 gw $1
route add -host 99.86.199.100 gw $1
route add -host 99.86.199.110 gw $1
route add -host 99.86.199.32 gw $1
route add -host 99.86.199.4 gw $1
route add -host 99.86.199.60 gw $1
route add -host 99.86.199.66 gw $1
route add -host 99.86.199.96 gw $1
route add -host 99.86.219.42 gw $1
route add -host 99.86.219.50 gw $1
route add -host 99.86.222.67 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-13T05:56:24+08:00
