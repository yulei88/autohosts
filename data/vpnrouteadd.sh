...
route add -host 172.217.21.35 gw $1
...
route add -host 3.211.228.189 gw $1
...
route add -host 52.216.164.69 gw $1
route add -host 52.216.94.19 gw $1
route add -host 52.218.232.56 gw $1
...
#Last updated:  2019-07-21T05:56:05+08:00
