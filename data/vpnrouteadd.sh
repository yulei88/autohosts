...
route add -host 34.196.80.48 gw $1
route add -host 34.211.135.102 gw $1
...
route add -host 52.217.16.252 gw $1
route add -host 52.217.37.46 gw $1
route add -host 52.218.252.128 gw $1
route add -host 52.218.97.99 gw $1
route add -host 52.219.113.72 gw $1
route add -host 52.219.168.80 gw $1
route add -host 52.219.40.82 gw $1
...
route add -host 52.89.134.170 gw $1
route add -host 52.95.134.127 gw $1
...
route add -host 54.183.110.239 gw $1
...
route add -host 99.84.238.156 gw $1
route add -host 99.84.238.190 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-11T22:10:45+08:00
