...
route add -host 13.32.54.29 gw $1
route add -host 13.32.54.32 gw $1
...
route add -host 13.33.215.121 gw $1
route add -host 13.33.215.128 gw $1
...
route add -host 13.33.215.74 gw $1
...
route add -host 52.21.3.159 gw $1
route add -host 52.216.10.123 gw $1
route add -host 52.216.163.45 gw $1
route add -host 52.216.166.3 gw $1
route add -host 52.216.94.211 gw $1
route add -host 52.218.245.232 gw $1
route add -host 52.218.49.108 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-25T18:56:27+08:00
