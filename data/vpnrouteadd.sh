...
route add -host 34.196.124.157 gw $1
...
route add -host 52.216.106.148 gw $1
route add -host 52.216.161.141 gw $1
route add -host 52.218.200.120 gw $1
route add -host 52.218.65.84 gw $1
route add -host 52.219.0.44 gw $1
route add -host 52.219.28.37 gw $1
route add -host 52.219.36.190 gw $1
route add -host 52.219.74.60 gw $1
...
route add -host 52.44.233.54 gw $1
...
route add -host 52.85.0.175 gw $1
route add -host 52.85.0.36 gw $1
route add -host 52.85.0.58 gw $1
...
route add -host 54.192.111.128 gw $1
...
route add -host 54.231.49.194 gw $1
...
#Last updated:  2018-11-17T08:27:04+08:00
