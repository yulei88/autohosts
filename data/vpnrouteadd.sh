...
route add -host 13.225.166.74 gw $1
...
route add -host 18.196.250.97 gw $1
...
route add -host 216.58.207.78 gw $1
...
route add -host 35.169.46.35 gw $1
...
route add -host 52.216.233.43 gw $1
route add -host 52.216.97.245 gw $1
route add -host 52.218.201.120 gw $1
route add -host 52.218.56.67 gw $1
...
route add -host 52.89.125.120 gw $1
...
route add -host 54.192.73.116 gw $1
route add -host 54.192.73.16 gw $1
route add -host 54.192.73.29 gw $1
route add -host 54.192.73.44 gw $1
...
#Last updated:  2020-01-16T11:59:40+08:00
