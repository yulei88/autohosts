...
route add -host 172.253.124.94 gw $1
...
route add -host 23.44.7.57 gw $1
...
route add -host 34.228.172.19 gw $1
...
route add -host 52.216.106.21 gw $1
route add -host 52.217.17.12 gw $1
route add -host 52.218.200.16 gw $1
route add -host 52.218.56.179 gw $1
...
route add -host 52.54.196.100 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-16T09:44:42+08:00
