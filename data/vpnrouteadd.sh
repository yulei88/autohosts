...
route add -host 13.35.101.10 gw $1
...
route add -host 34.218.20.139 gw $1
route add -host 34.238.173.155 gw $1
route add -host 34.98.99.30 gw $1
route add -host 35.163.178.218 gw $1
route add -host 35.171.251.239 gw $1
...
route add -host 52.217.70.76 gw $1
route add -host 52.217.81.238 gw $1
route add -host 52.218.243.80 gw $1
route add -host 52.218.52.234 gw $1
route add -host 52.219.120.32 gw $1
route add -host 52.219.12.66 gw $1
...
route add -host 52.44.19.12 gw $1
...
route add -host 54.144.57.31 gw $1
...
route add -host 99.84.138.78 gw $1
...
route add -host 99.86.35.58 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-20T13:12:23+08:00
