...
route add -host 3.222.13.62 gw $1
...
route add -host 52.217.109.214 gw $1
route add -host 52.217.16.204 gw $1
route add -host 52.218.152.8 gw $1
route add -host 52.218.65.4 gw $1
route add -host 52.219.112.192 gw $1
route add -host 52.219.128.22 gw $1
route add -host 52.219.168.47 gw $1
...
route add -host 65.9.38.110 gw $1
...
route add -host 74.125.130.117 gw $1
...
route add -host 74.125.68.101 gw $1
route add -host 74.125.68.102 gw $1
route add -host 74.125.68.138 gw $1
...
#Last updated:  2021-01-10T09:52:12+08:00
