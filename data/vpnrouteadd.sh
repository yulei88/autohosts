...
route add -host 172.217.15.195 gw $1
...
route add -host 172.217.169.131 gw $1
...
route add -host 18.194.59.89 gw $1
route add -host 184.169.163.236 gw $1
route add -host 184.169.220.10 gw $1
...
route add -host 23.50.224.11 gw $1
...
route add -host 34.196.232.179 gw $1
route add -host 34.196.239.16 gw $1
...
route add -host 52.204.215.111 gw $1
route add -host 52.206.18.98 gw $1
route add -host 52.216.110.181 gw $1
route add -host 52.217.0.3 gw $1
...
route add -host 52.219.73.111 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.22.237.23 gw $1
route add -host 52.24.205.214 gw $1
route add -host 52.3.148.212 gw $1
...
route add -host 52.85.0.103 gw $1
route add -host 52.85.0.161 gw $1
route add -host 52.85.0.228 gw $1
route add -host 52.85.0.89 gw $1
route add -host 52.85.3.110 gw $1
route add -host 52.85.3.134 gw $1
route add -host 52.87.25.120 gw $1
route add -host 52.9.210.53 gw $1
route add -host 52.95.132.91 gw $1
route add -host 52.95.163.30 gw $1
route add -host 52.9.75.41 gw $1
route add -host 54.164.162.29 gw $1
route add -host 54.172.115.1 gw $1
route add -host 54.186.240.37 gw $1
...
route add -host 61.213.151.40 gw $1
...
#Last updated:  2019-06-15T18:57:15+08:00
