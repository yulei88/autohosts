...
route add -host 108.177.122.136 gw $1
...
route add -host 13.56.192.227 gw $1
...
route add -host 142.250.76.99 gw $1
...
route add -host 40.90.136.163 gw $1
...
route add -host 52.217.105.28 gw $1
route add -host 52.217.94.14 gw $1
route add -host 52.218.202.8 gw $1
...
route add -host 52.219.168.31 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.2.6.191 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2021-02-24T05:55:47+08:00
