...
route add -host 142.250.68.14 gw $1
...
route add -host 172.253.120.91 gw $1
...
route add -host 35.164.68.109 gw $1
...
route add -host 50.16.55.74 gw $1
...
route add -host 52.216.162.21 gw $1
route add -host 52.21.76.84 gw $1
route add -host 52.217.8.36 gw $1
route add -host 52.218.180.192 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-02T22:09:14+08:00
