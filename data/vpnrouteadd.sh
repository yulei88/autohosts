...
route add -host 52.216.229.69 gw $1
route add -host 52.217.13.108 gw $1
route add -host 52.218.108.43 gw $1
route add -host 52.218.252.104 gw $1
route add -host 52.219.0.238 gw $1
route add -host 52.219.112.64 gw $1
route add -host 52.219.32.195 gw $1
route add -host 52.219.75.39 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.3.102.88 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-29T05:48:37+08:00
