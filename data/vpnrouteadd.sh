...
route add -host 104.103.98.161 gw $1
...
route add -host 23.195.89.176 gw $1
...
route add -host 35.170.253.153 gw $1
...
route add -host 52.217.41.172 gw $1
route add -host 52.218.229.88 gw $1
route add -host 52.218.89.83 gw $1
...
route add -host 54.231.40.98 gw $1
...
route add -host 99.86.33.51 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-08T22:03:06+08:00
