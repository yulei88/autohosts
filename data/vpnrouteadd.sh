...
route add -host 108.177.98.91 gw $1
...
route add -host 13.225.157.90 gw $1
...
route add -host 13.249.171.125 gw $1
...
route add -host 3.216.190.241 gw $1
route add -host 34.192.55.61 gw $1
route add -host 34.206.22.68 gw $1
route add -host 34.224.163.107 gw $1
...
route add -host 52.216.136.59 gw $1
route add -host 52.217.4.86 gw $1
...
route add -host 52.70.136.70 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-21T12:01:37+08:00
