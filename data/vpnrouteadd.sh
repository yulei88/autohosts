...
route add -host 23.195.89.67 gw $1
...
route add -host 52.216.90.22 gw $1
route add -host 52.217.84.220 gw $1
route add -host 52.218.247.200 gw $1
...
route add -host 52.84.126.80 gw $1
route add -host 52.84.16.33 gw $1
route add -host 52.84.16.52 gw $1
route add -host 52.84.53.119 gw $1
route add -host 52.84.53.122 gw $1
route add -host 52.84.53.28 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-07-28T09:49:06+08:00
