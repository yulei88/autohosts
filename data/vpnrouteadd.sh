...
route add -host 13.35.78.91 gw $1
...
route add -host 34.205.1.55 gw $1
...
route add -host 52.216.102.99 gw $1
route add -host 52.216.168.99 gw $1
...
#Last updated:  2019-05-23T08:25:28+08:00
