...
route add -host 13.32.54.46 gw $1
...
route add -host 13.33.215.123 gw $1
...
route add -host 13.33.215.77 gw $1
...
route add -host 3.214.72.111 gw $1
...
route add -host 52.216.134.235 gw $1
route add -host 52.216.9.147 gw $1
route add -host 52.217.39.38 gw $1
...
route add -host 52.8.3.113 gw $1
route add -host 52.84.235.102 gw $1
route add -host 52.84.235.146 gw $1
route add -host 52.84.235.168 gw $1
route add -host 52.84.235.24 gw $1
route add -host 52.84.235.8 gw $1
route add -host 52.84.235.82 gw $1
route add -host 52.84.235.87 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-27T08:27:03+08:00
