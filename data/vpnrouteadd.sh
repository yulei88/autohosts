...
route add -host 13.224.10.111 gw $1
route add -host 13.224.10.24 gw $1
...
route add -host 143.204.74.14 gw $1
...
route add -host 143.204.74.71 gw $1
...
route add -host 3.214.242.45 gw $1
...
route add -host 52.216.134.253 gw $1
route add -host 52.216.141.52 gw $1
route add -host 52.218.228.48 gw $1
route add -host 52.218.98.171 gw $1
route add -host 52.219.121.16 gw $1
route add -host 52.219.16.34 gw $1
...
route add -host 54.183.44.55 gw $1
...
route add -host 65.9.42.26 gw $1
...
route add -host 74.125.195.93 gw $1
...
#Last updated:  2020-11-12T09:50:58+08:00
