...
route add -host 107.23.88.156 gw $1
...
route add -host 13.35.99.20 gw $1
route add -host 13.35.99.56 gw $1
route add -host 13.35.99.57 gw $1
route add -host 13.35.99.80 gw $1
route add -host 13.35.99.93 gw $1
...
route add -host 172.217.21.14 gw $1
...
route add -host 172.82.241.227 gw $1
...
route add -host 203.208.43.120 gw $1
...
route add -host 216.58.199.234 gw $1
...
route add -host 34.206.233.8 gw $1
...
route add -host 37.0.86.50 gw $1
route add -host 37.0.87.27 gw $1
...
route add -host 3.94.16.44 gw $1
...
route add -host 52.20.239.22 gw $1
route add -host 52.205.206.12 gw $1
route add -host 52.216.111.69 gw $1
route add -host 52.216.133.131 gw $1
route add -host 52.218.196.192 gw $1
route add -host 52.218.97.138 gw $1
route add -host 52.219.24.13 gw $1
route add -host 52.219.32.174 gw $1
route add -host 52.219.4.104 gw $1
route add -host 52.219.72.88 gw $1
...
route add -host 52.72.224.71 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.85.12.106 gw $1
route add -host 52.85.12.11 gw $1
route add -host 52.85.12.120 gw $1
route add -host 52.85.12.130 gw $1
route add -host 52.85.12.143 gw $1
...
route add -host 52.85.12.201 gw $1
...
route add -host 52.85.12.92 gw $1
...
route add -host 52.86.65.143 gw $1
route add -host 52.9.109.157 gw $1
route add -host 52.95.131.5 gw $1
route add -host 52.95.164.59 gw $1
route add -host 54.148.70.127 gw $1
route add -host 54.153.81.237 gw $1
route add -host 54.169.27.21 gw $1
route add -host 54.183.177.71 gw $1
route add -host 54.192.232.113 gw $1
route add -host 54.192.235.52 gw $1
route add -host 54.193.253.3 gw $1
route add -host 54.209.5.49 gw $1
route add -host 54.213.108.65 gw $1
route add -host 54.230.235.32 gw $1
...
route add -host 67.217.80.137 gw $1
...
route add -host 69.192.3.16 gw $1
route add -host 69.192.3.17 gw $1
route add -host 69.192.3.19 gw $1
route add -host 69.192.3.24 gw $1
...
route add -host 69.192.4.42 gw $1
route add -host 69.192.4.97 gw $1
route add -host 72.246.190.104 gw $1
route add -host 72.246.190.105 gw $1
route add -host 72.246.190.48 gw $1
...
route add -host 72.246.190.91 gw $1
...
#Last updated:  2019-02-13T18:56:22+08:00
