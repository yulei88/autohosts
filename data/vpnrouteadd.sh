...
route add -host 104.18.62.237 gw $1
...
route add -host 104.77.73.53 gw $1
route add -host 104.78.16.156 gw $1
route add -host 104.78.18.118 gw $1
route add -host 104.78.18.128 gw $1
...
route add -host 13.224.13.111 gw $1
route add -host 13.224.13.85 gw $1
...
route add -host 13.35.46.109 gw $1
...
route add -host 13.35.46.43 gw $1
...
route add -host 13.57.150.216 gw $1
...
route add -host 172.217.204.94 gw $1
...
route add -host 23.35.91.108 gw $1
...
route add -host 23.58.33.66 gw $1
route add -host 23.66.132.147 gw $1
route add -host 23.66.136.105 gw $1
route add -host 23.9.40.79 gw $1
...
route add -host 34.205.192.196 gw $1
route add -host 34.215.28.163 gw $1
route add -host 34.235.25.19 gw $1
route add -host 35.162.41.68 gw $1
...
route add -host 3.94.139.100 gw $1
...
route add -host 50.16.3.207 gw $1
route add -host 52.10.92.179 gw $1
route add -host 52.119.210.50 gw $1
route add -host 52.199.23.186 gw $1
route add -host 52.20.123.13 gw $1
route add -host 52.21.148.213 gw $1
route add -host 52.216.225.155 gw $1
route add -host 52.217.46.28 gw $1
route add -host 52.218.221.88 gw $1
...
route add -host 52.42.184.175 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.57.211.105 gw $1
...
route add -host 99.86.33.114 gw $1
route add -host 99.86.33.3 gw $1
route add -host 99.86.33.61 gw $1
route add -host 99.86.33.87 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-11T22:03:25+08:00
