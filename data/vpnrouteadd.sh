...
route add -host 172.217.30.99 gw $1
...
route add -host 34.192.110.121 gw $1
...
route add -host 35.163.57.88 gw $1
...
route add -host 52.216.18.243 gw $1
route add -host 52.217.37.108 gw $1
route add -host 52.218.208.0 gw $1
route add -host 52.218.41.219 gw $1
...
route add -host 52.37.240.208 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.55.198.78 gw $1
route add -host 52.70.84.37 gw $1
route add -host 52.73.180.228 gw $1
...
route add -host 52.95.134.191 gw $1
route add -host 52.95.164.38 gw $1
route add -host 52.9.75.63 gw $1
...
#Last updated:  2020-06-03T22:04:16+08:00
