...
route add -host 107.23.153.10 gw $1
...
route add -host 157.55.109.226 gw $1
...
route add -host 216.58.192.195 gw $1
...
route add -host 35.160.172.183 gw $1
...
route add -host 52.217.89.44 gw $1
route add -host 52.218.1.67 gw $1
...
route add -host 54.81.117.112 gw $1
...
route add -host 99.84.137.15 gw $1
route add -host 99.84.137.17 gw $1
route add -host 99.84.137.19 gw $1
route add -host 99.84.233.120 gw $1
route add -host 99.84.233.97 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-02-26T13:19:30+08:00
