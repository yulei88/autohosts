...
route add -host 13.226.198.105 gw $1
route add -host 13.226.198.112 gw $1
...
route add -host 13.57.88.179 gw $1
...
route add -host 23.44.7.123 gw $1
...
route add -host 23.45.51.90 gw $1
...
route add -host 34.212.77.30 gw $1
...
route add -host 52.1.161.66 gw $1
...
route add -host 88.221.140.74 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-04-10T22:03:14+08:00
