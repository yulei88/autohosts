...
#
route add -host 100.20.31.177 gw $1
...
route add -host 13.33.174.125 gw $1
...
route add -host 173.194.210.120 gw $1
...
route add -host 52.0.63.5 gw $1
route add -host 52.119.210.255 gw $1
route add -host 52.199.4.173 gw $1
route add -host 52.202.231.6 gw $1
route add -host 52.216.85.27 gw $1
route add -host 52.216.95.149 gw $1
route add -host 52.218.196.0 gw $1
...
route add -host 52.219.73.139 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-10-02T22:00:43+08:00
