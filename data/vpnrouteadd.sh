...
route add -host 13.32.197.111 gw $1
route add -host 13.32.197.215 gw $1
route add -host 13.32.197.227 gw $1
...
route add -host 13.32.231.3 gw $1
...
route add -host 23.56.25.35 gw $1
...
route add -host 52.216.169.219 gw $1
route add -host 52.216.238.163 gw $1
route add -host 52.216.93.27 gw $1
route add -host 52.217.0.166 gw $1
route add -host 52.218.21.106 gw $1
...
route add -host 52.84.165.104 gw $1
...
route add -host 54.183.203.116 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-08-28T08:28:10+08:00
