...
route add -host 13.32.230.126 gw $1
route add -host 13.32.230.203 gw $1
route add -host 13.32.230.84 gw $1
route add -host 13.35.125.117 gw $1
...
route add -host 172.217.166.46 gw $1
...
route add -host 52.216.114.147 gw $1
route add -host 52.216.145.149 gw $1
route add -host 52.216.234.11 gw $1
route add -host 52.218.229.200 gw $1
...
route add -host 52.45.80.121 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.4.86.34 gw $1
...
route add -host 52.88.136.90 gw $1
