...
route add -host 13.226.217.56 gw $1
route add -host 13.226.217.80 gw $1
...
route add -host 151.101.198.164 gw $1
...
route add -host 23.195.89.147 gw $1
...
route add -host 35.163.121.134 gw $1
...
route add -host 52.216.145.93 gw $1
route add -host 52.216.77.228 gw $1
...
route add -host 52.5.207.252 gw $1
...
route add -host 52.9.222.29 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-08-30T22:08:38+08:00
