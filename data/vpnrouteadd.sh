...
route add -host 13.225.166.11 gw $1
...
route add -host 184.50.106.73 gw $1
...
route add -host 23.8.104.69 gw $1
...
route add -host 52.0.172.153 gw $1
route add -host 52.119.210.50 gw $1
route add -host 52.200.203.143 gw $1
route add -host 52.216.240.196 gw $1
route add -host 52.21.65.76 gw $1
route add -host 52.217.14.166 gw $1
...
route add -host 52.87.20.69 gw $1
...
route add -host 99.84.55.80 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-23T06:03:00+08:00
