...
route add -host 173.194.203.136 gw $1
...
route add -host 23.44.7.115 gw $1
...
route add -host 52.216.143.132 gw $1
route add -host 52.216.237.45 gw $1
route add -host 52.218.100.75 gw $1
route add -host 52.218.213.0 gw $1
...
route add -host 54.203.108.64 gw $1
