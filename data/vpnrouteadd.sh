...
route add -host 184.73.120.50 gw $1
...
route add -host 23.57.66.66 gw $1
route add -host 23.57.66.67 gw $1
route add -host 23.57.66.72 gw $1
route add -host 23.57.66.75 gw $1
route add -host 23.57.66.96 gw $1
route add -host 23.57.66.97 gw $1
...
route add -host 3.209.18.208 gw $1
...
route add -host 52.206.167.230 gw $1
route add -host 52.216.109.219 gw $1
route add -host 52.216.138.245 gw $1
route add -host 52.216.238.171 gw $1
route add -host 52.218.201.88 gw $1
route add -host 52.218.24.51 gw $1
...
route add -host 54.192.111.200 gw $1
...
route add -host 54.230.111.20 gw $1
...
#Last updated:  2019-06-22T18:58:05+08:00
