...
route add -host 104.21.64.75 gw $1
...
route add -host 13.225.177.118 gw $1
route add -host 13.225.177.61 gw $1
...
route add -host 142.250.199.67 gw $1
...
route add -host 52.11.102.189 gw $1
...
route add -host 52.219.133.38 gw $1
...
route add -host 54.215.132.44 gw $1
route add -host 54.230.126.45 gw $1
route add -host 54.230.126.52 gw $1
route add -host 54.230.126.76 gw $1
...
route add -host 99.84.77.34 gw $1
route add -host 99.84.77.39 gw $1
route add -host 99.84.77.58 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-15T09:51:29+08:00
