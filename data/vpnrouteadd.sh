...
route add -host 142.250.11.94 gw $1
...
route add -host 18.207.8.48 gw $1
...
route add -host 3.225.162.72 gw $1
route add -host 34.194.218.210 gw $1
route add -host 34.202.128.229 gw $1
route add -host 34.215.28.163 gw $1
route add -host 34.232.244.87 gw $1
...
route add -host 52.196.205.131 gw $1
...
route add -host 52.216.162.179 gw $1
route add -host 52.217.0.156 gw $1
route add -host 52.217.80.94 gw $1
route add -host 52.218.197.48 gw $1
route add -host 52.218.62.195 gw $1
...
route add -host 52.41.211.110 gw $1
route add -host 52.44.123.142 gw $1
...
route add -host 54.183.129.212 gw $1
route add -host 54.192.23.46 gw $1
...
#Last updated:  2020-07-19T09:48:03+08:00
