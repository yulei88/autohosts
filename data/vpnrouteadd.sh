...
route add -host 35.172.27.21 gw $1
...
route add -host 52.216.178.75 gw $1
route add -host 52.217.15.54 gw $1
route add -host 52.218.216.200 gw $1
...
route add -host 99.86.193.49 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-07-01T05:42:50+08:00
