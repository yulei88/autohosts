...
route add -host 172.217.161.163 gw $1
...
route add -host 23.32.3.75 gw $1
route add -host 23.33.95.81 gw $1
...
route add -host 52.217.37.222 gw $1
route add -host 52.218.220.96 gw $1
route add -host 52.218.97.26 gw $1
route add -host 52.219.128.174 gw $1
route add -host 52.219.1.46 gw $1
...
route add -host 52.44.180.233 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.72.230.65 gw $1
route add -host 52.73.155.110 gw $1
...
route add -host 52.9.8.196 gw $1
route add -host 54.164.198.130 gw $1
route add -host 54.164.67.92 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-20T21:59:04+08:00
