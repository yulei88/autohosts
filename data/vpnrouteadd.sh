...
route add -host 216.58.199.233 gw $1
...
route add -host 34.232.134.1 gw $1
...
route add -host 52.216.161.69 gw $1
route add -host 52.218.208.184 gw $1
route add -host 52.218.52.76 gw $1
...
route add -host 52.222.194.237 gw $1
...
route add -host 52.222.194.253 gw $1
route add -host 52.222.194.254 gw $1
...
route add -host 52.222.194.85 gw $1
...
route add -host 52.72.109.197 gw $1
...
route add -host 54.198.196.140 gw $1
...
route add -host 99.84.74.98 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2018-12-13T05:57:48+08:00
