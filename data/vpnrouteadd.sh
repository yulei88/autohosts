...
route add -host 143.204.131.106 gw $1
route add -host 143.204.131.3 gw $1
route add -host 143.204.131.69 gw $1
...
route add -host 3.210.218.45 gw $1
...
route add -host 52.216.81.107 gw $1
route add -host 52.218.200.208 gw $1
route add -host 52.218.57.171 gw $1
route add -host 52.219.116.136 gw $1
route add -host 52.219.124.94 gw $1
route add -host 52.219.4.56 gw $1
route add -host 52.219.47.75 gw $1
...
route add -host 52.89.115.96 gw $1
route add -host 52.95.132.243 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-12-13T09:55:16+08:00
