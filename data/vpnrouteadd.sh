...
route add -host 13.224.15.12 gw $1
...
route add -host 216.58.205.206 gw $1
...
route add -host 23.23.233.55 gw $1
...
route add -host 23.44.7.98 gw $1
...
route add -host 52.217.80.46 gw $1
route add -host 52.218.247.192 gw $1
route add -host 52.218.89.219 gw $1
route add -host 52.219.117.72 gw $1
route add -host 52.219.129.10 gw $1
route add -host 52.219.136.50 gw $1
...
route add -host 52.6.10.162 gw $1
route add -host 52.69.114.110 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.8.67.12 gw $1
route add -host 52.95.134.247 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-11-08T22:10:17+08:00
