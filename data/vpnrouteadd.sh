...
route add -host 216.58.200.163 gw $1
...
route add -host 52.217.41.238 gw $1
route add -host 52.217.4.84 gw $1
route add -host 52.218.197.104 gw $1
...
#Last updated:  2020-10-20T05:53:09+08:00
