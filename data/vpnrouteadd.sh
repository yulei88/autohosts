...
route add -host 18.181.158.121 gw $1
...
route add -host 3.211.116.121 gw $1
...
route add -host 40.90.136.166 gw $1
...
route add -host 52.217.67.70 gw $1
route add -host 52.217.82.228 gw $1
route add -host 52.218.105.242 gw $1
route add -host 52.218.245.176 gw $1
...
route add -host 52.39.219.127 gw $1
route add -host 52.52.73.213 gw $1
route add -host 52.53.147.211 gw $1
route add -host 52.68.110.241 gw $1
...
route add -host 54.84.31.146 gw $1
