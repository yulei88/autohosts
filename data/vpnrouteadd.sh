...
route add -host 142.250.64.99 gw $1
...
route add -host 172.217.21.206 gw $1
...
route add -host 184.73.75.69 gw $1
...
route add -host 23.195.89.195 gw $1
...
route add -host 34.192.9.36 gw $1
route add -host 34.202.128.229 gw $1
route add -host 34.212.58.211 gw $1
...
route add -host 52.201.90.120 gw $1
route add -host 52.21.148.213 gw $1
route add -host 52.216.10.53 gw $1
route add -host 52.217.44.84 gw $1
route add -host 52.218.237.128 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-03T05:46:30+08:00
