...
route add -host 13.225.163.68 gw $1
...
route add -host 13.35.90.105 gw $1
route add -host 134.170.179.79 gw $1
route add -host 13.56.34.78 gw $1
...
route add -host 142.250.184.131 gw $1
...
route add -host 52.217.82.188 gw $1
route add -host 52.217.92.134 gw $1
route add -host 52.218.241.80 gw $1
route add -host 52.218.56.235 gw $1
route add -host 52.219.0.254 gw $1
...
route add -host 52.95.129.43 gw $1
...
route add -host 54.83.30.212 gw $1
...
route add -host 74.125.68.108 gw $1
...
route add -host 99.84.201.120 gw $1
route add -host 99.84.201.129 gw $1
route add -host 99.84.201.27 gw $1
route add -host 99.84.201.34 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-12-21T05:53:33+08:00
