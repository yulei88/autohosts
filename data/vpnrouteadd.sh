...
route add -host 23.44.7.41 gw $1
route add -host 23.44.7.9 gw $1
...
route add -host 3.93.224.76 gw $1
...
route add -host 52.217.42.158 gw $1
...
route add -host 52.27.239.9 gw $1
...
#Last updated:  2020-06-15T13:11:25+08:00
