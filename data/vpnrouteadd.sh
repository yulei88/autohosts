...
route add -host 13.225.170.91 gw $1
...
route add -host 18.193.28.192 gw $1
...
route add -host 3.210.196.55 gw $1
...
route add -host 34.218.181.176 gw $1
...
route add -host 50.16.148.254 gw $1
...
route add -host 52.217.67.222 gw $1
...
route add -host 52.219.168.35 gw $1
...
route add -host 54.211.186.165 gw $1
...
route add -host 99.84.138.72 gw $1
route add -host 99.84.138.77 gw $1
route add -host 99.84.138.96 gw $1
route add -host 99.84.138.99 gw $1
route add -host 99.84.233.97 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-02-09T13:15:57+08:00
