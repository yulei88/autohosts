...
route add -host 13.249.146.101 gw $1
...
route add -host 13.32.230.218 gw $1
route add -host 13.32.230.245 gw $1
route add -host 13.32.230.49 gw $1
route add -host 13.33.196.176 gw $1
...
route add -host 52.216.204.203 gw $1
route add -host 52.216.94.125 gw $1
route add -host 52.218.108.59 gw $1
route add -host 52.218.193.152 gw $1
route add -host 52.219.116.56 gw $1
route add -host 52.219.32.37 gw $1
route add -host 52.219.68.206 gw $1
...
route add -host 52.6.181.41 gw $1
...
#Last updated:  2019-09-16T18:55:58+08:00
