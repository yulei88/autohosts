...
route add -host 13.227.21.12 gw $1
route add -host 13.227.21.47 gw $1
route add -host 13.227.21.6 gw $1
...
route add -host 141.0.11.238 gw $1
route add -host 141.0.11.239 gw $1
...
route add -host 141.0.11.253 gw $1
...
route add -host 23.44.7.75 gw $1
...
route add -host 52.216.10.197 gw $1
route add -host 52.216.78.52 gw $1
route add -host 52.218.100.179 gw $1
route add -host 52.218.228.96 gw $1
...
route add -host 52.34.191.41 gw $1
...
route add -host 54.85.224.6 gw $1
...
route add -host 74.125.192.127 gw $1
...
#Last updated:  2020-06-25T05:45:59+08:00
