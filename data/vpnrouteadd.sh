...
route add -host 142.250.128.94 gw $1
...
route add -host 44.241.19.80 gw $1
...
route add -host 52.216.18.163 gw $1
route add -host 52.216.238.3 gw $1
route add -host 52.218.225.104 gw $1
route add -host 52.218.60.203 gw $1
route add -host 52.219.16.114 gw $1
route add -host 52.219.164.14 gw $1
...
route add -host 99.84.207.114 gw $1
route add -host 99.84.207.41 gw $1
route add -host 99.84.207.58 gw $1
route add -host 99.84.207.89 gw $1
route add -host 99.84.238.123 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-02T05:58:09+08:00
