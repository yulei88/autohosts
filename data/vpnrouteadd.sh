...
route add -host 172.217.29.67 gw $1
...
route add -host 23.44.7.74 gw $1
...
route add -host 3.123.177.159 gw $1
route add -host 3.209.155.14 gw $1
route add -host 3.211.246.44 gw $1
route add -host 3.212.123.108 gw $1
...
route add -host 35.162.6.51 gw $1
...
route add -host 52.216.206.107 gw $1
route add -host 52.218.247.232 gw $1
route add -host 52.218.65.132 gw $1
...
route add -host 52.52.72.61 gw $1
...
route add -host 52.95.134.231 gw $1
route add -host 52.95.163.66 gw $1
route add -host 54.164.98.120 gw $1
route add -host 54.193.253.6 gw $1
route add -host 54.203.128.50 gw $1
route add -host 54.231.98.139 gw $1
...
route add -host 99.86.33.39 gw $1
route add -host 99.86.33.70 gw $1
route add -host 99.86.33.87 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-16T22:04:05+08:00
