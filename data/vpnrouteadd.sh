...
#
route add -host 100.25.208.131 gw $1
...
route add -host 18.185.53.53 gw $1
...
route add -host 34.205.232.59 gw $1
route add -host 34.210.180.41 gw $1
...
route add -host 52.197.180.20 gw $1
route add -host 52.216.1.11 gw $1
route add -host 52.216.134.51 gw $1
route add -host 52.217.0.148 gw $1
...
route add -host 52.52.242.64 gw $1
...
route add -host 54.153.87.92 gw $1
route add -host 54.165.5.101 gw $1
...
route add -host 64.233.166.120 gw $1
...
#Last updated:  2019-08-20T08:28:50+08:00
