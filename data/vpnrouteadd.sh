...
route add -host 13.249.171.90 gw $1
...
route add -host 18.197.167.191 gw $1
...
route add -host 34.217.252.98 gw $1
...
route add -host 52.218.204.80 gw $1
route add -host 52.218.53.66 gw $1
route add -host 52.219.0.174 gw $1
route add -host 52.219.120.104 gw $1
route add -host 52.219.124.70 gw $1
...
route add -host 52.53.43.66 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-01-16T21:56:34+08:00
