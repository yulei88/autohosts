...
route add -host 104.18.49.242 gw $1
...
route add -host 13.225.146.33 gw $1
...
route add -host 13.226.77.37 gw $1
...
route add -host 143.204.126.26 gw $1
...
route add -host 172.217.214.94 gw $1
...
route add -host 172.217.3.163 gw $1
...
route add -host 216.58.213.99 gw $1
route add -host 216.58.217.202 gw $1
route add -host 216.58.219.10 gw $1
route add -host 216.58.219.42 gw $1
route add -host 23.192.44.240 gw $1
route add -host 23.192.46.210 gw $1
route add -host 23.192.47.152 gw $1
route add -host 23.192.47.153 gw $1
route add -host 23.192.47.154 gw $1
route add -host 23.192.47.160 gw $1
route add -host 23.192.47.161 gw $1
route add -host 23.192.47.163 gw $1
route add -host 23.192.47.168 gw $1
route add -host 23.192.47.169 gw $1
route add -host 23.192.47.170 gw $1
route add -host 23.192.47.176 gw $1
route add -host 23.192.47.177 gw $1
route add -host 23.192.47.178 gw $1
route add -host 23.192.47.184 gw $1
route add -host 23.192.47.185 gw $1
route add -host 23.192.47.192 gw $1
route add -host 23.192.47.193 gw $1
route add -host 23.192.47.194 gw $1
route add -host 23.192.47.200 gw $1
route add -host 23.192.47.201 gw $1
route add -host 23.192.47.208 gw $1
route add -host 23.192.47.209 gw $1
route add -host 23.192.47.210 gw $1
route add -host 23.192.47.211 gw $1
route add -host 23.192.47.218 gw $1
route add -host 23.192.47.224 gw $1
route add -host 23.192.47.225 gw $1
route add -host 23.192.47.226 gw $1
route add -host 23.192.47.232 gw $1
route add -host 23.192.47.233 gw $1
route add -host 23.192.47.241 gw $1
route add -host 23.192.47.248 gw $1
...
route add -host 23.56.170.147 gw $1
route add -host 23.56.170.153 gw $1
route add -host 23.56.170.16 gw $1
route add -host 23.56.170.17 gw $1
route add -host 23.56.170.19 gw $1
route add -host 23.56.170.33 gw $1
route add -host 23.56.170.40 gw $1
route add -host 23.56.170.41 gw $1
route add -host 23.56.170.42 gw $1
route add -host 23.56.170.48 gw $1
route add -host 23.56.170.49 gw $1
route add -host 23.56.170.50 gw $1
route add -host 23.56.170.58 gw $1
route add -host 23.56.170.64 gw $1
route add -host 23.56.170.65 gw $1
route add -host 23.56.170.66 gw $1
route add -host 23.56.170.67 gw $1
...
route add -host 3.223.74.156 gw $1
route add -host 3.226.33.140 gw $1
route add -host 34.199.201.175 gw $1
route add -host 34.202.128.229 gw $1
route add -host 34.208.233.85 gw $1
route add -host 34.232.176.182 gw $1
route add -host 35.158.11.30 gw $1
...
route add -host 52.199.221.137 gw $1
route add -host 52.199.254.91 gw $1
route add -host 52.20.199.62 gw $1
route add -host 52.216.169.147 gw $1
route add -host 52.217.41.22 gw $1
route add -host 52.218.109.147 gw $1
route add -host 52.218.218.56 gw $1
route add -host 52.219.116.120 gw $1
route add -host 52.219.124.190 gw $1
route add -host 52.219.4.92 gw $1
route add -host 52.219.75.27 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.23.107.56 gw $1
route add -host 52.23.96.167 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.36.225.32 gw $1
route add -host 52.3.70.141 gw $1
route add -host 52.42.208.20 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.52.111.38 gw $1
route add -host 52.52.5.73 gw $1
route add -host 52.52.90.107 gw $1
route add -host 52.54.240.6 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.95.134.59 gw $1
...
route add -host 54.218.24.60 gw $1
...
route add -host 74.125.196.127 gw $1
...
route add -host 99.84.51.38 gw $1
...
route add -host 99.84.55.27 gw $1
route add -host 99.84.55.3 gw $1
route add -host 99.84.55.84 gw $1
route add -host 99.84.59.110 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-19T09:47:16+08:00
