...
route add -host 23.211.234.186 gw $1
...
route add -host 52.207.175.51 gw $1
route add -host 52.21.58.55 gw $1
route add -host 52.216.18.211 gw $1
route add -host 52.216.27.44 gw $1
route add -host 52.218.112.91 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-03-27T22:04:30+08:00
