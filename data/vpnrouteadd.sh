...
route add -host 13.226.18.87 gw $1
...
route add -host 13.249.138.58 gw $1
route add -host 13.249.138.6 gw $1
route add -host 13.249.138.63 gw $1
...
route add -host 18.208.100.51 gw $1
...
route add -host 52.216.28.244 gw $1
route add -host 52.218.242.32 gw $1
route add -host 52.218.36.178 gw $1
route add -host 52.219.116.176 gw $1
route add -host 52.219.125.74 gw $1
route add -host 52.219.140.23 gw $1
route add -host 52.219.1.98 gw $1
...
route add -host 52.85.79.44 gw $1
...
#Last updated:  2020-06-24T13:11:58+08:00
