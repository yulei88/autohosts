...
route add -host 18.194.235.246 gw $1
...
route add -host 52.216.233.101 gw $1
...
route add -host 52.85.6.114 gw $1
route add -host 52.85.6.12 gw $1
route add -host 52.85.6.125 gw $1
route add -host 52.85.6.13 gw $1
route add -host 52.85.6.146 gw $1
route add -host 52.85.6.159 gw $1
route add -host 52.85.6.16 gw $1
route add -host 52.85.6.172 gw $1
route add -host 52.85.6.179 gw $1
route add -host 52.85.6.188 gw $1
route add -host 52.85.6.19 gw $1
route add -host 52.85.6.192 gw $1
route add -host 52.85.6.206 gw $1
route add -host 52.85.6.213 gw $1
route add -host 52.85.6.220 gw $1
route add -host 52.85.6.230 gw $1
route add -host 52.85.6.24 gw $1
route add -host 52.85.6.25 gw $1
route add -host 52.85.6.30 gw $1
route add -host 52.85.6.35 gw $1
route add -host 52.85.6.58 gw $1
route add -host 52.85.6.66 gw $1
route add -host 52.85.6.96 gw $1
route add -host 52.85.8.10 gw $1
route add -host 52.85.8.13 gw $1
...
#Last updated:  2019-03-08T05:59:09+08:00
