...
route add -host 172.217.1.131 gw $1
...
route add -host 172.217.168.67 gw $1
...
route add -host 18.196.134.225 gw $1
...
route add -host 34.239.4.90 gw $1
...
route add -host 50.112.27.222 gw $1
route add -host 52.10.29.96 gw $1
route add -host 52.1.172.141 gw $1
route add -host 52.119.210.50 gw $1
route add -host 52.202.27.59 gw $1
route add -host 52.205.59.243 gw $1
route add -host 52.216.1.248 gw $1
route add -host 52.216.131.133 gw $1
route add -host 52.216.19.24 gw $1
...
route add -host 52.219.73.127 gw $1
...
#Last updated:  2019-06-02T08:27:07+08:00
