...
route add -host 142.250.76.163 gw $1
...
route add -host 143.204.74.59 gw $1
...
route add -host 52.20.117.249 gw $1
route add -host 52.216.110.117 gw $1
route add -host 52.217.111.20 gw $1
route add -host 52.218.192.8 gw $1
route add -host 52.218.41.187 gw $1
route add -host 52.219.117.40 gw $1
route add -host 52.219.129.42 gw $1
route add -host 52.219.47.119 gw $1
route add -host 52.219.8.10 gw $1
...
route add -host 52.88.183.183 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-02T13:26:10+08:00
