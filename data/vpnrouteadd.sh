...
route add -host 172.217.24.3 gw $1
...
route add -host 23.20.61.157 gw $1
route add -host 23.227.38.32 gw $1
route add -host 23.227.63.64 gw $1
route add -host 23.32.241.17 gw $1
route add -host 23.34.119.52 gw $1
route add -host 23.34.123.12 gw $1
...
route add -host 52.218.240.160 gw $1
route add -host 52.218.96.26 gw $1
route add -host 52.219.0.92 gw $1
route add -host 52.219.112.80 gw $1
...
route add -host 54.164.114.36 gw $1
...
route add -host 54.86.240.186 gw $1
...
#Last updated:  2019-05-15T18:55:54+08:00
