...
route add -host 125.56.212.236 gw $1
...
route add -host 18.185.197.205 gw $1
...
route add -host 216.58.199.46 gw $1
...
route add -host 23.20.169.33 gw $1
...
route add -host 3.85.255.128 gw $1
...
route add -host 52.216.110.237 gw $1
route add -host 52.216.238.83 gw $1
route add -host 52.216.85.187 gw $1
route add -host 52.218.104.138 gw $1
route add -host 52.218.248.184 gw $1
route add -host 52.219.0.20 gw $1
route add -host 52.219.24.29 gw $1
route add -host 52.219.36.97 gw $1
...
route add -host 52.6.147.92 gw $1
...
route add -host 52.95.163.35 gw $1
...
route add -host 74.125.128.109 gw $1
...
#Last updated:  2019-01-01T05:58:52+08:00
