...
route add -host 13.225.212.87 gw $1
route add -host 13.225.62.115 gw $1
...
route add -host 13.33.71.6 gw $1
route add -host 13.33.71.67 gw $1
...
route add -host 172.217.31.14 gw $1
...
route add -host 23.42.157.9 gw $1
...
route add -host 52.216.238.5 gw $1
route add -host 52.216.97.187 gw $1
route add -host 52.218.192.184 gw $1
route add -host 52.218.36.242 gw $1
...
route add -host 52.45.42.190 gw $1
...
route add -host 74.125.132.120 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-12-25T11:59:56+08:00
