...
route add -host 13.209.172.67 gw $1
...
route add -host 172.217.26.111 gw $1
...
route add -host 18.205.72.247 gw $1
route add -host 18.213.183.225 gw $1
route add -host 184.25.205.24 gw $1
route add -host 184.25.205.33 gw $1
...
route add -host 213.144.235.202 gw $1
...
route add -host 23.33.178.33 gw $1
route add -host 23.44.150.252 gw $1
route add -host 23.62.226.160 gw $1
...
route add -host 34.233.96.0 gw $1
route add -host 34.236.196.22 gw $1
route add -host 35.158.226.13 gw $1
...
route add -host 52.20.205.36 gw $1
route add -host 52.203.70.197 gw $1
route add -host 52.216.165.109 gw $1
route add -host 52.216.97.19 gw $1
route add -host 52.218.104.106 gw $1
route add -host 52.218.201.24 gw $1
route add -host 52.219.0.154 gw $1
route add -host 52.219.28.13 gw $1
route add -host 52.219.40.21 gw $1
route add -host 52.219.74.8 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.3.143.156 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.39.74.21 gw $1
route add -host 52.40.172.168 gw $1
route add -host 52.4.185.197 gw $1
route add -host 52.45.219.205 gw $1
route add -host 52.48.212.136 gw $1
route add -host 52.52.198.88 gw $1
route add -host 52.55.117.226 gw $1
route add -host 52.7.11.163 gw $1
route add -host 52.72.235.223 gw $1
route add -host 52.74.174.169 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.8.115.55 gw $1
route add -host 52.85.12.10 gw $1
route add -host 52.85.12.121 gw $1
route add -host 52.85.12.180 gw $1
route add -host 52.85.12.188 gw $1
route add -host 52.85.12.192 gw $1
route add -host 52.85.12.198 gw $1
route add -host 52.85.12.204 gw $1
route add -host 52.85.12.206 gw $1
route add -host 52.85.12.208 gw $1
...
route add -host 52.85.12.227 gw $1
route add -host 52.85.12.23 gw $1
route add -host 52.85.12.234 gw $1
route add -host 52.85.12.248 gw $1
route add -host 52.85.12.252 gw $1
route add -host 52.85.12.26 gw $1
route add -host 52.85.12.29 gw $1
route add -host 52.85.12.39 gw $1
route add -host 52.85.12.8 gw $1
route add -host 52.85.12.83 gw $1
route add -host 52.85.12.86 gw $1
route add -host 52.85.12.96 gw $1
route add -host 52.85.13.35 gw $1
route add -host 52.85.13.44 gw $1
route add -host 52.85.13.47 gw $1
route add -host 52.85.15.121 gw $1
route add -host 52.95.131.37 gw $1
route add -host 52.95.165.30 gw $1
route add -host 54.165.45.209 gw $1
route add -host 54.191.39.115 gw $1
route add -host 54.192.235.136 gw $1
route add -host 54.193.253.6 gw $1
route add -host 54.230.235.93 gw $1
route add -host 54.235.253.182 gw $1
route add -host 54.236.70.234 gw $1
route add -host 54.239.194.149 gw $1
...
route add -host 54.241.138.157 gw $1
route add -host 54.241.5.138 gw $1
route add -host 54.242.150.139 gw $1
...
route add -host 69.192.3.17 gw $1
route add -host 69.192.3.18 gw $1
route add -host 69.192.3.19 gw $1
route add -host 69.192.3.26 gw $1
route add -host 69.192.3.33 gw $1
route add -host 69.192.3.34 gw $1
route add -host 69.192.3.9 gw $1
...
route add -host 74.125.130.147 gw $1
...
route add -host 99.84.239.4 gw $1
route add -host 99.84.239.9 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-01-13T08:31:52+08:00
