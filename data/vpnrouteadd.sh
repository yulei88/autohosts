...
route add -host 13.35.46.54 gw $1
route add -host 13.35.46.7 gw $1
route add -host 13.35.51.10 gw $1
route add -host 13.35.70.107 gw $1
route add -host 13.35.70.18 gw $1
route add -host 13.35.70.3 gw $1
route add -host 13.35.70.42 gw $1
route add -host 13.35.70.83 gw $1
...
route add -host 142.250.78.99 gw $1
...
route add -host 34.213.66.220 gw $1
...
route add -host 52.216.250.166 gw $1
route add -host 52.217.12.156 gw $1
...
route add -host 99.84.55.70 gw $1
route add -host 99.84.55.84 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2021-01-23T22:08:21+08:00
