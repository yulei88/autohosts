...
route add -host 108.177.12.120 gw $1
...
route add -host 172.217.197.94 gw $1
...
route add -host 18.197.66.83 gw $1
...
route add -host 216.58.212.163 gw $1
...
route add -host 23.45.50.97 gw $1
...
route add -host 34.217.244.255 gw $1
...
route add -host 52.216.109.235 gw $1
route add -host 52.217.92.38 gw $1
...
route add -host 52.219.16.170 gw $1
...
route add -host 54.183.233.94 gw $1
route add -host 54.191.235.13 gw $1
route add -host 54.192.153.14 gw $1
...
route add -host 99.86.34.50 gw $1
route add -host 99.86.34.8 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-10-29T05:50:07+08:00
