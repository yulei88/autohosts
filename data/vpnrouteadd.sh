...
route add -host 52.216.144.237 gw $1
route add -host 52.216.99.171 gw $1
route add -host 52.218.200.224 gw $1
route add -host 52.218.37.131 gw $1
...
route add -host 52.39.133.134 gw $1
...
#Last updated:  2020-07-27T13:13:53+08:00
