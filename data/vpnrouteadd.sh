...
route add -host 3.120.219.248 gw $1
...
route add -host 52.216.230.59 gw $1
...
route add -host 52.52.178.116 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.8.138.22 gw $1
route add -host 52.88.48.98 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-12-07T22:02:59+08:00
