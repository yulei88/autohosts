...
route add -host 13.224.10.15 gw $1
...
route add -host 143.204.74.102 gw $1
...
route add -host 143.204.74.123 gw $1
route add -host 143.204.74.124 gw $1
route add -host 143.204.74.125 gw $1
route add -host 143.204.74.16 gw $1
route add -host 143.204.74.21 gw $1
route add -host 143.204.74.26 gw $1
route add -host 143.204.74.31 gw $1
route add -host 143.204.74.37 gw $1
route add -host 143.204.74.45 gw $1
route add -host 143.204.74.68 gw $1
...
route add -host 3.126.34.66 gw $1
route add -host 3.212.172.45 gw $1
...
route add -host 52.203.110.194 gw $1
route add -host 52.216.76.68 gw $1
route add -host 52.217.0.13 gw $1
route add -host 52.218.232.8 gw $1
route add -host 52.218.61.251 gw $1
route add -host 52.219.112.128 gw $1
route add -host 52.219.124.198 gw $1
route add -host 52.219.1.82 gw $1
route add -host 52.219.47.123 gw $1
...
route add -host 52.73.165.14 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.95.134.239 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-11-12T22:08:47+08:00
