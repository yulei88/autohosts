...
route add -host 34.196.90.132 gw $1
...
route add -host 52.216.105.61 gw $1
route add -host 52.216.8.3 gw $1
route add -host 52.218.136.208 gw $1
route add -host 52.218.28.227 gw $1
route add -host 52.219.116.24 gw $1
route add -host 52.219.125.38 gw $1
route add -host 52.219.140.107 gw $1
route add -host 52.219.16.238 gw $1
route add -host 52.221.46.214 gw $1
route add -host 52.3.27.142 gw $1
route add -host 52.34.193.177 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.42.227.25 gw $1
route add -host 52.43.141.199 gw $1
...
#Last updated:  2021-01-11T05:53:51+08:00
