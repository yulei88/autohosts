...
route add -host 104.244.46.167 gw $1
...
route add -host 13.57.113.201 gw $1
...
route add -host 162.125.32.137 gw $1
...
route add -host 23.33.178.24 gw $1
...
route add -host 23.67.188.188 gw $1
...
route add -host 34.203.98.54 gw $1
route add -host 34.207.38.180 gw $1
...
route add -host 52.0.57.132 gw $1
route add -host 52.1.172.141 gw $1
route add -host 52.119.168.190 gw $1
route add -host 52.20.26.228 gw $1
route add -host 52.216.10.91 gw $1
route add -host 52.216.228.48 gw $1
route add -host 52.216.238.213 gw $1
route add -host 52.218.240.120 gw $1
route add -host 52.218.36.2 gw $1
route add -host 52.219.32.5 gw $1
route add -host 52.219.68.40 gw $1
...
route add -host 52.41.51.224 gw $1
...
route add -host 52.8.102.249 gw $1
route add -host 52.85.12.10 gw $1
...
route add -host 52.85.12.164 gw $1
route add -host 52.85.12.176 gw $1
route add -host 52.85.12.187 gw $1
route add -host 52.85.12.189 gw $1
...
route add -host 52.85.12.221 gw $1
route add -host 52.85.12.230 gw $1
route add -host 52.85.12.234 gw $1
route add -host 52.85.12.31 gw $1
route add -host 52.85.12.34 gw $1
route add -host 52.85.12.43 gw $1
route add -host 52.85.12.48 gw $1
route add -host 52.85.12.49 gw $1
route add -host 52.85.12.6 gw $1
route add -host 52.85.12.66 gw $1
route add -host 52.85.12.76 gw $1
route add -host 52.85.12.96 gw $1
route add -host 52.85.12.97 gw $1
route add -host 52.85.12.99 gw $1
route add -host 52.85.13.47 gw $1
route add -host 52.85.13.50 gw $1
route add -host 52.85.13.54 gw $1
route add -host 52.85.13.70 gw $1
route add -host 52.86.176.192 gw $1
route add -host 52.95.131.37 gw $1
route add -host 52.95.164.30 gw $1
route add -host 54.156.212.69 gw $1
route add -host 54.175.138.25 gw $1
...
route add -host 54.231.237.29 gw $1
...
route add -host 64.233.184.109 gw $1
...
route add -host 64.71.134.59 gw $1
...
route add -host 74.125.24.99 gw $1
...
route add -host 96.17.151.48 gw $1
