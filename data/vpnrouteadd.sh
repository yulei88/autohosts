...
route add -host 13.226.166.17 gw $1
route add -host 13.226.201.51 gw $1
route add -host 13.226.201.71 gw $1
...
route add -host 3.231.38.227 gw $1
...
route add -host 52.216.226.104 gw $1
route add -host 52.217.67.86 gw $1
route add -host 52.218.252.64 gw $1
route add -host 52.218.53.2 gw $1
route add -host 52.219.113.16 gw $1
route add -host 52.219.128.114 gw $1
route add -host 52.219.4.36 gw $1
route add -host 52.219.47.231 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-12-14T13:23:30+08:00
