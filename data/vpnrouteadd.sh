...
route add -host 13.224.0.49 gw $1
...
route add -host 13.35.67.38 gw $1
...
route add -host 3.211.39.152 gw $1
...
route add -host 52.216.114.109 gw $1
...
route add -host 52.36.84.175 gw $1
...
route add -host 52.9.75.169 gw $1
...
route add -host 99.84.50.70 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-02T05:46:03+08:00
