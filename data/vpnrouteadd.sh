...
route add -host 23.45.51.171 gw $1
...
route add -host 52.1.241.171 gw $1
route add -host 52.196.193.27 gw $1
route add -host 52.199.23.186 gw $1
route add -host 52.21.148.213 gw $1
route add -host 52.216.228.75 gw $1
route add -host 52.216.97.139 gw $1
route add -host 52.218.109.211 gw $1
route add -host 52.218.228.32 gw $1
route add -host 52.219.0.254 gw $1
route add -host 52.219.116.48 gw $1
route add -host 52.219.124.126 gw $1
route add -host 52.219.140.11 gw $1
...
route add -host 52.95.128.31 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-05-24T13:10:01+08:00
