...
route add -host 18.213.196.128 gw $1
...
route add -host 23.2.132.169 gw $1
route add -host 23.2.133.159 gw $1
...
route add -host 23.37.144.108 gw $1
route add -host 23.37.144.123 gw $1
...
#Last updated:  2019-11-08T06:05:42+08:00
