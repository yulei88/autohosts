...
route add -host 13.33.41.2 gw $1
...
route add -host 18.195.187.64 gw $1
...
route add -host 52.216.243.60 gw $1
route add -host 52.217.40.118 gw $1
...
route add -host 54.219.153.172 gw $1
...
route add -host 54.86.187.151 gw $1
...
route add -host 69.25.20.193 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-12-17T22:01:47+08:00
