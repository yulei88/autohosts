...
route add -host 104.18.63.237 gw $1
...
route add -host 13.224.13.125 gw $1
...
route add -host 13.35.46.112 gw $1
...
route add -host 13.35.46.75 gw $1
route add -host 13.35.46.8 gw $1
...
route add -host 142.250.66.195 gw $1
...
route add -host 23.195.89.193 gw $1
...
route add -host 23.45.51.227 gw $1
route add -host 23.79.166.51 gw $1
route add -host 23.79.179.43 gw $1
...
route add -host 3.225.26.105 gw $1
...
route add -host 35.168.107.122 gw $1
route add -host 35.169.158.28 gw $1
...
route add -host 52.204.68.55 gw $1
route add -host 52.216.108.251 gw $1
route add -host 52.216.111.45 gw $1
...
route add -host 52.2.38.102 gw $1
...
route add -host 52.9.214.152 gw $1
route add -host 52.95.132.231 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-06-11T09:46:11+08:00
