...
route add -host 18.184.107.21 gw $1
route add -host 18.211.223.13 gw $1
route add -host 18.232.239.73 gw $1
...
route add -host 52.20.209.71 gw $1
route add -host 52.205.0.140 gw $1
route add -host 52.216.25.214 gw $1
route add -host 52.217.13.188 gw $1
...
#Last updated:  2020-05-25T21:59:05+08:00
