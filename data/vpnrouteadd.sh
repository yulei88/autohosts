...
route add -host 13.224.42.17 gw $1
...
route add -host 13.33.67.29 gw $1
...
route add -host 172.217.13.174 gw $1
...
route add -host 173.194.79.94 gw $1
...
route add -host 34.232.241.1 gw $1
route add -host 35.158.234.158 gw $1
...
route add -host 52.0.51.44 gw $1
...
route add -host 52.2.138.24 gw $1
route add -host 52.216.77.14 gw $1
...
route add -host 52.40.202.43 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-07-19T05:50:54+08:00
