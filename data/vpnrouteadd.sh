...
route add -host 13.226.198.67 gw $1
route add -host 13.226.198.68 gw $1
route add -host 13.226.198.71 gw $1
route add -host 13.226.238.122 gw $1
route add -host 13.226.251.105 gw $1
route add -host 13.226.251.5 gw $1
route add -host 13.226.251.98 gw $1
...
route add -host 13.35.84.114 gw $1
...
route add -host 52.0.181.7 gw $1
...
route add -host 52.216.187.3 gw $1
route add -host 52.217.40.174 gw $1
route add -host 52.218.105.58 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-04-09T13:12:24+08:00
