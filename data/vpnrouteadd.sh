...
route add -host 18.196.147.86 gw $1
...
route add -host 3.209.37.237 gw $1
...
route add -host 52.216.238.243 gw $1
route add -host 52.216.98.133 gw $1
route add -host 52.218.224.160 gw $1
route add -host 52.218.97.178 gw $1
...
route add -host 52.73.47.226 gw $1
...
route add -host 52.85.0.143 gw $1
...
route add -host 54.192.111.89 gw $1
...
route add -host 99.84.41.109 gw $1
route add -host 99.84.41.111 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2019-06-24T08:28:00+08:00
