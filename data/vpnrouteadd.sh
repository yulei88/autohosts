...
route add -host 34.197.202.126 gw $1
route add -host 34.208.74.157 gw $1
...
route add -host 52.217.103.94 gw $1
...
route add -host 52.52.61.126 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-12-27T13:19:00+08:00
