...
route add -host 52.216.136.150 gw $1
route add -host 52.217.65.140 gw $1
route add -host 52.218.253.168 gw $1
route add -host 52.218.85.123 gw $1
route add -host 52.219.112.24 gw $1
route add -host 52.219.125.50 gw $1
route add -host 52.219.16.166 gw $1
route add -host 52.219.75.95 gw $1
...
route add -host 99.86.32.104 gw $1
route add -host 99.86.32.16 gw $1
route add -host 99.86.32.89 gw $1
route add -host 99.86.32.99 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-09-20T09:49:32+08:00
