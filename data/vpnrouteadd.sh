...
route add -host 18.214.94.131 gw $1
...
route add -host 209.85.202.94 gw $1
...
route add -host 52.217.12.238 gw $1
route add -host 52.218.201.176 gw $1
route add -host 52.218.52.36 gw $1
route add -host 52.219.120.144 gw $1
route add -host 52.219.132.74 gw $1
...
route add -host 52.40.136.122 gw $1
...
route add -host 54.230.173.104 gw $1
...
route add -host 54.230.244.143 gw $1
...
route add -host 99.84.142.44 gw $1
