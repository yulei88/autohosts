...
route add -host 104.80.88.48 gw $1
...
route add -host 13.225.161.67 gw $1
...
route add -host 13.32.255.59 gw $1
...
route add -host 216.58.221.206 gw $1
...
route add -host 3.231.46.251 gw $1
route add -host 34.196.95.231 gw $1
route add -host 34.200.55.36 gw $1
route add -host 34.205.126.147 gw $1
route add -host 34.223.215.140 gw $1
...
route add -host 52.216.114.179 gw $1
route add -host 52.216.97.77 gw $1
route add -host 52.218.241.120 gw $1
...
route add -host 54.175.50.115 gw $1
...
#Last updated:  2019-11-06T22:04:56+08:00
