...
route add -host 13.249.146.60 gw $1
...
route add -host 13.32.230.67 gw $1
...
route add -host 3.223.181.244 gw $1
...
route add -host 52.0.5.232 gw $1
...
route add -host 52.216.100.107 gw $1
route add -host 52.216.177.11 gw $1
route add -host 52.216.94.45 gw $1
route add -host 52.218.204.48 gw $1
route add -host 52.218.84.98 gw $1
...
route add -host 52.34.118.171 gw $1
route add -host 52.36.140.12 gw $1
route add -host 52.44.166.47 gw $1
...
route add -host 52.6.59.70 gw $1
...
#Last updated:  2019-08-31T18:57:20+08:00
