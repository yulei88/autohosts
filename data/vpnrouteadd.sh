...
route add -host 13.227.61.28 gw $1
route add -host 13.227.61.72 gw $1
...
route add -host 13.57.161.202 gw $1
...
route add -host 172.64.164.5 gw $1
...
route add -host 3.120.71.115 gw $1
...
route add -host 52.217.39.198 gw $1
route add -host 52.21.76.84 gw $1
route add -host 52.218.221.96 gw $1
route add -host 52.218.90.107 gw $1
route add -host 52.219.120.128 gw $1
route add -host 52.219.125.6 gw $1
...
route add -host 52.72.197.223 gw $1
...
route add -host 54.153.61.243 gw $1
...
route add -host 99.84.232.131 gw $1
route add -host 99.84.56.54 gw $1
...
#Last updated:  2020-09-23T09:50:56+08:00
