...
route add -host 13.224.15.86 gw $1
...
route add -host 23.195.90.32 gw $1
...
route add -host 34.211.246.87 gw $1
...
route add -host 52.217.67.134 gw $1
route add -host 52.217.72.148 gw $1
route add -host 52.218.234.96 gw $1
route add -host 52.218.90.179 gw $1
route add -host 52.219.120.136 gw $1
route add -host 52.219.12.22 gw $1
route add -host 52.219.132.50 gw $1
...
route add -host 52.95.128.79 gw $1
...
route add -host 54.183.254.195 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2020-11-07T05:52:16+08:00
