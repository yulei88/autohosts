...
route add -host 13.32.54.100 gw $1
...
route add -host 13.33.174.87 gw $1
...
route add -host 216.58.205.78 gw $1
...
route add -host 3.120.61.77 gw $1
...
route add -host 3.209.163.60 gw $1
...
route add -host 34.226.46.213 gw $1
route add -host 34.234.135.217 gw $1
...
route add -host 52.203.233.181 gw $1
route add -host 52.205.167.87 gw $1
route add -host 52.216.230.37 gw $1
route add -host 52.217.8.36 gw $1
route add -host 52.218.244.128 gw $1
...
route add -host 54.183.227.55 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-10-11T22:02:30+08:00
