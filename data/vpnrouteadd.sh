...
route add -host 107.21.12.190 gw $1
...
route add -host 13.225.146.9 gw $1
...
route add -host 13.33.42.24 gw $1
route add -host 13.33.42.35 gw $1
route add -host 13.33.42.72 gw $1
...
route add -host 157.240.19.26 gw $1
...
route add -host 157.240.2.52 gw $1
route add -host 157.240.26.33 gw $1
route add -host 157.240.3.29 gw $1
...
route add -host 216.58.205.67 gw $1
...
route add -host 23.51.208.61 gw $1
...
route add -host 31.13.67.63 gw $1
...
route add -host 3.223.63.248 gw $1
route add -host 34.196.221.134 gw $1
...
route add -host 52.216.204.197 gw $1
route add -host 52.217.46.156 gw $1
route add -host 52.218.100.67 gw $1
route add -host 52.218.244.88 gw $1
route add -host 52.219.0.219 gw $1
route add -host 52.219.120.72 gw $1
route add -host 52.219.36.150 gw $1
route add -host 52.219.74.175 gw $1
...
route add -host 52.58.15.113 gw $1
route add -host 52.76.148.61 gw $1
route add -host 52.9.130.24 gw $1
route add -host 52.9.16.178 gw $1
route add -host 52.95.133.167 gw $1
...
route add -host 64.233.187.14 gw $1
...
route add -host 69.192.3.25 gw $1
route add -host 69.192.3.26 gw $1
route add -host 72.247.181.47 gw $1
...
route add -host 99.84.55.90 gw $1
route add -host 99.84.55.96 gw $1
route add -host 99.84.59.110 gw $1
route add -host 8.8.8.8 gw $1
#Last updated:  2020-02-20T22:02:06+08:00
