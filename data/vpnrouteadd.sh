...
route add -host 13.249.146.2 gw $1
...
route add -host 13.32.230.210 gw $1
route add -host 13.32.230.34 gw $1
route add -host 13.32.230.49 gw $1
route add -host 13.32.230.72 gw $1
...
route add -host 172.217.212.120 gw $1
...
route add -host 34.201.81.227 gw $1
...
route add -host 52.216.114.35 gw $1
route add -host 52.216.138.14 gw $1
route add -host 52.218.221.112 gw $1
route add -host 52.218.52.178 gw $1
route add -host 52.219.112.72 gw $1
route add -host 52.219.16.62 gw $1
...
route add -host 8.8.8.8 gw $1
#Last updated:  2019-09-16T08:25:22+08:00
